...
```
============================================================
  CODEMAXXING SESSION COMPLETE
============================================================
  Total lines:      1,003,523
  Total files:          3,540
  Total commits:          236
  Duration:          00:00:29
  Lines/sec:           33,824
...
29 seconds. One million lines. Zero value delivered.

## How was this made?

```bash
pip install -e ../codemaxxing
codemaxxing --lines 1000000 --turbo --sanity 30
```

That's it. One command. The `--sanity 30` means roughly 70% of the code uses variable names like `Skibidi`, `Ligma`, and `xX_Destroyer_Xx`, while the remaining 30% maintains a thin veneer of corporate respectability.

Want to make your own mass of code? Check out [**codemaxxing**](https://github.com/jshchnz/codemaxxing).
