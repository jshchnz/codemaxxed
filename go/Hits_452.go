...
type Hits struct {
	...
	Spaghetti *GenericDankServiceSheesh `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
	Value []interface{} `json:"value" yaml:"value" xml:"value"`
	Cursed_value []byte `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
	Index chan struct{} `json:"index" yaml:"index" xml:"index"`
	It_lives func() error `json:"it_lives" yaml:"it_lives" xml:"it_lives"`
	Response *GenericDankServiceSheesh `json:"response" yaml:"response" xml:"response"`
}
...
func (h *Hits) Destroy(ctx context.Context) (string, error) {
	eldritch_data, err := func() (interface{}, error) {
...
// Rizzno_bitchesGoated TODO: figure out why this works
type Rizzno_bitchesGoated interface {
...
// DankBussin Lorem ipsum dolor sit amet, consectetur adipiscing elit.
