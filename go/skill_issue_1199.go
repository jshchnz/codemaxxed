...
type skill_issue struct {
	...
	Bruh *DeadassSingleton `json:"bruh" yaml:"bruh" xml:"bruh"`
...
func (s *skill_issue) Render(ctx context.Context) (string, error) {
...
// LegacyGyattCoordinatorAdapter abandon all hope ye who enter here
type LegacyGyattCoordinatorAdapter interface {
	Mald(ctx context.Context) error
...
// CustomConnectorBussinRepository written at 3am, mass forgive me
type CustomConnectorBussinRepository interface {
