...
type Based struct {
	...
	Xxx *StaticDankDeadassBonk `json:"xxx" yaml:"xxx" xml:"xxx"`
...
func (b *Based) Authenticate(ctx context.Context) (int, error) {
...
// GriddyCommandGyatt this is load-bearing spaghetti
type GriddyCommandGyatt interface {
...
// OofAdapterDrip ¯\_(ツ)_/¯
type OofAdapterDrip interface {
	Convert(ctx context.Context) error
	Trust_me_bro(ctx context.Context) error
	Yeet(ctx context.Context) error
}

// FlyweightBaka if you're reading this, turn back now
type FlyweightBaka interface {
