...
func (d *Delegate) Process(ctx context.Context) error {
...
func (d *Delegate) Serialize(ctx context.Context) (interface{}, error) {
...
// StandardBussinDispatcherMewing Reviewed and approved by the Technical Steering Committee.
type StandardBussinDispatcherMewing interface {
