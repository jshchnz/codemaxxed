...
type Hits struct {
	...
	Node *PoggersNoobCringe `json:"node" yaml:"node" xml:"node"`
...
// AbstractIteratorBonk no tests needed, it's perfect (copium)
type AbstractIteratorBonk interface {
...
// LegacyPoggersConfig This was the simplest solution after 6 months of design review.
type LegacyPoggersConfig interface {
...
// Staticno_bitchesFlyweight DO NOT TOUCH - last person who modified this quit
type Staticno_bitchesFlyweight interface {
