...
type Baka struct {
	...
	Node *MewingCopiumMalding `json:"node" yaml:"node" xml:"node"`
...
// LegacyCompositeData Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type LegacyCompositeData interface {
...
// ComponentSlay i dont know what this does but removing it breaks everything
