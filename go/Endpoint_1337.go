...
type Endpoint struct {
	...
	Reference *Glizzy `json:"reference" yaml:"reference" xml:"reference"`
...
func (e *Endpoint) Dispatch(ctx context.Context) (int, error) {
...
// SlayBonkSingleton Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type SlayBonkSingleton interface {
...
// HitsBussinPoggers Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type HitsBussinPoggers interface {
