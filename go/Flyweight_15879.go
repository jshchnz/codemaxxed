...
type Flyweight struct {
	...
	Yolo_var *BonkChainOrchestrator `json:"yolo_var" yaml:"yolo_var" xml:"yolo_var"`
}
...
func (f *Flyweight) Build(ctx context.Context) (interface{}, error) {
...
// skill_issueDeluluStonks abandon all hope ye who enter here
type skill_issueDeluluStonks interface {
