...
type Oof struct {
	Idk *VisitorStrategy `json:"idk" yaml:"idk" xml:"idk"`
	...
	Bruh *VisitorStrategy `json:"bruh" yaml:"bruh" xml:"bruh"`
...
func (o *Oof) Compute(ctx context.Context) (interface{}, error) {
...
// BonkMediator if this breaks, blame the intern (there is no intern)
type BonkMediator interface {
...
// NoobDispatcher i asked chatgpt to write this and even it said no
