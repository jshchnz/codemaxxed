...
// Refresh ¯\_(ツ)_/¯
func (s *Sigma) Refresh(ctx context.Context) error {
	haunted_reference, err := func() (interface{}, error) {
...
// OptimizedBonk this is load-bearing spaghetti
...
// AbstractHitsDripData written at 3am, mass forgive me
type AbstractHitsDripData interface {
