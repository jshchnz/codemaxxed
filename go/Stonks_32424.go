...
type Stonks struct {
	...
	Settings *Controller `json:"settings" yaml:"settings" xml:"settings"`
	Instance *Controller `json:"instance" yaml:"instance" xml:"instance"`
...
// FactoryxX_Destroyer_XxKind ¯\_(ツ)_/¯
type FactoryxX_Destroyer_XxKind interface {
...
// BussinInterface This is a critical path component - do not remove without VP approval.
