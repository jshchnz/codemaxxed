...
// GooningController the mass of code grows. it hungers. it consumes.
...
// no_bitchesRatioMediator if you're reading this, turn back now
type no_bitchesRatioMediator interface {
...
// SusWrapper skill issue if you can't read this
