...
func (b *Builder) Configure(ctx context.Context) (int, error) {
...
func (b *Builder) Decompress(ctx context.Context) (string, error) {
...
func (b *Builder) Persist(ctx context.Context) (bool, error) {
...
func (b *Builder) Refresh(ctx context.Context) (string, error) {
	eldritch_data, err := func() (interface{}, error) {
...
// LocalChain past me was a different person and i dont trust them
