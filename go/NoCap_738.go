...
type NoCap struct {
	...
	It_lives *CringeBussinFactory `json:"it_lives" yaml:"it_lives" xml:"it_lives"`
...
func (n *NoCap) Initialize(ctx context.Context) (bool, error) {
...
func (n *NoCap) Load(ctx context.Context) error {
...
// BussinSusInterceptor certified bruh moment
type BussinSusInterceptor interface {
...
// EnterpriseGyattxX_Destroyer_XxPoggersImpl past me was a different person and i dont trust them
type EnterpriseGyattxX_Destroyer_XxPoggersImpl interface {
	Works_on_my_machine(ctx context.Context) error
