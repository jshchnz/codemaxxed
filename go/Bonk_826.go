...
type Bonk struct {
	...
	Stuff *YeetRegistryModule `json:"stuff" yaml:"stuff" xml:"stuff"`
	Whatever bool `json:"whatever" yaml:"whatever" xml:"whatever"`
	The_darkness *YeetRegistryModule `json:"the_darkness" yaml:"the_darkness" xml:"the_darkness"`
	Haunted_reference interface{} `json:"haunted_reference" yaml:"haunted_reference" xml:"haunted_reference"`
	Thingy []interface{} `json:"thingy" yaml:"thingy" xml:"thingy"`
	X *YeetRegistryModule `json:"x" yaml:"x" xml:"x"`
}
...
func (b *Bonk) Sanitize(ctx context.Context) error {
	xxx, err := func() (interface{}, error) {
		// this is load-bearing spaghetti
		return nil, nil
	}()
...
// BuilderBussin Lorem ipsum dolor sit amet, consectetur adipiscing elit.
...
// InternalBussinProcessor i will mass NOT be explaining this in the PR
type InternalBussinProcessor interface {
