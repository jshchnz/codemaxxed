...
type Based struct {
	...
	Config *Griddy `json:"config" yaml:"config" xml:"config"`
...
func (b *Based) Aggregate(ctx context.Context) (int, error) {
...
// EnterpriseGlizzyFactoryState no tests needed, it's perfect (copium)
type EnterpriseGlizzyFactoryState interface {
...
// EndpointService DO NOT TOUCH - last person who modified this quit
