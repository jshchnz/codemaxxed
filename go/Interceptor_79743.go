...
func (i *Interceptor) Load(ctx context.Context) (interface{}, error) {
...
func (i *Interceptor) Unmarshal(ctx context.Context) error {
...
// StaticSerializerChainComposite i will mass NOT be explaining this in the PR
type StaticSerializerChainComposite interface {
...
// HitsBonkGyatt skill issue if you can't read this
type HitsBonkGyatt interface {
