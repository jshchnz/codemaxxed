...
type Griddy struct {
	...
	Idk *GlizzyNoCap `json:"idk" yaml:"idk" xml:"idk"`
...
// InitializerBonkState this is load-bearing spaghetti
type InitializerBonkState interface {
...
// WrapperSkibidiModel Reviewed and approved by the Technical Steering Committee.
type WrapperSkibidiModel interface {
