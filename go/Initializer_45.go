...
type Initializer struct {
	...
	Yolo_var *MapperBakaFanum `json:"yolo_var" yaml:"yolo_var" xml:"yolo_var"`
	Item []interface{} `json:"item" yaml:"item" xml:"item"`
	The_darkness *MapperBakaFanum `json:"the_darkness" yaml:"the_darkness" xml:"the_darkness"`
...
func (i *Initializer) Decompress(ctx context.Context) (interface{}, error) {
...
func (i *Initializer) Update(ctx context.Context) (string, error) {
...
// GigachadSpec i asked chatgpt to write this and even it said no
