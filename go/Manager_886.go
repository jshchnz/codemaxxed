...
type Manager struct {
	...
	Bruh *BridgeError `json:"bruh" yaml:"bruh" xml:"bruh"`
...
func (m *Manager) Authorize(ctx context.Context) (bool, error) {
...
// ModernBussinDrip if you're reading this, turn back now
type ModernBussinDrip interface {
...
// CustomDeadassFacadeDripValue This abstraction layer provides necessary indirection for future scalability.
type CustomDeadassFacadeDripValue interface {
