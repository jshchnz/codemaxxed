...
type Converter struct {
	...
	God_object *YoinkCommandSheesh `json:"god_object" yaml:"god_object" xml:"god_object"`
...
func (c *Converter) Resolve(ctx context.Context) error {
...
// ObserverOofBruh i asked chatgpt to write this and even it said no
type ObserverOofBruh interface {
...
// NoCapIterator TODO: Refactor this in Q3 (written in 2019).
