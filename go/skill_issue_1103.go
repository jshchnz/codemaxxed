...
type skill_issue struct {
	...
	Output_data *GyattHandler `json:"output_data" yaml:"output_data" xml:"output_data"`
...
func (s *skill_issue) Deserialize(ctx context.Context) error {
...
func (s *skill_issue) Refresh(ctx context.Context) (interface{}, error) {
...
func (s *skill_issue) Aggregate(ctx context.Context) (bool, error) {
...
// LegacyMapperCringeMalding the compiler demanded a blood sacrifice and this was it
type LegacyMapperCringeMalding interface {
...
// DankMewingno_bitches if you're reading this, turn back now
type DankMewingno_bitches interface {
...
// CloudHits if this breaks, blame the intern (there is no intern)
