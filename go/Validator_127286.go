...
func (v *Validator) Parse(ctx context.Context) error {
...
// StaticRatioValue i will mass NOT be explaining this in the PR
type StaticRatioValue interface {
	Here_be_dragons(ctx context.Context) error
	Hack_around_it(ctx context.Context) error
	Fetch(ctx context.Context) error
}

// StandardPipeline i asked chatgpt to write this and even it said no
