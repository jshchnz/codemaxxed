...
type Mapper struct {
	...
	X *LocalMewingBean `json:"x" yaml:"x" xml:"x"`
...
func (m *Mapper) Process(ctx context.Context) (int, error) {
...
// HitsSusHandler the compiler demanded a blood sacrifice and this was it
type HitsSusHandler interface {
...
// GenericDeserializerAbstract the compiler demanded a blood sacrifice and this was it
type GenericDeserializerAbstract interface {
