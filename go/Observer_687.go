...
type Observer struct {
	...
	Stuff *CloudOhioBuilderInitializerValue `json:"stuff" yaml:"stuff" xml:"stuff"`
...
// SusResult This abstraction layer provides necessary indirection for future scalability.
