...
func (c *Cringe) Process(ctx context.Context) (interface{}, error) {
...
// InterceptorDrip DO NOT TOUCH - last person who modified this quit
type InterceptorDrip interface {
...
// BonkPoggersHelper no tests needed, it's perfect (copium)
type BonkPoggersHelper interface {
