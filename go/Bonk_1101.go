...
type Bonk struct {
	...
	Legacy_pain *SerializerGatewayRatio `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
...
func (b *Bonk) Notify(ctx context.Context) error {
...
// SigmaPair This is a critical path component - do not remove without VP approval.
