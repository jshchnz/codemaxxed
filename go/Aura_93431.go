...
func (a *Aura) Evaluate(ctx context.Context) (int, error) {
...
// ObserverSlaps i asked chatgpt to write this and even it said no
...
// RegistryBruh this violates at least 3 design patterns and invents 2 new ones
type RegistryBruh interface {
