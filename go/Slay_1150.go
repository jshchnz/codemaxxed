...
type Slay struct {
	Thingy *SussySusTransformerRecord `json:"thingy" yaml:"thingy" xml:"thingy"`
...
func (s *Slay) Process(ctx context.Context) (string, error) {
...
// DeluluStonks past me was a different person and i dont trust them
...
// GriddyDankDeadass past me was a different person and i dont trust them
type GriddyDankDeadass interface {
...
// DynamicOhioDankBased the code is documentation enough (it is not)
type DynamicOhioDankBased interface {
