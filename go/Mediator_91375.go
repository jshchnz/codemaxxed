...
// AuraSusFactory Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type AuraSusFactory interface {
	Sacrifice_to_the_compiler(ctx context.Context) error
...
// DistributedNoobOofYeetBase written at 3am, mass forgive me
type DistributedNoobOofYeetBase interface {
	Ship_it(ctx context.Context) error
