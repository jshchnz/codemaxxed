...
func (c *Configurator) Register(ctx context.Context) (int, error) {
...
// SusFacade skill issue if you can't read this
...
// YeetImpl this is load-bearing spaghetti
