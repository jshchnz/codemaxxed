...
func (b *Bonk) Format(ctx context.Context) (interface{}, error) {
...
// SingletonCompositeBased the mass of code grows. it hungers. it consumes.
type SingletonCompositeBased interface {
