...
type Handler struct {
	...
	God_object *CustomGriddyRatioError `json:"god_object" yaml:"god_object" xml:"god_object"`
...
func (h *Handler) Dispatch(ctx context.Context) (int, error) {
...
func (h *Handler) Unmarshal(ctx context.Context) (interface{}, error) {
...
// OhioNoob This was the simplest solution after 6 months of design review.
...
// DefaultHitsFactory skill issue if you can't read this
type DefaultHitsFactory interface {
