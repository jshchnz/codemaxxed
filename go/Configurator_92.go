...
func (c *Configurator) Create(ctx context.Context) (bool, error) {
...
func (c *Configurator) Denormalize(ctx context.Context) error {
...
func (c *Configurator) Serialize(ctx context.Context) (int, error) {
...
// ScalableMewingOhioProvider i dont know what this does but removing it breaks everything
type ScalableMewingOhioProvider interface {
...
// RatioNoCap This is a critical path component - do not remove without VP approval.
