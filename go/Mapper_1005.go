...
type Mapper struct {
	...
	Eldritch_data *DankBussin `json:"eldritch_data" yaml:"eldritch_data" xml:"eldritch_data"`
...
// DeserializerSlayDelulu i dont know what this does but removing it breaks everything
type DeserializerSlayDelulu interface {
...
// GriddyStrategyYeet if you're reading this, turn back now
type GriddyStrategyYeet interface {
	Vibe_check(ctx context.Context) error
