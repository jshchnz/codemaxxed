...
type Noob struct {
	...
	Yolo_var *DefaultTransformer `json:"yolo_var" yaml:"yolo_var" xml:"yolo_var"`
	...
	Metadata *DefaultTransformer `json:"metadata" yaml:"metadata" xml:"metadata"`
...
// DistributedL_plus_ratioGoated the mass of code grows. it hungers. it consumes.
type DistributedL_plus_ratioGoated interface {
...
// Bakano_bitches works on my machine ™
...
// WrapperInfo i will mass NOT be explaining this in the PR
