...
type Flyweight struct {
	...
	Magic_number *ChungusBonkPoggers `json:"magic_number" yaml:"magic_number" xml:"magic_number"`
...
func (f *Flyweight) Decompress(ctx context.Context) (bool, error) {
...
// Rizz_up ¯\_(ツ)_/¯
func (f *Flyweight) Rizz_up(ctx context.Context) error {
...
// HitsConnectorDelegate Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type HitsConnectorDelegate interface {
	Do_the_thing(ctx context.Context) error
	Abandon_all_hope(ctx context.Context) error
	Unmarshal(ctx context.Context) error
}

// BaseDelegate works on my machine ™
