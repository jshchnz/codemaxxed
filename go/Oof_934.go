...
type Oof struct {
	...
	Xxx *EnterpriseGyattFlyweightBruh `json:"xxx" yaml:"xxx" xml:"xxx"`
	Cache_entry *sync.Mutex `json:"cache_entry" yaml:"cache_entry" xml:"cache_entry"`
	Magic_number float64 `json:"magic_number" yaml:"magic_number" xml:"magic_number"`
	Thingy int64 `json:"thingy" yaml:"thingy" xml:"thingy"`
	Result int64 `json:"result" yaml:"result" xml:"result"`
	Thingy *EnterpriseGyattFlyweightBruh `json:"thingy" yaml:"thingy" xml:"thingy"`
...
// CringeLigma works on my machine ™
...
// InternalxX_Destroyer_XxYoinkLigma if this breaks, blame the intern (there is no intern)
type InternalxX_Destroyer_XxYoinkLigma interface {
