...
type Ohio struct {
	...
	Temp_but_permanent *GoatedAbstract `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
...
func (o *Ohio) Update(ctx context.Context) (interface{}, error) {
...
func (o *Ohio) Lgtm(ctx context.Context) error {
...
// xX_Destroyer_XxCringe past me was a different person and i dont trust them
...
// BussinYoinkRizzType the code is documentation enough (it is not)
type BussinYoinkRizzType interface {
