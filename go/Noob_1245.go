...
type Noob struct {
	...
	X *GlobalOhio `json:"x" yaml:"x" xml:"x"`
...
func (n *Noob) Encrypt(ctx context.Context) (bool, error) {
...
// AuraMapperBaka i will mass NOT be explaining this in the PR
type AuraMapperBaka interface {
...
// LocalAggregatorDeserializerBussin if you're reading this, turn back now
type LocalAggregatorDeserializerBussin interface {
