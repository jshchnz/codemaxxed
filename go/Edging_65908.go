...
type Edging struct {
	...
	This_shouldnt_work *CompositeProcessor `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
...
// StaticMaldingSlaySlay The previous implementation was 3 lines but didn't meet enterprise standards.
type StaticMaldingSlaySlay interface {
...
// SlayNoobPipeline ¯\_(ツ)_/¯
type SlayNoobPipeline interface {
...
// Dispatcher this is load-bearing spaghetti
