...
func (b *Based) Encrypt(ctx context.Context) (interface{}, error) {
...
func (b *Based) Build(ctx context.Context) (interface{}, error) {
	whatever, err := func() (interface{}, error) {
...
func (b *Based) Marshal(ctx context.Context) (string, error) {
...
// BaseDripStonksValue Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type BaseDripStonksValue interface {
...
// DispatcherHelper Lorem ipsum dolor sit amet, consectetur adipiscing elit.
