...
func (m *Malding) Deserialize(ctx context.Context) error {
...
// OrchestratorError i will mass NOT be explaining this in the PR
...
// CopiumBase skill issue if you can't read this
