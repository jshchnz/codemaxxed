...
type Singleton struct {
	Xxx *OofSkibidiAdapter `json:"xxx" yaml:"xxx" xml:"xxx"`
	Whatever int64 `json:"whatever" yaml:"whatever" xml:"whatever"`
	Tech_debt *sync.Mutex `json:"tech_debt" yaml:"tech_debt" xml:"tech_debt"`
	Stuff interface{} `json:"stuff" yaml:"stuff" xml:"stuff"`
	Request *sync.Mutex `json:"request" yaml:"request" xml:"request"`
	Cursed_value *OofSkibidiAdapter `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
	Count string `json:"count" yaml:"count" xml:"count"`
	Temp_but_permanent chan struct{} `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
	Bruh *OofSkibidiAdapter `json:"bruh" yaml:"bruh" xml:"bruh"`
...
func (s *Singleton) Decrypt(ctx context.Context) (interface{}, error) {
...
// GlobalBased i dont know what this does but removing it breaks everything
