...
func (m *Middleware) Handle(ctx context.Context) (int, error) {
...
func (m *Middleware) Denormalize(ctx context.Context) (interface{}, error) {
	it_lives, err := func() (interface{}, error) {
...
// CoordinatorFanumChain ¯\_(ツ)_/¯
type CoordinatorFanumChain interface {
...
// NoCapno_bitches the code is documentation enough (it is not)
