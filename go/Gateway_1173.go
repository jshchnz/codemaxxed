...
func (g *Gateway) Save(ctx context.Context) (bool, error) {
...
func (g *Gateway) Sync(ctx context.Context) (bool, error) {
...
func (g *Gateway) Evaluate(ctx context.Context) (interface{}, error) {
...
// BussinEdgingSpec ¯\_(ツ)_/¯
type BussinEdgingSpec interface {
...
// GigachadChungusBruh This abstraction layer provides necessary indirection for future scalability.
type GigachadChungusBruh interface {
