...
// ScalableL_plus_ratio works on my machine ™
...
// DeadassYoink the code is documentation enough (it is not)
...
// StandardPoggers DO NOT TOUCH - last person who modified this quit
