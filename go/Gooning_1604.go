...
func (g *Gooning) Validate(ctx context.Context) (bool, error) {
...
// LigmaRegistrySigma abandon all hope ye who enter here
type LigmaRegistrySigma interface {
...
// SigmaPoggersMewing abandon all hope ye who enter here
type SigmaPoggersMewing interface {
	Cry(ctx context.Context) error
