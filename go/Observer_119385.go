...
type Observer struct {
	...
	Stuff *SheeshMediatorSingleton `json:"stuff" yaml:"stuff" xml:"stuff"`
	...
	Xx *SheeshMediatorSingleton `json:"xx" yaml:"xx" xml:"xx"`
	This_shouldnt_work *SheeshMediatorSingleton `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
...
func (o *Observer) Save(ctx context.Context) (interface{}, error) {
	this_shouldnt_work, err := func() (interface{}, error) {
...
// SusSkibidi no tests needed, it's perfect (copium)
