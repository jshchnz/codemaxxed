...
type Strategy struct {
	...
	Payload *DistributedEndpoint `json:"payload" yaml:"payload" xml:"payload"`
...
func (s *Strategy) Save(ctx context.Context) (string, error) {
...
// GenericDripPoggersException if this breaks, blame the intern (there is no intern)
type GenericDripPoggersException interface {
...
// CringeYoink This is a critical path component - do not remove without VP approval.
