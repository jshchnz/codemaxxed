...
type Delegate struct {
	...
	Data *skill_issueFanum `json:"data" yaml:"data" xml:"data"`
	Idk int64 `json:"idk" yaml:"idk" xml:"idk"`
	Temp_but_permanent bool `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
	The_darkness interface{} `json:"the_darkness" yaml:"the_darkness" xml:"the_darkness"`
	Tech_debt *skill_issueFanum `json:"tech_debt" yaml:"tech_debt" xml:"tech_debt"`
	Index bool `json:"index" yaml:"index" xml:"index"`
	Entity error `json:"entity" yaml:"entity" xml:"entity"`
	Stuff int64 `json:"stuff" yaml:"stuff" xml:"stuff"`
	X map[string]interface{} `json:"x" yaml:"x" xml:"x"`
	Item *skill_issueFanum `json:"item" yaml:"item" xml:"item"`
...
func (d *Delegate) Evaluate(ctx context.Context) (string, error) {
...
// InternalAura if you're reading this, turn back now
