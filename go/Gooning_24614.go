...
// Serialize ¯\_(ツ)_/¯
func (g *Gooning) Serialize(ctx context.Context) (string, error) {
...
func (g *Gooning) Resolve(ctx context.Context) (interface{}, error) {
...
// DripResult the code is documentation enough (it is not)
...
// CloudSigma Lorem ipsum dolor sit amet, consectetur adipiscing elit.
...
// OptimizedRatioBasedGooning no tests needed, it's perfect (copium)
type OptimizedRatioBasedGooning interface {
