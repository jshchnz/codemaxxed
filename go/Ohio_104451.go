...
func (o *Ohio) Update(ctx context.Context) (int, error) {
...
// InternalYoinkHelper certified bruh moment
type InternalYoinkHelper interface {
...
// NoCapDripSussy Reviewed and approved by the Technical Steering Committee.
type NoCapDripSussy interface {
	Transform(ctx context.Context) error
