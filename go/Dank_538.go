...
func (d *Dank) Initialize(ctx context.Context) (int, error) {
...
// GlobalEndpointDrip no tests needed, it's perfect (copium)
type GlobalEndpointDrip interface {
...
// GlizzyKind this violates at least 3 design patterns and invents 2 new ones
...
// DefaultVibeDelulu if this breaks, blame the intern (there is no intern)
type DefaultVibeDelulu interface {
	Mald(ctx context.Context) error
	Trust_me_bro(ctx context.Context) error
