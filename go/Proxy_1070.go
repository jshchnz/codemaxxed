...
func (p *Proxy) Cache(ctx context.Context) (interface{}, error) {
...
// SussyYeet this is load-bearing spaghetti
...
// WrapperEndpointBussinAbstract works on my machine ™
type WrapperEndpointBussinAbstract interface {
