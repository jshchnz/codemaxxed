...
type Bussin struct {
	Destination *CommandOrchestratorFanumBase `json:"destination" yaml:"destination" xml:"destination"`
...
// StandardDeluluBussinGoated Legacy code - here be dragons.
type StandardDeluluBussinGoated interface {
...
// StonksCommand i dont know what this does but removing it breaks everything
...
// StonksDankData Per the architecture review board decision ARB-2847.
type StonksDankData interface {
