...
func (v *Validator) Go_outside(ctx context.Context) (bool, error) {
...
func (v *Validator) Serialize(ctx context.Context) (interface{}, error) {
...
// GriddyChungusDecorator abandon all hope ye who enter here
type GriddyChungusDecorator interface {
	Cry(ctx context.Context) error
