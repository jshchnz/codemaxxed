...
// Format ¯\_(ツ)_/¯
func (e *Endpoint) Format(ctx context.Context) (string, error) {
...
// YeetBussinxX_Destroyer_Xx no tests needed, it's perfect (copium)
type YeetBussinxX_Destroyer_Xx interface {
...
// BuilderSigmaYeetModel i will mass NOT be explaining this in the PR
type BuilderSigmaYeetModel interface {
	Lgtm(ctx context.Context) error
	Cry(ctx context.Context) error
	Abandon_all_hope(ctx context.Context) error
}

// Bridge works on my machine ™
