...
type Processor struct {
	...
	Entity *CustomFanumVibe `json:"entity" yaml:"entity" xml:"entity"`
}
...
// xX_Destroyer_XxLigma i dont know what this does but removing it breaks everything
...
// IteratorCopiumOhioSpec i will mass NOT be explaining this in the PR
type IteratorCopiumOhioSpec interface {
...
// HitsRecord the code is documentation enough (it is not)
