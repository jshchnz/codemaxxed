...
func (h *Handler) Process(ctx context.Context) (int, error) {
...
func (h *Handler) Authenticate(ctx context.Context) (int, error) {
...
// PoggersCringeDispatcher the code is documentation enough (it is not)
type PoggersCringeDispatcher interface {
...
// LocalSerializer the compiler demanded a blood sacrifice and this was it
