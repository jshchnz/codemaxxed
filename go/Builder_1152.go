...
type Builder struct {
	...
	Spaghetti *EnhancedManager `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
	...
	Idk *EnhancedManager `json:"idk" yaml:"idk" xml:"idk"`
...
func (b *Builder) Marshal(ctx context.Context) (interface{}, error) {
...
// DistributedGigachad i dont know what this does but removing it breaks everything
...
// AbstractHitsStonksVisitor if this breaks, blame the intern (there is no intern)
type AbstractHitsStonksVisitor interface {
