...
func (b *Baka) Save(ctx context.Context) (interface{}, error) {
...
// CloudSigmaFanum abandon all hope ye who enter here
type CloudSigmaFanum interface {
...
// OptimizedProcessorWrapperResolver abandon all hope ye who enter here
type OptimizedProcessorWrapperResolver interface {
