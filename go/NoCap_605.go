...
type NoCap struct {
	...
	Forbidden_knowledge *AbstractGoated `json:"forbidden_knowledge" yaml:"forbidden_knowledge" xml:"forbidden_knowledge"`
...
// CoreModuleDeserializer if this breaks, blame the intern (there is no intern)
type CoreModuleDeserializer interface {
...
// ObserverAggregatorValidatorResult DO NOT MODIFY - This is load-bearing architecture.
type ObserverAggregatorValidatorResult interface {
...
// Staticno_bitchesSigma TODO: Refactor this in Q3 (written in 2019).
type Staticno_bitchesSigma interface {
