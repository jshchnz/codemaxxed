...
type Bonk struct {
	God_object *RizzResult `json:"god_object" yaml:"god_object" xml:"god_object"`
...
func (b *Bonk) Dispatch(ctx context.Context) (int, error) {
...
// DeadassPoggers i dont know what this does but removing it breaks everything
...
// MediatorPipelineCoordinator if this breaks, blame the intern (there is no intern)
type MediatorPipelineCoordinator interface {
