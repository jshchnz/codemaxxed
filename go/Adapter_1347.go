...
func (a *Adapter) Sanitize(ctx context.Context) (bool, error) {
...
func (a *Adapter) Handle(ctx context.Context) (bool, error) {
...
func (a *Adapter) Handle(ctx context.Context) (string, error) {
	legacy_pain, err := func() (interface{}, error) {
		// the compiler demanded a blood sacrifice and this was it
		return nil, nil
	}()
...
// CustomDeadassType TODO: figure out why this works
type CustomDeadassType interface {
...
// GlobalDeserializerGooningGoated i will mass NOT be explaining this in the PR
type GlobalDeserializerGooningGoated interface {
