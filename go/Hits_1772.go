...
// BasedDank the code is documentation enough (it is not)
...
// xX_Destroyer_XxYoink past me was a different person and i dont trust them
...
// ControllerGriddyYeet if this breaks, blame the intern (there is no intern)
type ControllerGriddyYeet interface {
	Dont_touch_this(ctx context.Context) error
