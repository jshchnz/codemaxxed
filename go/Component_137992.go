...
func (c *Component) Works_on_my_machine(ctx context.Context) (interface{}, error) {
...
func (c *Component) Fetch(ctx context.Context) error {
...
// GenericYeetGooningCompositeInterface This is a critical path component - do not remove without VP approval.
type GenericYeetGooningCompositeInterface interface {
...
// AdapterBaka This was the simplest solution after 6 months of design review.
