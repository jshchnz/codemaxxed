...
type Provider struct {
	...
	Idk *SheeshAura `json:"idk" yaml:"idk" xml:"idk"`
...
// Persist ¯\_(ツ)_/¯
func (p *Provider) Persist(ctx context.Context) (bool, error) {
...
func (p *Provider) Normalize(ctx context.Context) (string, error) {
...
// DeadassIteratorException TODO: figure out why this works
type DeadassIteratorException interface {
...
// AggregatorL_plus_ratio no tests needed, it's perfect (copium)
