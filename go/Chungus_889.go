...
type Chungus struct {
	...
	Spaghetti *MewingSkibidiRepository `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
...
func (c *Chungus) Load(ctx context.Context) (string, error) {
...
// RatioGooning TODO: figure out why this works
...
// DeluluLigma abandon all hope ye who enter here
...
// CustomLigmaGoatedGriddy this is load-bearing spaghetti
type CustomLigmaGoatedGriddy interface {
