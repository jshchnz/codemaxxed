...
func (s *Strategy) Notify(ctx context.Context) (string, error) {
...
// DynamicSigmaSkibidi i asked chatgpt to write this and even it said no
type DynamicSigmaSkibidi interface {
...
// PoggersDispatcherDispatcherState skill issue if you can't read this
type PoggersDispatcherDispatcherState interface {
