...
type Based struct {
	...
	Reference *Bruh `json:"reference" yaml:"reference" xml:"reference"`
}
...
func (b *Based) Transform(ctx context.Context) (string, error) {
...
// no_bitchesLigmaMediator This method handles the core business logic for the enterprise workflow.
type no_bitchesLigmaMediator interface {
