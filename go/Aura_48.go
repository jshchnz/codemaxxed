...
type Aura struct {
	...
	Thingy *xX_Destroyer_XxNoob `json:"thingy" yaml:"thingy" xml:"thingy"`
...
// DistributedRepositoryAuraInterceptor this is load-bearing spaghetti
type DistributedRepositoryAuraInterceptor interface {
...
// MewingCopiumMalding certified bruh moment
type MewingCopiumMalding interface {
