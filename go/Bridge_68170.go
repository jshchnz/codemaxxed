...
func (b *Bridge) Resolve(ctx context.Context) (int, error) {
...
func (b *Bridge) Serialize(ctx context.Context) (bool, error) {
...
// LigmaSkibidiNoCap TODO: figure out why this works
type LigmaSkibidiNoCap interface {
