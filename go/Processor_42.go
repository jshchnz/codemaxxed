...
func (p *Processor) Format(ctx context.Context) error {
...
// CustomGigachadPoggersFlyweight skill issue if you can't read this
type CustomGigachadPoggersFlyweight interface {
