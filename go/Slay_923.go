...
func (s *Slay) Authorize(ctx context.Context) (interface{}, error) {
...
// DripMewingInterface skill issue if you can't read this
type DripMewingInterface interface {
...
// SusDelegateStonks if you're reading this, turn back now
type SusDelegateStonks interface {
...
// DefaultServicePipeline i dont know what this does but removing it breaks everything
type DefaultServicePipeline interface {
