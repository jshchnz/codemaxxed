...
type Yeet struct {
	...
	Tech_debt *DeluluL_plus_ratio `json:"tech_debt" yaml:"tech_debt" xml:"tech_debt"`
...
func (y *Yeet) Compress(ctx context.Context) (bool, error) {
...
// ProcessorStonks the compiler demanded a blood sacrifice and this was it
