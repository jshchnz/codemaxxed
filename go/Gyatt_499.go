...
type Gyatt struct {
	Forbidden_knowledge *CringeCoordinatorSkibidi `json:"forbidden_knowledge" yaml:"forbidden_knowledge" xml:"forbidden_knowledge"`
...
func (g *Gyatt) Delete(ctx context.Context) (string, error) {
...
// GyattModel Legacy code - here be dragons.
type GyattModel interface {
