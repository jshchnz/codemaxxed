...
func (b *Based) Render(ctx context.Context) (int, error) {
...
// SusInterface Implements the AbstractFactory pattern for maximum extensibility.
...
// NoobPoggers This is a critical path component - do not remove without VP approval.
