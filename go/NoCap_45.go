...
func (n *NoCap) Invalidate(ctx context.Context) (int, error) {
	thingy, err := func() (interface{}, error) {
		// TODO: Refactor this in Q3 (written in 2019).
		return nil, nil
	}()
...
// xX_Destroyer_XxType this violates at least 3 design patterns and invents 2 new ones
...
// StonksSlaps Conforms to ISO 27001 compliance requirements.
