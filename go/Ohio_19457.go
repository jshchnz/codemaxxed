...
// GlizzyGyattResponse past me was a different person and i dont trust them
type GlizzyGyattResponse interface {
...
// CustomModuleHits past me was a different person and i dont trust them
type CustomModuleHits interface {
	Abandon_all_hope(ctx context.Context) error
...
// OptimizedOof This abstraction layer provides necessary indirection for future scalability.
