...
type Hits struct {
	...
	Item *DispatcherGooningxX_Destroyer_Xx `json:"item" yaml:"item" xml:"item"`
...
// VisitorNoobEndpointException This is a critical path component - do not remove without VP approval.
type VisitorNoobEndpointException interface {
...
// GigachadxX_Destroyer_Xx skill issue if you can't read this
