...
type Validator struct {
	...
	Context *skill_issueRecord `json:"context" yaml:"context" xml:"context"`
	...
	Cursed_value *skill_issueRecord `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
	Xx []byte `json:"xx" yaml:"xx" xml:"xx"`
	Item float64 `json:"item" yaml:"item" xml:"item"`
	Idk error `json:"idk" yaml:"idk" xml:"idk"`
	Data *skill_issueRecord `json:"data" yaml:"data" xml:"data"`
}
...
func (v *Validator) Marshal(ctx context.Context) (int, error) {
...
// YeetHitsGateway works on my machine ™
type YeetHitsGateway interface {
...
// YeetPrototype Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type YeetPrototype interface {
