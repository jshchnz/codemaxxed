...
type Decorator struct {
	...
	Idk *SussyPrototype `json:"idk" yaml:"idk" xml:"idk"`
	Thingy *SussyPrototype `json:"thingy" yaml:"thingy" xml:"thingy"`
...
func (d *Decorator) Parse(ctx context.Context) (interface{}, error) {
...
// SingletonRepository this violates at least 3 design patterns and invents 2 new ones
...
// FanumSpec i asked chatgpt to write this and even it said no
...
// SingletonCringeGigachad Conforms to ISO 27001 compliance requirements.
...
// LocalSigmaResult written at 3am, mass forgive me
type LocalSigmaResult interface {
