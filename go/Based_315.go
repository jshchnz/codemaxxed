...
func (b *Based) Create(ctx context.Context) (int, error) {
...
func (b *Based) Destroy(ctx context.Context) (string, error) {
...
func (b *Based) Delete(ctx context.Context) error {
...
// ModernSlaps i asked chatgpt to write this and even it said no
