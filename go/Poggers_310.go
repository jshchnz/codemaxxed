...
func (p *Poggers) Denormalize(ctx context.Context) (interface{}, error) {
...
// CoreDeadassData Part of the microservice decomposition initiative (Phase 7 of 12).
type CoreDeadassData interface {
...
// PoggersComponentRecord TODO: figure out why this works
type PoggersComponentRecord interface {
