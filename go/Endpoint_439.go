...
type Endpoint struct {
	...
	Idk *ScalableHits `json:"idk" yaml:"idk" xml:"idk"`
...
// GatewayNoobSus no tests needed, it's perfect (copium)
type GatewayNoobSus interface {
...
// InterceptorFlyweightAggregator the compiler demanded a blood sacrifice and this was it
type InterceptorFlyweightAggregator interface {
