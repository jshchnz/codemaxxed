...
// GooningNoCapBruh DO NOT TOUCH - last person who modified this quit
type GooningNoCapBruh interface {
...
// DefaultNoCapHopium the code is documentation enough (it is not)
type DefaultNoCapHopium interface {
