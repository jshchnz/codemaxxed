...
type Bussin struct {
	...
	Whatever *InternalPrototypeAbstract `json:"whatever" yaml:"whatever" xml:"whatever"`
	Instance context.Context `json:"instance" yaml:"instance" xml:"instance"`
	Fix_me_please *InternalPrototypeAbstract `json:"fix_me_please" yaml:"fix_me_please" xml:"fix_me_please"`
	Whatever context.Context `json:"whatever" yaml:"whatever" xml:"whatever"`
	Tech_debt float64 `json:"tech_debt" yaml:"tech_debt" xml:"tech_debt"`
	Forbidden_knowledge float64 `json:"forbidden_knowledge" yaml:"forbidden_knowledge" xml:"forbidden_knowledge"`
	Whatever int `json:"whatever" yaml:"whatever" xml:"whatever"`
	Temp_but_permanent *InternalPrototypeAbstract `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
...
func (b *Bussin) Authenticate(ctx context.Context) (bool, error) {
...
// MaldingStonksFactory abandon all hope ye who enter here
type MaldingStonksFactory interface {
