...
// ScalablexX_Destroyer_XxBridgeSus abandon all hope ye who enter here
type ScalablexX_Destroyer_XxBridgeSus interface {
...
// InternalVibeSerializer if this breaks, blame the intern (there is no intern)
type InternalVibeSerializer interface {
