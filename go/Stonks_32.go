...
// CringeDelegate i asked chatgpt to write this and even it said no
...
// AbstractChainCringeDeadass no tests needed, it's perfect (copium)
type AbstractChainCringeDeadass interface {
