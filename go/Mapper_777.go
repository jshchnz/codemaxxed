...
type Mapper struct {
	...
	Item *LigmaFacadeGlizzy `json:"item" yaml:"item" xml:"item"`
...
func (m *Mapper) Authenticate(ctx context.Context) (int, error) {
...
// CoreLigma DO NOT MODIFY - This is load-bearing architecture.
...
// DynamicBasedPoggersProxyEntity this is load-bearing spaghetti
type DynamicBasedPoggersProxyEntity interface {
