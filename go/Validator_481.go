...
type Validator struct {
	...
	Xxx *SheeshOof `json:"xxx" yaml:"xxx" xml:"xxx"`
...
func (v *Validator) Delete(ctx context.Context) (bool, error) {
...
func (v *Validator) Evaluate(ctx context.Context) (int, error) {
...
// Oof This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
type Oof interface {
...
// EnhancedDankHitsUtil i dont know what this does but removing it breaks everything
type EnhancedDankHitsUtil interface {
