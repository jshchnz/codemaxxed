...
type Composite struct {
	...
	X *InterceptorPipeline `json:"x" yaml:"x" xml:"x"`
...
func (c *Composite) Dispatch(ctx context.Context) (bool, error) {
...
func (c *Composite) Dont_touch_this(ctx context.Context) (interface{}, error) {
...
// InternalFacadeGriddyRecord This is a critical path component - do not remove without VP approval.
type InternalFacadeGriddyRecord interface {
...
// StandardBuilderDeluluxX_Destroyer_Xx TODO: Refactor this in Q3 (written in 2019).
type StandardBuilderDeluluxX_Destroyer_Xx interface {
	Go_outside(ctx context.Context) error
	Pray_to_the_machine_spirit(ctx context.Context) error
	Evaluate(ctx context.Context) error
}

// OofPrototype if you're reading this, turn back now
