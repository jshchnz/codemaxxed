...
// ModernStonksSlay Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type ModernStonksSlay interface {
...
// YeetAdapterValidator the code is documentation enough (it is not)
type YeetAdapterValidator interface {
