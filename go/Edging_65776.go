...
type Edging struct {
	...
	Whatever *OhioObserverMalding `json:"whatever" yaml:"whatever" xml:"whatever"`
...
// VisitorConnector written at 3am, mass forgive me
type VisitorConnector interface {
...
// PrototypeException DO NOT TOUCH - last person who modified this quit
type PrototypeException interface {
