...
func (c *Controller) Bussin_fr(ctx context.Context) (bool, error) {
...
// SerializerLigmaResponse this function is cursed
type SerializerLigmaResponse interface {
...
// PoggersCopium vibe coded, do not question
