...
func (s *Slay) Marshal(ctx context.Context) (bool, error) {
...
// GlizzyGriddyGlizzy this function is cursed
type GlizzyGriddyGlizzy interface {
...
// StonksBaka if you're reading this, turn back now
