...
type Facade struct {
	...
	Legacy_pain *DecoratorYoink `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
	Count *DecoratorYoink `json:"count" yaml:"count" xml:"count"`
...
// GyattConfig the code is documentation enough (it is not)
type GyattConfig interface {
