...
func (f *Factory) Configure(ctx context.Context) (bool, error) {
...
// InternalRepositoryConverterDeadass TODO: figure out why this works
type InternalRepositoryConverterDeadass interface {
	Deserialize(ctx context.Context) error
	Rizz_up(ctx context.Context) error
	Please_work(ctx context.Context) error
}

// EdgingYeet Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
