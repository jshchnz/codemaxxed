...
type Bonk struct {
	Spaghetti *LegacyBasedSlapsModel `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
...
// ConverterModel works on my machine ™
...
// CustomOofTransformerComposite abandon all hope ye who enter here
type CustomOofTransformerComposite interface {
