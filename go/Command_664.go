...
type Command struct {
	...
	Fix_me_please *BaseRatio `json:"fix_me_please" yaml:"fix_me_please" xml:"fix_me_please"`
...
func (c *Command) Notify(ctx context.Context) (string, error) {
...
func (c *Command) Destroy(ctx context.Context) (bool, error) {
...
func (c *Command) Resolve(ctx context.Context) (interface{}, error) {
