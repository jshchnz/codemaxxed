...
type Builder struct {
	...
	Whatever *ChungusBussin `json:"whatever" yaml:"whatever" xml:"whatever"`
...
// PrototypeDispatcherSheesh past me was a different person and i dont trust them
type PrototypeDispatcherSheesh interface {
...
// PipelineMaldingRepository Reviewed and approved by the Technical Steering Committee.
type PipelineMaldingRepository interface {
