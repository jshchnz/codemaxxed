...
type Deserializer struct {
	...
	Thingy *ScalableSerializerUtils `json:"thingy" yaml:"thingy" xml:"thingy"`
...
func (d *Deserializer) Aggregate(ctx context.Context) (bool, error) {
...
// NoCapBonk TODO: Refactor this in Q3 (written in 2019).
...
// SingletonOrchestrator Optimized for enterprise-grade throughput.
type SingletonOrchestrator interface {
...
// RepositoryYeetRizzDefinition the compiler demanded a blood sacrifice and this was it
type RepositoryYeetRizzDefinition interface {
