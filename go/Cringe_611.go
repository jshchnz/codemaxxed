...
type Cringe struct {
	...
	Xxx *NoobCringeTransformer `json:"xxx" yaml:"xxx" xml:"xxx"`
...
func (c *Cringe) Aggregate(ctx context.Context) (int, error) {
...
func (c *Cringe) Decrypt(ctx context.Context) (interface{}, error) {
...
// AggregatorRatio The previous implementation was 3 lines but didn't meet enterprise standards.
...
// OhioLigmaBuilder TODO: figure out why this works
type OhioLigmaBuilder interface {
...
// ProviderMiddlewareCommand i will mass NOT be explaining this in the PR
type ProviderMiddlewareCommand interface {
