...
type Wrapper struct {
	...
	Source *AbstractRatioGlizzySheesh `json:"source" yaml:"source" xml:"source"`
...
func (w *Wrapper) Build(ctx context.Context) error {
...
func (w *Wrapper) Save(ctx context.Context) error {
...
// StaticPoggers certified bruh moment
...
// DefaultWrapperDankHopium i will mass NOT be explaining this in the PR
type DefaultWrapperDankHopium interface {
...
// StandardWrapper written at 3am, mass forgive me
type StandardWrapper interface {
	Cry(ctx context.Context) error
	Please_work(ctx context.Context) error
	Unmarshal(ctx context.Context) error
}

// GoatedMalding The previous implementation was 3 lines but didn't meet enterprise standards.
