...
func (g *GyattValue) Do_the_thing(ctx context.Context) error {
...
func (g *GyattValue) Cope(ctx context.Context) (interface{}, error) {
...
func (g *GyattValue) Fetch(ctx context.Context) (interface{}, error) {
...
func (g *GyattValue) Initialize(ctx context.Context) (string, error) {
...
func (g *GyattValue) Bussin_fr(ctx context.Context) (interface{}, error) {
...
// ControllerModel past me was a different person and i dont trust them
