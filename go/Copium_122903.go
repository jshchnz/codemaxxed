...
// MiddlewarexX_Destroyer_XxDank if this breaks, blame the intern (there is no intern)
type MiddlewarexX_Destroyer_XxDank interface {
	Yeet(ctx context.Context) error
	Serialize(ctx context.Context) error
	Mald(ctx context.Context) error
}

// StrategyGooning if you're reading this, turn back now
