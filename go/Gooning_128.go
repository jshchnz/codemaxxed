...
// GriddyCommand written at 3am, mass forgive me
...
// BaseSheeshHandler Thread-safe implementation using the double-checked locking pattern.
type BaseSheeshHandler interface {
...
// ResolverSigma skill issue if you can't read this
