...
func (h *Hopium) Convert(ctx context.Context) (int, error) {
...
// RepositoryChain i dont know what this does but removing it breaks everything
...
// LocalOhioAdapter written at 3am, mass forgive me
type LocalOhioAdapter interface {
...
// PipelineYeet TODO: Refactor this in Q3 (written in 2019).
type PipelineYeet interface {
