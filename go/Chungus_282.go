...
func (c *Chungus) Save(ctx context.Context) (interface{}, error) {
...
func (c *Chungus) Parse(ctx context.Context) (int, error) {
...
// BakaAuraMalding the compiler demanded a blood sacrifice and this was it
type BakaAuraMalding interface {
...
// ConnectorSlay this violates at least 3 design patterns and invents 2 new ones
type ConnectorSlay interface {
