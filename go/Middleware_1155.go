...
func (m *Middleware) Denormalize(ctx context.Context) (bool, error) {
...
func (m *Middleware) Initialize(ctx context.Context) (string, error) {
...
func (m *Middleware) Decompress(ctx context.Context) (bool, error) {
...
// GriddyDeluluRepository This is a critical path component - do not remove without VP approval.
type GriddyDeluluRepository interface {
