...
type Bonk struct {
	...
	Buffer *AuraSlaySkibidi `json:"buffer" yaml:"buffer" xml:"buffer"`
...
// GriddyException This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
...
// CringeSus if this breaks, blame the intern (there is no intern)
