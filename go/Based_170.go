...
func (b *Based) Create(ctx context.Context) error {
...
func (b *Based) Invalidate(ctx context.Context) (bool, error) {
...
func (b *Based) Hack_around_it(ctx context.Context) (interface{}, error) {
...
// DankL_plus_ratioResult Legacy code - here be dragons.
type DankL_plus_ratioResult interface {
...
// YoinkOrchestratorResponse This abstraction layer provides necessary indirection for future scalability.
type YoinkOrchestratorResponse interface {
	Lgtm(ctx context.Context) error
	Seethe(ctx context.Context) error
	Works_on_my_machine(ctx context.Context) error
}

// LegacyDankRizzRizz This is a critical path component - do not remove without VP approval.
type LegacyDankRizzRizz interface {
