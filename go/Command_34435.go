...
func (c *Command) Marshal(ctx context.Context) error {
...
// SlayBaka the compiler demanded a blood sacrifice and this was it
...
// ValidatorSigmaCringeConfig the code is documentation enough (it is not)
type ValidatorSigmaCringeConfig interface {
	Rizz_up(ctx context.Context) error
