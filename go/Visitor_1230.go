...
func (v *Visitor) Evaluate(ctx context.Context) (bool, error) {
...
func (v *Visitor) Dispatch(ctx context.Context) (interface{}, error) {
...
func (v *Visitor) Update(ctx context.Context) (int, error) {
...
// Mediator Legacy code - here be dragons.
...
// BaseInitializerServiceMiddleware this function is cursed
type BaseInitializerServiceMiddleware interface {
	Please_work(ctx context.Context) error
...
// StandardGriddy Legacy code - here be dragons.
