...
type Singleton struct {
	...
	Fix_me_please *BaseFactoryPoggersController `json:"fix_me_please" yaml:"fix_me_please" xml:"fix_me_please"`
...
func (s *Singleton) Process(ctx context.Context) (interface{}, error) {
...
func (s *Singleton) Authenticate(ctx context.Context) (string, error) {
...
func (s *Singleton) Parse(ctx context.Context) error {
...
// BussinInitializerGooning ¯\_(ツ)_/¯
type BussinInitializerGooning interface {
