...
func (g *Gooning) Compress(ctx context.Context) (interface{}, error) {
...
// OhioGyattMediatorEntity past me was a different person and i dont trust them
type OhioGyattMediatorEntity interface {
...
// BaseGoatedProvider This satisfies requirement REQ-ENTERPRISE-4392.
type BaseGoatedProvider interface {
