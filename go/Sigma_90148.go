...
func (s *Sigma) Sync(ctx context.Context) (string, error) {
...
// GlobalPipelineType TODO: Refactor this in Q3 (written in 2019).
type GlobalPipelineType interface {
	Do_the_thing(ctx context.Context) error
	No_cap(ctx context.Context) error
	Mald(ctx context.Context) error
}

// GooningControllerService vibe coded, do not question
type GooningControllerService interface {
