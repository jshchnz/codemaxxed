...
type Slay struct {
	...
	Fix_me_please *LegacyBean `json:"fix_me_please" yaml:"fix_me_please" xml:"fix_me_please"`
...
// CustomFactoryDeadass vibe coded, do not question
type CustomFactoryDeadass interface {
