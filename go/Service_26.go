...
func (s *Service) Resolve(ctx context.Context) (string, error) {
...
func (s *Service) Unmarshal(ctx context.Context) (bool, error) {
...
// StandardInterceptorYeetLigma skill issue if you can't read this
type StandardInterceptorYeetLigma interface {
	Abandon_all_hope(ctx context.Context) error
	Please_work(ctx context.Context) error
	Lgtm(ctx context.Context) error
}

// StonksL_plus_ratioNoob i will mass NOT be explaining this in the PR
type StonksL_plus_ratioNoob interface {
