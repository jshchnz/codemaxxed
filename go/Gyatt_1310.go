...
func (g *Gyatt) Denormalize(ctx context.Context) (int, error) {
...
func (g *Gyatt) Encrypt(ctx context.Context) (interface{}, error) {
...
// StonksDescriptor Reviewed and approved by the Technical Steering Committee.
...
// DankInterceptor the mass of code grows. it hungers. it consumes.
type DankInterceptor interface {
