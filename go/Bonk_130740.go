...
// CommandHits This was the simplest solution after 6 months of design review.
...
// DecoratorLigma Per the architecture review board decision ARB-2847.
type DecoratorLigma interface {
