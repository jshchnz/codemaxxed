...
// HopiumConfigurator if you're reading this, turn back now
...
// DefaultBakaCompositeno_bitches Implements the AbstractFactory pattern for maximum extensibility.
type DefaultBakaCompositeno_bitches interface {
