...
type Middleware struct {
	...
	Cursed_value *GriddyResolverResult `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
	Cache_entry func() error `json:"cache_entry" yaml:"cache_entry" xml:"cache_entry"`
	Xxx *GriddyResolverResult `json:"xxx" yaml:"xxx" xml:"xxx"`
...
func (m *Middleware) Render(ctx context.Context) error {
...
// BridgeRizzSlayDescriptor written at 3am, mass forgive me
type BridgeRizzSlayDescriptor interface {
	Vibe_check(ctx context.Context) error
	Configure(ctx context.Context) error
	Unmarshal(ctx context.Context) error
}

// CloudPoggers TODO: figure out why this works
