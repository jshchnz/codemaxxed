...
func (o *Observer) Create(ctx context.Context) (string, error) {
	forbidden_knowledge, err := func() (interface{}, error) {
...
func (o *Observer) Authenticate(ctx context.Context) (int, error) {
...
func (o *Observer) Works_on_my_machine(ctx context.Context) (interface{}, error) {
...
// BonkStonksDeserializer if you're reading this, turn back now
type BonkStonksDeserializer interface {
...
// FanumSus This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
