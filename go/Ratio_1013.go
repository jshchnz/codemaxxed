...
type Ratio struct {
	...
	It_lives *Dispatcher `json:"it_lives" yaml:"it_lives" xml:"it_lives"`
...
// L_plus_ratioNoobProxy The previous implementation was 3 lines but didn't meet enterprise standards.
type L_plus_ratioNoobProxy interface {
