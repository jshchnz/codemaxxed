...
func (y *Yeet) Compute(ctx context.Context) error {
...
// GenericMaldingCommandHelper no tests needed, it's perfect (copium)
type GenericMaldingCommandHelper interface {
...
// DistributedSheeshWrapperPoggers abandon all hope ye who enter here
type DistributedSheeshWrapperPoggers interface {
...
// CustomDispatcherHandlerUtils abandon all hope ye who enter here
type CustomDispatcherHandlerUtils interface {
