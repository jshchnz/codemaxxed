...
type Fanum struct {
	...
	Bruh *BruhGigachadAuraRecord `json:"bruh" yaml:"bruh" xml:"bruh"`
	X map[string]interface{} `json:"x" yaml:"x" xml:"x"`
}
...
// FactoryOhioNoCapPair This abstraction layer provides necessary indirection for future scalability.
type FactoryOhioNoCapPair interface {
...
// GlizzyBakaBaka TODO: figure out why this works
type GlizzyBakaBaka interface {
