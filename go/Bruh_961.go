...
func (b *Bruh) Evaluate(ctx context.Context) (int, error) {
...
// EnterpriseCommand DO NOT TOUCH - last person who modified this quit
...
// GyattNoobGooning i dont know what this does but removing it breaks everything
type GyattNoobGooning interface {
