...
func (c *Configurator) Cache(ctx context.Context) (string, error) {
...
func (c *Configurator) Notify(ctx context.Context) (int, error) {
...
// L_plus_ratioEdging this function is cursed
...
// ScalableAggregatorSusError if this breaks, blame the intern (there is no intern)
type ScalableAggregatorSusError interface {
