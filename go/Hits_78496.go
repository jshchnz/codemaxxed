...
type Hits struct {
	...
	Thingy *TransformerUtil `json:"thingy" yaml:"thingy" xml:"thingy"`
...
// EnterpriseConverterSheesh Thread-safe implementation using the double-checked locking pattern.
type EnterpriseConverterSheesh interface {
