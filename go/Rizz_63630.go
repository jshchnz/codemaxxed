...
// GriddyYoink i will mass NOT be explaining this in the PR
type GriddyYoink interface {
...
// SusOhioProxyInterface if this breaks, blame the intern (there is no intern)
type SusOhioProxyInterface interface {
