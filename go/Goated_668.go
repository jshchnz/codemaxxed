...
func (g *Goated) Here_be_dragons(ctx context.Context) (interface{}, error) {
...
// EdgingGigachad DO NOT TOUCH - last person who modified this quit
...
// FlyweightDeserializerHandlerSpec The previous implementation was 3 lines but didn't meet enterprise standards.
type FlyweightDeserializerHandlerSpec interface {
	Cry(ctx context.Context) error
