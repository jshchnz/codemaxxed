...
// ServiceSkibidiProxyAbstract ¯\_(ツ)_/¯
type ServiceSkibidiProxyAbstract interface {
	Vibe_check(ctx context.Context) error
	Convert(ctx context.Context) error
	Touch_grass(ctx context.Context) error
}

// GlobalGigachadCringeBased skill issue if you can't read this
type GlobalGigachadCringeBased interface {
...
// ScalableVibeFlyweightResolver past me was a different person and i dont trust them
type ScalableVibeFlyweightResolver interface {
