...
type Chungus struct {
	...
	This_shouldnt_work *YoinkCringe `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
...
func (c *Chungus) Sanitize(ctx context.Context) (bool, error) {
...
func (c *Chungus) Convert(ctx context.Context) (int, error) {
...
// ChungusGateway TODO: Refactor this in Q3 (written in 2019).
...
// GlizzyBridge skill issue if you can't read this
type GlizzyBridge interface {
...
// ConnectorHitsAura TODO: Refactor this in Q3 (written in 2019).
type ConnectorHitsAura interface {
