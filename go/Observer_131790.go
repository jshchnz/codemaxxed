...
type Observer struct {
	...
	Eldritch_data *xX_Destroyer_XxCopium `json:"eldritch_data" yaml:"eldritch_data" xml:"eldritch_data"`
	Dont_ask int `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
	Status []byte `json:"status" yaml:"status" xml:"status"`
	Temp_but_permanent string `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
	Whatever bool `json:"whatever" yaml:"whatever" xml:"whatever"`
	Metadata *xX_Destroyer_XxCopium `json:"metadata" yaml:"metadata" xml:"metadata"`
...
func (o *Observer) Deserialize(ctx context.Context) error {
...
// SlapsConfiguratorNoob ¯\_(ツ)_/¯
type SlapsConfiguratorNoob interface {
...
// GatewayLigmaNoob i dont know what this does but removing it breaks everything
type GatewayLigmaNoob interface {
