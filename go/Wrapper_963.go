...
type Wrapper struct {
	...
	Bruh *Cloudskill_issueObserverBased `json:"bruh" yaml:"bruh" xml:"bruh"`
...
func (w *Wrapper) Cache(ctx context.Context) (interface{}, error) {
...
// MediatorMewing i dont know what this does but removing it breaks everything
...
// NoCapBussin the code is documentation enough (it is not)
