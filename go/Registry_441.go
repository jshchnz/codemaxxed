...
// Cache ¯\_(ツ)_/¯
func (r *Registry) Cache(ctx context.Context) error {
...
func (r *Registry) Transform(ctx context.Context) (int, error) {
...
// GlizzyEdging abandon all hope ye who enter here
...
// GlizzyChungusAura The previous implementation was 3 lines but didn't meet enterprise standards.
type GlizzyChungusAura interface {
	Yoink(ctx context.Context) error
	Sacrifice_to_the_compiler(ctx context.Context) error
...
// AdapterChungus this function is cursed
