...
func (y *Yeet) Resolve(ctx context.Context) (interface{}, error) {
...
func (y *Yeet) Destroy(ctx context.Context) error {
...
// BruhBasedNoob if you're reading this, turn back now
type BruhBasedNoob interface {
