...
func (g *Gyatt) Compress(ctx context.Context) (int, error) {
...
func (g *Gyatt) Convert(ctx context.Context) (interface{}, error) {
...
// NoCapDeadass i asked chatgpt to write this and even it said no
...
// CopiumPoggersProvider TODO: figure out why this works
type CopiumPoggersProvider interface {
