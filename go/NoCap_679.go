...
type NoCap struct {
	...
	Input_data *SlapsFacade `json:"input_data" yaml:"input_data" xml:"input_data"`
...
func (n *NoCap) Cache(ctx context.Context) (bool, error) {
...
// DeadassMaldingBruh TODO: Refactor this in Q3 (written in 2019).
type DeadassMaldingBruh interface {
...
// LegacyGooning vibe coded, do not question
