...
type Controller struct {
	...
	Fix_me_please *GooningConfig `json:"fix_me_please" yaml:"fix_me_please" xml:"fix_me_please"`
...
// BaseHitsNoCapManager this function is cursed
type BaseHitsNoCapManager interface {
