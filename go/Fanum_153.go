...
type Fanum struct {
	...
	Entity *CoreGigachad `json:"entity" yaml:"entity" xml:"entity"`
...
func (f *Fanum) Dispatch(ctx context.Context) (int, error) {
...
func (f *Fanum) Normalize(ctx context.Context) (string, error) {
...
// DynamicGriddyBussinGriddy skill issue if you can't read this
type DynamicGriddyBussinGriddy interface {
...
// DripHits past me was a different person and i dont trust them
