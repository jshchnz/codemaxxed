...
type Stonks struct {
	...
	Idk *CopiumSlay `json:"idk" yaml:"idk" xml:"idk"`
...
// HitsRepositoryDefinition Thread-safe implementation using the double-checked locking pattern.
type HitsRepositoryDefinition interface {
