...
type Gooning struct {
	...
	Output_data *StrategyBased `json:"output_data" yaml:"output_data" xml:"output_data"`
...
func (g *Gooning) Serialize(ctx context.Context) (bool, error) {
...
// InternalCoordinatorStonks skill issue if you can't read this
type InternalCoordinatorStonks interface {
	Todo_fix_later(ctx context.Context) error
	Rizz_up(ctx context.Context) error
	Trust_me_bro(ctx context.Context) error
}

// NoCapMewingProvider i dont know what this does but removing it breaks everything
type NoCapMewingProvider interface {
