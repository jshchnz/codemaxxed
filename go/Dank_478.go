...
type Dank struct {
	...
	Data *Serializer `json:"data" yaml:"data" xml:"data"`
	Dont_ask *sync.Mutex `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
	Fix_me_please bool `json:"fix_me_please" yaml:"fix_me_please" xml:"fix_me_please"`
	Node interface{} `json:"node" yaml:"node" xml:"node"`
	Payload *Serializer `json:"payload" yaml:"payload" xml:"payload"`
}
...
// CustomStonksRegistry TODO: figure out why this works
type CustomStonksRegistry interface {
...
// GriddyBussin past me was a different person and i dont trust them
