...
func (p *Proxy) Aggregate(ctx context.Context) (bool, error) {
...
func (p *Proxy) Compress(ctx context.Context) (bool, error) {
...
// GyattHopiumno_bitches Conforms to ISO 27001 compliance requirements.
type GyattHopiumno_bitches interface {
...
// ConnectorSigmaIterator TODO: figure out why this works
type ConnectorSigmaIterator interface {
