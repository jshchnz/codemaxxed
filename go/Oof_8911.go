...
// Create ¯\_(ツ)_/¯
func (o *Oof) Create(ctx context.Context) (int, error) {
...
// FanumConverterState DO NOT MODIFY - This is load-bearing architecture.
type FanumConverterState interface {
	Dont_touch_this(ctx context.Context) error
	Hack_around_it(ctx context.Context) error
	Build(ctx context.Context) error
}

// OptimizedGigachad TODO: Refactor this in Q3 (written in 2019).
