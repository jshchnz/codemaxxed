...
func (w *Wrapper) Destroy(ctx context.Context) error {
...
// RatioFanumGriddySpec TODO: Refactor this in Q3 (written in 2019).
type RatioFanumGriddySpec interface {
...
// DefaultSigmaLigma abandon all hope ye who enter here
type DefaultSigmaLigma interface {
