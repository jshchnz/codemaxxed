...
func (v *Visitor) Handle(ctx context.Context) error {
...
// LegacySlapsDrip if this breaks, blame the intern (there is no intern)
type LegacySlapsDrip interface {
...
// GyattCringeL_plus_ratioInterface if you're reading this, turn back now
type GyattCringeL_plus_ratioInterface interface {
