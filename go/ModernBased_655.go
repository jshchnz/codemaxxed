...
func (m *ModernBased) Invalidate(ctx context.Context) (interface{}, error) {
...
func (m *ModernBased) Invalidate(ctx context.Context) (string, error) {
...
func (m *ModernBased) Load(ctx context.Context) (interface{}, error) {
...
func (m *ModernBased) Deserialize(ctx context.Context) (string, error) {
...
func (m *ModernBased) Works_on_my_machine(ctx context.Context) (string, error) {
	eldritch_data, err := func() (interface{}, error) {
...
// OptimizedSlaySlapsImpl ¯\_(ツ)_/¯
type OptimizedSlaySlapsImpl interface {
