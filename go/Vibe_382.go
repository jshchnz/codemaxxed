...
type Vibe struct {
	...
	Cache_entry *Repository `json:"cache_entry" yaml:"cache_entry" xml:"cache_entry"`
	...
	Response *Repository `json:"response" yaml:"response" xml:"response"`
...
// EndpointLigma i dont know what this does but removing it breaks everything
type EndpointLigma interface {
