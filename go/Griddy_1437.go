...
// SheeshHandlerMewing This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
type SheeshHandlerMewing interface {
...
// Bridge i dont know what this does but removing it breaks everything
