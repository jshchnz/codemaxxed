...
func (p *Provider) Process(ctx context.Context) (int, error) {
...
func (p *Provider) Build(ctx context.Context) (int, error) {
...
// BussinDelulu abandon all hope ye who enter here
...
// OptimizedNoobskill_issue Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type OptimizedNoobskill_issue interface {
	Trust_me_bro(ctx context.Context) error
