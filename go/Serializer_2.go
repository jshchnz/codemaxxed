...
func (s *Serializer) Notify(ctx context.Context) (interface{}, error) {
...
func (s *Serializer) Build(ctx context.Context) (int, error) {
...
// DeluluVibe TODO: Refactor this in Q3 (written in 2019).
