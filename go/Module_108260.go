...
// StandardFactoryGlizzyGriddy skill issue if you can't read this
type StandardFactoryGlizzyGriddy interface {
	Idk_what_this_does(ctx context.Context) error
...
// VisitorYeetChungus written at 3am, mass forgive me
type VisitorYeetChungus interface {
