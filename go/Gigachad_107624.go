...
// no_bitchesSigmaDank works on my machine ™
type no_bitchesSigmaDank interface {
...
// MaldingBonkSingleton if this breaks, blame the intern (there is no intern)
type MaldingBonkSingleton interface {
