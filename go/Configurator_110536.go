...
type Configurator struct {
	...
	Legacy_pain *GlizzyHopium `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
...
// InternalNoobNoobBussin ¯\_(ツ)_/¯
type InternalNoobNoobBussin interface {
...
// CloudBussin This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
...
// CopiumImpl written at 3am, mass forgive me
...
// OhioYoink no tests needed, it's perfect (copium)
