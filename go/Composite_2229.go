...
func (c *Composite) Decompress(ctx context.Context) (string, error) {
...
// CommandSlayBussin TODO: figure out why this works
type CommandSlayBussin interface {
...
// StaticNoobBussinLigma abandon all hope ye who enter here
type StaticNoobBussinLigma interface {
...
// LocalCompositeDeluluSussy This was the simplest solution after 6 months of design review.
type LocalCompositeDeluluSussy interface {
	Pray_to_the_machine_spirit(ctx context.Context) error
	Seethe(ctx context.Context) error
	Lgtm(ctx context.Context) error
}

// YeetGoatedPoggers works on my machine ™
type YeetGoatedPoggers interface {
