...
type Chain struct {
	...
	Xxx *DefaultSlay `json:"xxx" yaml:"xxx" xml:"xxx"`
...
func (c *Chain) Hack_around_it(ctx context.Context) (bool, error) {
	thingy, err := func() (interface{}, error) {
...
func (c *Chain) Serialize(ctx context.Context) (interface{}, error) {
...
// CustomStonksConnectorAdapter Legacy code - here be dragons.
type CustomStonksConnectorAdapter interface {
