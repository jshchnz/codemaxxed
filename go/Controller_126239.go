...
func (c *Controller) Compress(ctx context.Context) (int, error) {
...
// RatioInitializerType the code is documentation enough (it is not)
type RatioInitializerType interface {
...
// InternalNoCapConfiguratorxX_Destroyer_Xx DO NOT TOUCH - last person who modified this quit
type InternalNoCapConfiguratorxX_Destroyer_Xx interface {
