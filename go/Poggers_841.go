...
type Poggers struct {
	...
	Magic_number *DynamicMewingEntity `json:"magic_number" yaml:"magic_number" xml:"magic_number"`
...
// GriddyDeluluBussin if you're reading this, turn back now
type GriddyDeluluBussin interface {
