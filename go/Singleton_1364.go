...
func (s *Singleton) Persist(ctx context.Context) (string, error) {
...
// InternalHitsskill_issueHelper the code is documentation enough (it is not)
type InternalHitsskill_issueHelper interface {
...
// OptimizedSusHopium skill issue if you can't read this
type OptimizedSusHopium interface {
