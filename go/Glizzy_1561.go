...
type Glizzy struct {
	...
	It_lives *DefaultxX_Destroyer_Xx `json:"it_lives" yaml:"it_lives" xml:"it_lives"`
...
func (g *Glizzy) Sync(ctx context.Context) (int, error) {
...
// L_plus_ratioOof if you're reading this, turn back now
...
// StrategyRegistry This was the simplest solution after 6 months of design review.
