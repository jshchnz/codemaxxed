...
type Gooning struct {
	...
	This_shouldnt_work *BussinOofGoatedValue `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
...
func (g *Gooning) Denormalize(ctx context.Context) (interface{}, error) {
...
func (g *Gooning) Build(ctx context.Context) (int, error) {
...
func (g *Gooning) Authenticate(ctx context.Context) error {
...
// BruhStrategyMewing TODO: figure out why this works
type BruhStrategyMewing interface {
...
// DankBussin this is load-bearing spaghetti
