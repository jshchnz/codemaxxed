...
// BonkSlayBridge i dont know what this does but removing it breaks everything
type BonkSlayBridge interface {
	Format(ctx context.Context) error
	No_cap(ctx context.Context) error
	Idk_what_this_does(ctx context.Context) error
}

// StonksRatioConverterType vibe coded, do not question
type StonksRatioConverterType interface {
