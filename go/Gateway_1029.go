...
func (g *Gateway) Transform(ctx context.Context) (interface{}, error) {
...
func (g *Gateway) Marshal(ctx context.Context) error {
...
func (g *Gateway) Dispatch(ctx context.Context) (interface{}, error) {
...
// DeadassGyattBonk the code is documentation enough (it is not)
type DeadassGyattBonk interface {
...
// StaticSlaps Lorem ipsum dolor sit amet, consectetur adipiscing elit.
...
// StaticCringeSkibidi Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type StaticCringeSkibidi interface {
