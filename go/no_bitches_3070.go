...
func (n *no_bitches) Convert(ctx context.Context) (interface{}, error) {
...
func (n *no_bitches) Delete(ctx context.Context) (int, error) {
...
func (n *no_bitches) Denormalize(ctx context.Context) (int, error) {
...
func (n *no_bitches) Save(ctx context.Context) error {
...
// PoggersBussin the compiler demanded a blood sacrifice and this was it
...
// Deadassno_bitchesVibe this function is cursed
type Deadassno_bitchesVibe interface {
