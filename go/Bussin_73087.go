...
// SigmaAggregator vibe coded, do not question
type SigmaAggregator interface {
...
// GenericYoinkEndpoint if this breaks, blame the intern (there is no intern)
type GenericYoinkEndpoint interface {
