...
// DynamicGoatedL_plus_ratioImpl Per the architecture review board decision ARB-2847.
type DynamicGoatedL_plus_ratioImpl interface {
...
// BakaHits this is load-bearing spaghetti
