...
func (s *Singleton) Create(ctx context.Context) (int, error) {
...
// SkibidiDeserializerDescriptor if you're reading this, turn back now
type SkibidiDeserializerDescriptor interface {
...
// SheeshDripModel i asked chatgpt to write this and even it said no
type SheeshDripModel interface {
