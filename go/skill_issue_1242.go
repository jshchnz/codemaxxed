...
type skill_issue struct {
	...
	Thingy map[string]interface{} `json:"thingy" yaml:"thingy" xml:"thingy"`
	This_shouldnt_work *FanumSigma `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
...
func (s *skill_issue) Execute(ctx context.Context) error {
...
// BridgeMapper Optimized for enterprise-grade throughput.
...
// LegacyResolverState i asked chatgpt to write this and even it said no
type LegacyResolverState interface {
