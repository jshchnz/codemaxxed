...
type Deserializer struct {
	...
	Magic_number *CustomYeetEdging `json:"magic_number" yaml:"magic_number" xml:"magic_number"`
...
// DeserializerGoatedGoatedAbstract i asked chatgpt to write this and even it said no
type DeserializerGoatedGoatedAbstract interface {
...
// ModernDispatcherUtil skill issue if you can't read this
type ModernDispatcherUtil interface {
