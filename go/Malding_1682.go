...
// Sigmano_bitchesValue TODO: figure out why this works
type Sigmano_bitchesValue interface {
...
// InternalL_plus_ratioBasedDank Thread-safe implementation using the double-checked locking pattern.
type InternalL_plus_ratioBasedDank interface {
