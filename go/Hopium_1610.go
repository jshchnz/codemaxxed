...
type Hopium struct {
	...
	Whatever *LocalRepositoryBridge `json:"whatever" yaml:"whatever" xml:"whatever"`
...
// DripConverter if this breaks, blame the intern (there is no intern)
type DripConverter interface {
...
// MaldingBussinKind this is load-bearing spaghetti
type MaldingBussinKind interface {
