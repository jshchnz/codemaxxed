...
type Fanum struct {
	...
	It_lives *ChainMediatorSlaps `json:"it_lives" yaml:"it_lives" xml:"it_lives"`
...
// BasedHitsCopium works on my machine ™
type BasedHitsCopium interface {
...
// ManagerGlizzyRepository i will mass NOT be explaining this in the PR
type ManagerGlizzyRepository interface {
...
// ProviderGatewayNoob DO NOT TOUCH - last person who modified this quit
type ProviderGatewayNoob interface {
