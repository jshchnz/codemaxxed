...
type Flyweight struct {
	...
	The_darkness *BonkFlyweightBussinImpl `json:"the_darkness" yaml:"the_darkness" xml:"the_darkness"`
	...
	Status *BonkFlyweightBussinImpl `json:"status" yaml:"status" xml:"status"`
...
func (f *Flyweight) Refresh(ctx context.Context) (interface{}, error) {
...
// StandardValidatorModel this function is cursed
type StandardValidatorModel interface {
...
// MaldingBasedCringe Legacy code - here be dragons.
type MaldingBasedCringe interface {
