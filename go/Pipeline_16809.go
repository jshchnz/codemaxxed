...
func (p *Pipeline) Ship_it(ctx context.Context) (string, error) {
...
func (p *Pipeline) Decrypt(ctx context.Context) (interface{}, error) {
...
func (p *Pipeline) Marshal(ctx context.Context) (string, error) {
...
func (p *Pipeline) Save(ctx context.Context) (interface{}, error) {
...
// SlayFanumChungus this is load-bearing spaghetti
type SlayFanumChungus interface {
