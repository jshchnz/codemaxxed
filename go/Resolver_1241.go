...
func (r *Resolver) Unmarshal(ctx context.Context) (interface{}, error) {
...
func (r *Resolver) Lgtm(ctx context.Context) (interface{}, error) {
...
// EdgingBaka this function is cursed
...
// LocalVibeGigachadGriddy this function is cursed
type LocalVibeGigachadGriddy interface {
...
// TransformerDankYoink i dont know what this does but removing it breaks everything
type TransformerDankYoink interface {
	Works_on_my_machine(ctx context.Context) error
