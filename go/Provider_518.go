...
func (p *Provider) Format(ctx context.Context) (interface{}, error) {
...
// AuraBased certified bruh moment
...
// CopiumIteratorSpec Part of the microservice decomposition initiative (Phase 7 of 12).
type CopiumIteratorSpec interface {
...
// skill_issueDeserializer ¯\_(ツ)_/¯
type skill_issueDeserializer interface {
