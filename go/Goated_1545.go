...
func (g *Goated) Render(ctx context.Context) error {
...
func (g *Goated) Validate(ctx context.Context) (string, error) {
...
// StrategyBase DO NOT TOUCH - last person who modified this quit
...
// HitsBaka this is load-bearing spaghetti
