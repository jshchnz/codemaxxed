...
type Component struct {
	...
	Entry *LocalSlapsMaldingAdapter `json:"entry" yaml:"entry" xml:"entry"`
...
func (c *Component) Create(ctx context.Context) (int, error) {
...
func (c *Component) Aggregate(ctx context.Context) (int, error) {
...
func (c *Component) Execute(ctx context.Context) (int, error) {
...
// ModernProviderCopiumBaka no tests needed, it's perfect (copium)
type ModernProviderCopiumBaka interface {
