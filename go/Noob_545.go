...
func (n *Noob) Notify(ctx context.Context) (int, error) {
...
// YeetHits TODO: Refactor this in Q3 (written in 2019).
...
// OofYeetConfiguratorConfig i dont know what this does but removing it breaks everything
type OofYeetConfiguratorConfig interface {
	Cope(ctx context.Context) error
