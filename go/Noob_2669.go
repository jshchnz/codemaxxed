...
type Noob struct {
	...
	Destination *InitializerEdging `json:"destination" yaml:"destination" xml:"destination"`
...
func (n *Noob) Go_outside(ctx context.Context) (int, error) {
...
func (n *Noob) Transform(ctx context.Context) (interface{}, error) {
...
func (n *Noob) Compress(ctx context.Context) (interface{}, error) {
...
// FanumNoCapStonks certified bruh moment
type FanumNoCapStonks interface {
	Ship_it(ctx context.Context) error
	Aggregate(ctx context.Context) error
	Idk_what_this_does(ctx context.Context) error
}

// GriddyRizzMalding the code is documentation enough (it is not)
type GriddyRizzMalding interface {
