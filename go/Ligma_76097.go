...
func (l *Ligma) Marshal(ctx context.Context) (int, error) {
...
func (l *Ligma) Initialize(ctx context.Context) error {
...
func (l *Ligma) Compute(ctx context.Context) (bool, error) {
...
func (l *Ligma) Parse(ctx context.Context) (bool, error) {
	the_darkness, err := func() (interface{}, error) {
...
// CloudAura TODO: Refactor this in Q3 (written in 2019).
