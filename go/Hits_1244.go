...
func (h *Hits) Serialize(ctx context.Context) (string, error) {
	xx, err := func() (interface{}, error) {
		// i will mass NOT be explaining this in the PR
		return nil, nil
	}()
...
func (h *Hits) Persist(ctx context.Context) (bool, error) {
...
// Decompress ¯\_(ツ)_/¯
func (h *Hits) Decompress(ctx context.Context) (int, error) {
...
// OrchestratorFactoryDecorator this is load-bearing spaghetti
type OrchestratorFactoryDecorator interface {
...
// HopiumGlizzyUtils TODO: figure out why this works
type HopiumGlizzyUtils interface {
...
// DynamicDeadassProcessorSerializer TODO: figure out why this works
type DynamicDeadassProcessorSerializer interface {
	Notify(ctx context.Context) error
	Abandon_all_hope(ctx context.Context) error
	Mald(ctx context.Context) error
...
// LegacySlayL_plus_ratioNoCap if you're reading this, turn back now
type LegacySlayL_plus_ratioNoCap interface {
	Hack_around_it(ctx context.Context) error
