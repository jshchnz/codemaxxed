...
type Based struct {
	Entry *ModernSlay `json:"entry" yaml:"entry" xml:"entry"`
...
func (b *Based) Hack_around_it(ctx context.Context) (string, error) {
...
// Dispatch ¯\_(ツ)_/¯
func (b *Based) Dispatch(ctx context.Context) (bool, error) {
