...
func (a *Adapter) Sanitize(ctx context.Context) error {
...
func (a *Adapter) Parse(ctx context.Context) (string, error) {
...
// TransformerBussin Implements the AbstractFactory pattern for maximum extensibility.
...
// CommandDankEndpointInterface no tests needed, it's perfect (copium)
type CommandDankEndpointInterface interface {
