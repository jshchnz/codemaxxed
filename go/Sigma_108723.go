...
type Sigma struct {
	...
	Tech_debt *GyattConnector `json:"tech_debt" yaml:"tech_debt" xml:"tech_debt"`
...
func (s *Sigma) Process(ctx context.Context) (int, error) {
...
func (s *Sigma) Normalize(ctx context.Context) error {
...
func (s *Sigma) Delete(ctx context.Context) (interface{}, error) {
...
// ModernSigmaDank This abstraction layer provides necessary indirection for future scalability.
type ModernSigmaDank interface {
...
// DistributedMapper if this breaks, blame the intern (there is no intern)
