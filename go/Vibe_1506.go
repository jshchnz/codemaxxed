...
func (v *Vibe) Validate(ctx context.Context) (int, error) {
...
// IteratorDeluluBasedSpec if this breaks, blame the intern (there is no intern)
type IteratorDeluluBasedSpec interface {
...
// VibeOofEdgingException Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type VibeOofEdgingException interface {
