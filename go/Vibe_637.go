...
// ModuleDankInfo if you're reading this, turn back now
type ModuleDankInfo interface {
...
// EnhancedGigachadAggregatorno_bitches this is load-bearing spaghetti
type EnhancedGigachadAggregatorno_bitches interface {
	Lgtm(ctx context.Context) error
	Mald(ctx context.Context) error
	Update(ctx context.Context) error
}

// GriddySheeshSheesh this is load-bearing spaghetti
type GriddySheeshSheesh interface {
