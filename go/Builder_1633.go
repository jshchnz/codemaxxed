...
// BruhYoink Implements the AbstractFactory pattern for maximum extensibility.
...
// RepositoryMediatorDelulu skill issue if you can't read this
type RepositoryMediatorDelulu interface {
