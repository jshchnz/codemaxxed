...
// InternalNoobEdgingBonk the code is documentation enough (it is not)
type InternalNoobEdgingBonk interface {
...
// AbstractDeluluYoinkRatio this is load-bearing spaghetti
type AbstractDeluluYoinkRatio interface {
	Idk_what_this_does(ctx context.Context) error
...
// FacadeInterface DO NOT MODIFY - This is load-bearing architecture.
...
// Service no tests needed, it's perfect (copium)
