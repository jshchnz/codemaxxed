...
func (a *Aura) Serialize(ctx context.Context) (int, error) {
...
func (a *Aura) Notify(ctx context.Context) error {
...
// EnterpriseDelegateIterator if this breaks, blame the intern (there is no intern)
type EnterpriseDelegateIterator interface {
	Trust_me_bro(ctx context.Context) error
	Handle(ctx context.Context) error
	Authorize(ctx context.Context) error
}

// AggregatorDescriptor written at 3am, mass forgive me
type AggregatorDescriptor interface {
...
// AdapterRequest This satisfies requirement REQ-ENTERPRISE-4392.
