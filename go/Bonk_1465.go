...
type Bonk struct {
	...
	Item *ModernSlayConfig `json:"item" yaml:"item" xml:"item"`
	...
	Element *ModernSlayConfig `json:"element" yaml:"element" xml:"element"`
...
// Cache ¯\_(ツ)_/¯
func (b *Bonk) Cache(ctx context.Context) (bool, error) {
...
func (b *Bonk) Sync(ctx context.Context) (string, error) {
...
// DistributedMediator past me was a different person and i dont trust them
