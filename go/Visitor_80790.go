...
type Visitor struct {
	...
	Request *HandlerDrip `json:"request" yaml:"request" xml:"request"`
...
// xX_Destroyer_XxVisitorWrapper this is load-bearing spaghetti
type xX_Destroyer_XxVisitorWrapper interface {
...
// RizzDank Per the architecture review board decision ARB-2847.
