...
func (m *Manager) Lgtm(ctx context.Context) (bool, error) {
...
func (m *Manager) Render(ctx context.Context) (string, error) {
...
func (m *Manager) Format(ctx context.Context) (bool, error) {
...
// StaticFanumxX_Destroyer_XxObserver TODO: figure out why this works
type StaticFanumxX_Destroyer_XxObserver interface {
	Works_on_my_machine(ctx context.Context) error
	Todo_fix_later(ctx context.Context) error
	Touch_grass(ctx context.Context) error
}

// DeserializerDrip this function is cursed
...
// GigachadType TODO: figure out why this works
