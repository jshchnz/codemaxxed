...
func (e *Endpoint) Delete(ctx context.Context) (bool, error) {
...
// CorePoggersGyatt this violates at least 3 design patterns and invents 2 new ones
type CorePoggersGyatt interface {
...
// EnhancedRatioDeluluDelulu this function is cursed
type EnhancedRatioDeluluDelulu interface {
