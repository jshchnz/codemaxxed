...
func (s *Service) Denormalize(ctx context.Context) (string, error) {
...
func (s *Service) Execute(ctx context.Context) (bool, error) {
...
// AbstractChainL_plus_ratioVibe This was the simplest solution after 6 months of design review.
type AbstractChainL_plus_ratioVibe interface {
...
// HitsMediatorContext i asked chatgpt to write this and even it said no
type HitsMediatorContext interface {
