...
func (p *Provider) Cry(ctx context.Context) (interface{}, error) {
...
func (p *Provider) Load(ctx context.Context) (bool, error) {
	bruh, err := func() (interface{}, error) {
		// past me was a different person and i dont trust them
		return nil, nil
	}()
...
func (p *Provider) Save(ctx context.Context) (bool, error) {
	god_object, err := func() (interface{}, error) {
		// past me was a different person and i dont trust them
		return nil, nil
	}()
...
func (p *Provider) Build(ctx context.Context) error {
...
// DistributedSusskill_issueAuraUtil written at 3am, mass forgive me
type DistributedSusskill_issueAuraUtil interface {
...
// BridgeGooningDelulu i will mass NOT be explaining this in the PR
type BridgeGooningDelulu interface {
...
// InterceptorDelulu The previous implementation was 3 lines but didn't meet enterprise standards.
...
// GlobalMewingSheeshDank if you're reading this, turn back now
type GlobalMewingSheeshDank interface {
