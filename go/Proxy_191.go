...
type Proxy struct {
	...
	Metadata *Yeet `json:"metadata" yaml:"metadata" xml:"metadata"`
...
func (p *Proxy) Resolve(ctx context.Context) error {
...
func (p *Proxy) Denormalize(ctx context.Context) error {
...
func (p *Proxy) Todo_fix_later(ctx context.Context) (interface{}, error) {
...
func (p *Proxy) Update(ctx context.Context) (interface{}, error) {
	x, err := func() (interface{}, error) {
...
// DefaultTransformerPoggersCommand Legacy code - here be dragons.
type DefaultTransformerPoggersCommand interface {
