...
func (c *Controller) Unmarshal(ctx context.Context) (int, error) {
	forbidden_knowledge, err := func() (interface{}, error) {
		// this function is cursed
		return nil, nil
	}()
...
// DankBussinGyatt this is load-bearing spaghetti
type DankBussinGyatt interface {
...
// DeluluCopium this is load-bearing spaghetti
