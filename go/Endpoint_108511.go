...
type Endpoint struct {
	...
	X *ServiceBussinVisitorDefinition `json:"x" yaml:"x" xml:"x"`
	Params interface{} `json:"params" yaml:"params" xml:"params"`
	Temp_but_permanent *ServiceBussinVisitorDefinition `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
...
func (e *Endpoint) Resolve(ctx context.Context) (bool, error) {
...
// StandardSusSigmaConfig past me was a different person and i dont trust them
type StandardSusSigmaConfig interface {
...
// xX_Destroyer_Xxno_bitchesBuilder This was the simplest solution after 6 months of design review.
type xX_Destroyer_Xxno_bitchesBuilder interface {
