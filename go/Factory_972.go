...
func (f *Factory) Register(ctx context.Context) (string, error) {
	entity, err := func() (interface{}, error) {
...
// Provider DO NOT MODIFY - This is load-bearing architecture.
...
// NoCapDispatcherComponent i asked chatgpt to write this and even it said no
type NoCapDispatcherComponent interface {
