...
func (s *Sus) Cry(ctx context.Context) (string, error) {
...
func (s *Sus) Aggregate(ctx context.Context) error {
...
func (s *Sus) Convert(ctx context.Context) (bool, error) {
...
func (s *Sus) Yeet(ctx context.Context) (string, error) {
	params, err := func() (interface{}, error) {
		// written at 3am, mass forgive me
		return nil, nil
	}()
...
// MewingBruhL_plus_ratio skill issue if you can't read this
type MewingBruhL_plus_ratio interface {
...
// GooningBasedGyatt Legacy code - here be dragons.
type GooningBasedGyatt interface {
