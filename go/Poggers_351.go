...
type Poggers struct {
	...
	Whatever *EnhancedStonksNoob `json:"whatever" yaml:"whatever" xml:"whatever"`
...
// SigmaL_plus_ratioVisitor TODO: Refactor this in Q3 (written in 2019).
type SigmaL_plus_ratioVisitor interface {
