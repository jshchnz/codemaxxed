...
type Baka struct {
	Xxx *ManagerSlayPipelineModel `json:"xxx" yaml:"xxx" xml:"xxx"`
...
func (b *Baka) Normalize(ctx context.Context) (interface{}, error) {
	cursed_value, err := func() (interface{}, error) {
...
// VisitorOhioGyatt abandon all hope ye who enter here
type VisitorOhioGyatt interface {
...
// InterceptorCringeYeetValue ¯\_(ツ)_/¯
type InterceptorCringeYeetValue interface {
	Abandon_all_hope(ctx context.Context) error
