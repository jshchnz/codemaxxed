...
type Rizz struct {
	...
	Source *BaseDripGoatedYoink `json:"source" yaml:"source" xml:"source"`
...
func (r *Rizz) Validate(ctx context.Context) (bool, error) {
...
func (r *Rizz) Unmarshal(ctx context.Context) (bool, error) {
...
// EndpointMewing this violates at least 3 design patterns and invents 2 new ones
...
// NoobOof abandon all hope ye who enter here
