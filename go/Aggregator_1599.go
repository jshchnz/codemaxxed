...
func (a *Aggregator) Serialize(ctx context.Context) (bool, error) {
...
// FlyweightCringe this violates at least 3 design patterns and invents 2 new ones
...
// GatewayPipeline Legacy code - here be dragons.
