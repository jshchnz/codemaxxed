...
func (p *Provider) Destroy(ctx context.Context) (string, error) {
...
func (p *Provider) Dispatch(ctx context.Context) (int, error) {
...
// ModernYeet This satisfies requirement REQ-ENTERPRISE-4392.
...
// LocalHopium written at 3am, mass forgive me
