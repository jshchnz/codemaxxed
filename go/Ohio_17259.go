...
type Ohio struct {
	...
	State *BaseDeserializerCringe `json:"state" yaml:"state" xml:"state"`
...
// DeserializerConfiguratorDefinition The previous implementation was 3 lines but didn't meet enterprise standards.
type DeserializerConfiguratorDefinition interface {
