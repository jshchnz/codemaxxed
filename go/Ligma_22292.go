...
func (l *Ligma) Configure(ctx context.Context) (string, error) {
...
func (l *Ligma) Notify(ctx context.Context) (bool, error) {
...
func (l *Ligma) Marshal(ctx context.Context) error {
...
// BonkBussinValidator abandon all hope ye who enter here
type BonkBussinValidator interface {
...
// BonkCommand This is a critical path component - do not remove without VP approval.
