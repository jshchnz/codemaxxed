...
// ConfiguratorAggregator past me was a different person and i dont trust them
type ConfiguratorAggregator interface {
	Save(ctx context.Context) error
	Compress(ctx context.Context) error
	Bussin_fr(ctx context.Context) error
}

// BeanBruhVibe the code is documentation enough (it is not)
type BeanBruhVibe interface {
