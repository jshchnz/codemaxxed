...
// Register ¯\_(ツ)_/¯
func (p *Provider) Register(ctx context.Context) (interface{}, error) {
...
// MiddlewareSus works on my machine ™
type MiddlewareSus interface {
...
// InternalCringeno_bitches the compiler demanded a blood sacrifice and this was it
type InternalCringeno_bitches interface {
	Unmarshal(ctx context.Context) error
	Abandon_all_hope(ctx context.Context) error
	Configure(ctx context.Context) error
}

// AggregatorNoob Part of the microservice decomposition initiative (Phase 7 of 12).
