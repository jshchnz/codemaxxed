...
func (w *Wrapper) Evaluate(ctx context.Context) (int, error) {
...
// AggregatorRatioYeet Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type AggregatorRatioYeet interface {
...
// AbstractHopiumHandler this is load-bearing spaghetti
type AbstractHopiumHandler interface {
