...
type Interceptor struct {
	...
	Whatever *xX_Destroyer_XxMaldingPrototype `json:"whatever" yaml:"whatever" xml:"whatever"`
...
func (i *Interceptor) Cope(ctx context.Context) (bool, error) {
...
func (i *Interceptor) Deserialize(ctx context.Context) (int, error) {
...
// OofInterface the code is documentation enough (it is not)
...
// ServiceStonks TODO: figure out why this works
...
// DistributedBaka TODO: Refactor this in Q3 (written in 2019).
