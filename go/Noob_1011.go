...
// StandardComponent This is a critical path component - do not remove without VP approval.
...
// PipelineOrchestratorDescriptor Part of the microservice decomposition initiative (Phase 7 of 12).
type PipelineOrchestratorDescriptor interface {
...
// DefaultConnector i will mass NOT be explaining this in the PR
...
// DeluluSussyDeadass skill issue if you can't read this
type DeluluSussyDeadass interface {
