...
func (i *Iterator) Deserialize(ctx context.Context) (interface{}, error) {
	legacy_pain, err := func() (interface{}, error) {
		// works on my machine ™
		return nil, nil
	}()
...
func (i *Iterator) Parse(ctx context.Context) (bool, error) {
...
// DeluluMapper abandon all hope ye who enter here
...
// FactoryDeluluLigma this function is cursed
type FactoryDeluluLigma interface {
...
// PipelineStrategy skill issue if you can't read this
