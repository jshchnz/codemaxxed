...
func (d *Delegate) Cache(ctx context.Context) error {
...
func (d *Delegate) Refresh(ctx context.Context) (int, error) {
...
func (d *Delegate) Authenticate(ctx context.Context) (interface{}, error) {
...
// OofYeet Lorem ipsum dolor sit amet, consectetur adipiscing elit.
...
// CoreDank Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
...
// CustomMediatorPipelineGooning the code is documentation enough (it is not)
type CustomMediatorPipelineGooning interface {
	Touch_grass(ctx context.Context) error
