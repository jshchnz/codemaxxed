...
func (s *Slaps) Go_outside(ctx context.Context) (int, error) {
...
// ChungusYoinkModule i will mass NOT be explaining this in the PR
type ChungusYoinkModule interface {
...
// CloudGooningNoCap this violates at least 3 design patterns and invents 2 new ones
type CloudGooningNoCap interface {
...
// GatewayHandler written at 3am, mass forgive me
...
// AbstractGigachadGigachadBussin this is load-bearing spaghetti
type AbstractGigachadGigachadBussin interface {
