...
func (c *Chungus) Convert(ctx context.Context) (string, error) {
...
func (c *Chungus) Vibe_check(ctx context.Context) (int, error) {
...
// GriddyGoatedEntity the compiler demanded a blood sacrifice and this was it
type GriddyGoatedEntity interface {
...
// GooningSpec written at 3am, mass forgive me
type GooningSpec interface {
