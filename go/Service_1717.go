...
type Service struct {
	...
	Node *Configurator `json:"node" yaml:"node" xml:"node"`
...
func (s *Service) Mald(ctx context.Context) (interface{}, error) {
...
// EnterpriseBussinskill_issueComposite Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type EnterpriseBussinskill_issueComposite interface {
