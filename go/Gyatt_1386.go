...
type Gyatt struct {
	...
	It_lives *CustomAggregator `json:"it_lives" yaml:"it_lives" xml:"it_lives"`
...
func (g *Gyatt) Fetch(ctx context.Context) (int, error) {
...
// SusFactory the compiler demanded a blood sacrifice and this was it
