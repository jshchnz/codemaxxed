...
func (g *Gateway) Fetch(ctx context.Context) (int, error) {
...
func (g *Gateway) Persist(ctx context.Context) (interface{}, error) {
...
// WrapperIterator written at 3am, mass forgive me
...
// GooningCopium the code is documentation enough (it is not)
