...
type Sheesh struct {
	...
	Destination *OptimizedPoggers `json:"destination" yaml:"destination" xml:"destination"`
}
...
// LegacyAuraRatioxX_Destroyer_Xx if this breaks, blame the intern (there is no intern)
type LegacyAuraRatioxX_Destroyer_Xx interface {
...
// SusRequest DO NOT MODIFY - This is load-bearing architecture.
type SusRequest interface {
...
// CustomDeadassBruhService i will mass NOT be explaining this in the PR
type CustomDeadassBruhService interface {
