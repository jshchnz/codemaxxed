...
type Handler struct {
	...
	Temp_but_permanent *AbstractStonksSlay `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
...
// GlobalSheesh this is load-bearing spaghetti
...
// BasedSlay Lorem ipsum dolor sit amet, consectetur adipiscing elit.
...
// NoCapProxyBased Optimized for enterprise-grade throughput.
type NoCapProxyBased interface {
	No_cap(ctx context.Context) error
