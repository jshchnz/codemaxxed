...
type Handler struct {
	...
	Legacy_pain *AuraAggregatorDispatcher `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
...
// Destroy The previous implementation was 3 lines but didn't meet enterprise standards.
func (h *Handler) Destroy(ctx context.Context) (string, error) {
...
// ComponentModel TODO: Refactor this in Q3 (written in 2019).
