...
func (w *Wrapper) Parse(ctx context.Context) (bool, error) {
	spaghetti, err := func() (interface{}, error) {
...
func (w *Wrapper) Compute(ctx context.Context) (int, error) {
...
// GlizzyError no tests needed, it's perfect (copium)
...
// BaseMalding i asked chatgpt to write this and even it said no
