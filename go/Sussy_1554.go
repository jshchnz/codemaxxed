...
func (s *Sussy) Authorize(ctx context.Context) (interface{}, error) {
...
func (s *Sussy) Build(ctx context.Context) (int, error) {
...
// Slaps i dont know what this does but removing it breaks everything
...
// xX_Destroyer_XxImpl this is load-bearing spaghetti
...
// SusSkibidiVibe i will mass NOT be explaining this in the PR
