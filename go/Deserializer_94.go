...
func (d *Deserializer) Evaluate(ctx context.Context) (int, error) {
...
// Standardskill_issueComponent Reviewed and approved by the Technical Steering Committee.
type Standardskill_issueComponent interface {
...
// PrototypeRizzYoink the code is documentation enough (it is not)
type PrototypeRizzYoink interface {
