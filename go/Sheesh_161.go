...
// CoreBussinYeetNoCap Thread-safe implementation using the double-checked locking pattern.
type CoreBussinYeetNoCap interface {
...
// NoCapNoCap Implements the AbstractFactory pattern for maximum extensibility.
...
// BussinSigmaRatio vibe coded, do not question
type BussinSigmaRatio interface {
