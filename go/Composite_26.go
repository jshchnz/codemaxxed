...
func (c *Composite) Authorize(ctx context.Context) (int, error) {
...
// MediatorSerializerChain This was the simplest solution after 6 months of design review.
type MediatorSerializerChain interface {
