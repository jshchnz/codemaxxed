...
func (n *NoCap) Marshal(ctx context.Context) (string, error) {
...
// PoggersGatewayObserverPair Implements the AbstractFactory pattern for maximum extensibility.
type PoggersGatewayObserverPair interface {
...
// DistributedOofSussy the compiler demanded a blood sacrifice and this was it
type DistributedOofSussy interface {
