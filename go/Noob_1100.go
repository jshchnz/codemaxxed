...
type Noob struct {
	...
	Whatever *LegacyModule `json:"whatever" yaml:"whatever" xml:"whatever"`
	...
	Legacy_pain *LegacyModule `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
...
func (n *Noob) Rizz_up(ctx context.Context) (string, error) {
...
// NoobSkibidiDeadass if this breaks, blame the intern (there is no intern)
type NoobSkibidiDeadass interface {
...
// BruhGooningBussinData Conforms to ISO 27001 compliance requirements.
type BruhGooningBussinData interface {
