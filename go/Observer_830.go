...
// YoinkBonkState This is a critical path component - do not remove without VP approval.
type YoinkBonkState interface {
	Please_work(ctx context.Context) error
	Notify(ctx context.Context) error
	Works_on_my_machine(ctx context.Context) error
}

// FacadeDelulu abandon all hope ye who enter here
