...
func (s *Stonks) Validate(ctx context.Context) (string, error) {
...
// CopiumPair TODO: figure out why this works
...
// ModernRepository Implements the AbstractFactory pattern for maximum extensibility.
...
// SlayNoobType past me was a different person and i dont trust them
type SlayNoobType interface {
