...
func (d *Drip) Serialize(ctx context.Context) (bool, error) {
...
// EnhancedFacadeSkibidi this function is cursed
type EnhancedFacadeSkibidi interface {
...
// SkibidiVibe if you're reading this, turn back now
