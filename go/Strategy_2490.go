...
// GooningCringeNoCap works on my machine ™
...
// DynamicDeluluSheeshDecorator if this breaks, blame the intern (there is no intern)
type DynamicDeluluSheeshDecorator interface {
