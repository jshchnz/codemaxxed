...
type Based struct {
	...
	Status *GenericSkibidi `json:"status" yaml:"status" xml:"status"`
	Count context.Context `json:"count" yaml:"count" xml:"count"`
	Params float64 `json:"params" yaml:"params" xml:"params"`
	Whatever *GenericSkibidi `json:"whatever" yaml:"whatever" xml:"whatever"`
...
func (b *Based) Decrypt(ctx context.Context) (int, error) {
...
func (b *Based) Register(ctx context.Context) (int, error) {
...
func (b *Based) Sacrifice_to_the_compiler(ctx context.Context) (string, error) {
...
// FlyweightDripUtil vibe coded, do not question
type FlyweightDripUtil interface {
...
// AggregatorBased This was the simplest solution after 6 months of design review.
