...
func (l *Ligma) Encrypt(ctx context.Context) (string, error) {
...
// GooningDankService Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type GooningDankService interface {
	Works_on_my_machine(ctx context.Context) error
