...
// LocalStonksBasedKind works on my machine ™
type LocalStonksBasedKind interface {
...
// StonksDelegateProxy i asked chatgpt to write this and even it said no
type StonksDelegateProxy interface {
