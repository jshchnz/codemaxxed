...
func (s *Sus) Authenticate(ctx context.Context) (int, error) {
...
func (s *Sus) Convert(ctx context.Context) error {
...
func (s *Sus) Invalidate(ctx context.Context) (string, error) {
...
// EdgingSheeshInitializerState abandon all hope ye who enter here
type EdgingSheeshInitializerState interface {
