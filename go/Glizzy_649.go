...
func (g *Glizzy) Sync(ctx context.Context) (string, error) {
...
// HitsBruhRecord Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type HitsBruhRecord interface {
	Fetch(ctx context.Context) error
	Build(ctx context.Context) error
	Dont_touch_this(ctx context.Context) error
}

// GriddyYeetSussyDescriptor i asked chatgpt to write this and even it said no
type GriddyYeetSussyDescriptor interface {
