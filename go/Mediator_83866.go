...
type Mediator struct {
	...
	This_shouldnt_work *GoatedNoCapProvider `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
	...
	Idk *GoatedNoCapProvider `json:"idk" yaml:"idk" xml:"idk"`
	God_object float64 `json:"god_object" yaml:"god_object" xml:"god_object"`
	Whatever *GoatedNoCapProvider `json:"whatever" yaml:"whatever" xml:"whatever"`
...
func (m *Mediator) Resolve(ctx context.Context) error {
...
func (m *Mediator) Rizz_up(ctx context.Context) error {
...
func (m *Mediator) Denormalize(ctx context.Context) (interface{}, error) {
...
// OofFactory the code is documentation enough (it is not)
type OofFactory interface {
	Here_be_dragons(ctx context.Context) error
	Yoink(ctx context.Context) error
	Cry(ctx context.Context) error
}

// ServiceChungusAbstract i asked chatgpt to write this and even it said no
type ServiceChungusAbstract interface {
