...
type Glizzy struct {
	...
	It_lives *GriddyGooning `json:"it_lives" yaml:"it_lives" xml:"it_lives"`
...
func (g *Glizzy) Load(ctx context.Context) error {
...
func (g *Glizzy) Delete(ctx context.Context) (interface{}, error) {
...
// FanumType Implements the AbstractFactory pattern for maximum extensibility.
...
// OofAbstract the mass of code grows. it hungers. it consumes.
...
// AuraRizzInitializer if this breaks, blame the intern (there is no intern)
type AuraRizzInitializer interface {
	Todo_fix_later(ctx context.Context) error
