...
// OptimizedGatewayFactoryMapper ¯\_(ツ)_/¯
type OptimizedGatewayFactoryMapper interface {
...
// StandardDeserializerFanumAura this is load-bearing spaghetti
type StandardDeserializerFanumAura interface {
	Handle(ctx context.Context) error
...
// EdgingResponse This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
