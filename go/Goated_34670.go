...
func (g *Goated) Dont_touch_this(ctx context.Context) (bool, error) {
...
func (g *Goated) Resolve(ctx context.Context) error {
	x, err := func() (interface{}, error) {
		// works on my machine ™
		return nil, nil
	}()
...
func (g *Goated) Todo_fix_later(ctx context.Context) (interface{}, error) {
...
// DistributedSlapsBussinCoordinatorException the mass of code grows. it hungers. it consumes.
type DistributedSlapsBussinCoordinatorException interface {
