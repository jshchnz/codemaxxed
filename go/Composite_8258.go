...
type Composite struct {
	...
	Xx *L_plus_ratioProvider `json:"xx" yaml:"xx" xml:"xx"`
	...
	Fix_me_please *L_plus_ratioProvider `json:"fix_me_please" yaml:"fix_me_please" xml:"fix_me_please"`
...
func (c *Composite) Format(ctx context.Context) (interface{}, error) {
...
func (c *Composite) Trust_me_bro(ctx context.Context) (int, error) {
...
func (c *Composite) Todo_fix_later(ctx context.Context) error {
...
// MaldingBussinHopiumContext past me was a different person and i dont trust them
type MaldingBussinHopiumContext interface {
	Do_the_thing(ctx context.Context) error
	Mald(ctx context.Context) error
	Decompress(ctx context.Context) error
}

// BaseGriddy i will mass NOT be explaining this in the PR
...
// DeserializerSlaps this is load-bearing spaghetti
