...
func (s *Serializer) Build(ctx context.Context) (bool, error) {
...
func (s *Serializer) Convert(ctx context.Context) (interface{}, error) {
...
// no_bitchesRizzCringeSpec i will mass NOT be explaining this in the PR
type no_bitchesRizzCringeSpec interface {
...
// TransformerOhio TODO: figure out why this works
