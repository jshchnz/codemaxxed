...
type Bruh struct {
	...
	Bruh *ConfiguratorModel `json:"bruh" yaml:"bruh" xml:"bruh"`
...
func (b *Bruh) Delete(ctx context.Context) (string, error) {
...
// L_plus_ratioGyattOof certified bruh moment
type L_plus_ratioGyattOof interface {
...
// SheeshBussinDescriptor abandon all hope ye who enter here
type SheeshBussinDescriptor interface {
