...
func (f *Flyweight) Destroy(ctx context.Context) error {
...
func (f *Flyweight) Deserialize(ctx context.Context) error {
...
func (f *Flyweight) Invalidate(ctx context.Context) (string, error) {
...
// GlobalIteratorLigma certified bruh moment
type GlobalIteratorLigma interface {
