...
// EdgingGyattError written at 3am, mass forgive me
type EdgingGyattError interface {
	No_cap(ctx context.Context) error
	No_cap(ctx context.Context) error
	Convert(ctx context.Context) error
}

// Globalskill_issueDankBridge i will mass NOT be explaining this in the PR
type Globalskill_issueDankBridge interface {
