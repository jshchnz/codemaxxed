...
type Malding struct {
	Context *Factory `json:"context" yaml:"context" xml:"context"`
...
// AbstractProxyGyatt Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type AbstractProxyGyatt interface {
