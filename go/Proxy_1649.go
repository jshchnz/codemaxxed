...
type Proxy struct {
	...
	Settings *RatioOhioProxyResponse `json:"settings" yaml:"settings" xml:"settings"`
...
func (p *Proxy) Refresh(ctx context.Context) (bool, error) {
...
func (p *Proxy) Destroy(ctx context.Context) (bool, error) {
...
// VibeRatioYoinkKind Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type VibeRatioYoinkKind interface {
