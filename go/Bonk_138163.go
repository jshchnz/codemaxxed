...
func (b *Bonk) Resolve(ctx context.Context) (bool, error) {
...
func (b *Bonk) Denormalize(ctx context.Context) (bool, error) {
...
// ScalableGyattHopium Implements the AbstractFactory pattern for maximum extensibility.
type ScalableGyattHopium interface {
...
// BonkControllerSlaps if this breaks, blame the intern (there is no intern)
type BonkControllerSlaps interface {
