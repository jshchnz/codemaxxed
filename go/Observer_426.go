...
func (o *Observer) Deserialize(ctx context.Context) (interface{}, error) {
...
func (o *Observer) Sync(ctx context.Context) (int, error) {
...
// ConnectorYeetEntity i asked chatgpt to write this and even it said no
type ConnectorYeetEntity interface {
...
// StrategyFlyweight past me was a different person and i dont trust them
