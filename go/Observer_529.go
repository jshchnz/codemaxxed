...
type Observer struct {
	...
	Data *ChainOof `json:"data" yaml:"data" xml:"data"`
...
func (o *Observer) Normalize(ctx context.Context) (int, error) {
...
func (o *Observer) Configure(ctx context.Context) error {
...
func (o *Observer) Handle(ctx context.Context) error {
...
func (o *Observer) Aggregate(ctx context.Context) (bool, error) {
...
// GenericxX_Destroyer_Xx past me was a different person and i dont trust them
...
// xX_Destroyer_XxSheesh Thread-safe implementation using the double-checked locking pattern.
