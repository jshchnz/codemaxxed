...
type Delulu struct {
	...
	This_shouldnt_work *BussinMapperGlizzy `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
	...
	Xx *BussinMapperGlizzy `json:"xx" yaml:"xx" xml:"xx"`
...
func (d *Delulu) Evaluate(ctx context.Context) (bool, error) {
...
// NoCapStonksGoated This abstraction layer provides necessary indirection for future scalability.
type NoCapStonksGoated interface {
...
// NoCapDripWrapperException written at 3am, mass forgive me
type NoCapDripWrapperException interface {
...
// DefaultStonksConfig abandon all hope ye who enter here
type DefaultStonksConfig interface {
