...
type Hits struct {
	...
	Output_data *Converter `json:"output_data" yaml:"output_data" xml:"output_data"`
...
// GenericManagerGyattCopiumPair certified bruh moment
type GenericManagerGyattCopiumPair interface {
...
// DistributedYoinkBakaValue ¯\_(ツ)_/¯
type DistributedYoinkBakaValue interface {
