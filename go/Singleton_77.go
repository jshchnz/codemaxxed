...
type Singleton struct {
	...
	Tech_debt *skill_issueGooningAbstract `json:"tech_debt" yaml:"tech_debt" xml:"tech_debt"`
...
func (s *Singleton) No_cap(ctx context.Context) (string, error) {
...
func (s *Singleton) Cry(ctx context.Context) error {
...
func (s *Singleton) Compute(ctx context.Context) (int, error) {
...
// AuraCringe i will mass NOT be explaining this in the PR
