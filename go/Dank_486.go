...
type Dank struct {
	...
	Request *InternalStonksBonkConfigurator `json:"request" yaml:"request" xml:"request"`
...
// SigmaStonks works on my machine ™
...
// WrapperContext i asked chatgpt to write this and even it said no
