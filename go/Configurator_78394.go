...
type Configurator struct {
	...
	Forbidden_knowledge *GooningGigachadException `json:"forbidden_knowledge" yaml:"forbidden_knowledge" xml:"forbidden_knowledge"`
}
...
func (c *Configurator) Normalize(ctx context.Context) (string, error) {
...
// BakaGyatt i will mass NOT be explaining this in the PR
