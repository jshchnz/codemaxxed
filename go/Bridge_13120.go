...
type Bridge struct {
	...
	Result *Stonks `json:"result" yaml:"result" xml:"result"`
...
func (b *Bridge) Convert(ctx context.Context) error {
...
func (b *Bridge) Mald(ctx context.Context) (interface{}, error) {
...
func (b *Bridge) Process(ctx context.Context) (bool, error) {
	fix_me_please, err := func() (interface{}, error) {
		// if you're reading this, turn back now
		return nil, nil
	}()
...
// AggregatorComponentMediator TODO: Refactor this in Q3 (written in 2019).
type AggregatorComponentMediator interface {
...
// HitsSigmaAura The previous implementation was 3 lines but didn't meet enterprise standards.
type HitsSigmaAura interface {
	Abandon_all_hope(ctx context.Context) error
...
// BruhCringeSheesh abandon all hope ye who enter here
type BruhCringeSheesh interface {
