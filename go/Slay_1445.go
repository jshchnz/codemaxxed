...
type Slay struct {
	...
	Cursed_value *BridgeBonkNoob `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
...
func (s *Slay) Parse(ctx context.Context) (bool, error) {
...
func (s *Slay) Evaluate(ctx context.Context) error {
...
// AbstractDeadassModuleAuraKind this function is cursed
type AbstractDeadassModuleAuraKind interface {
...
// SerializerL_plus_ratio the compiler demanded a blood sacrifice and this was it
type SerializerL_plus_ratio interface {
	Hack_around_it(ctx context.Context) error
