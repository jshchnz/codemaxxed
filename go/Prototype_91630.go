...
type Prototype struct {
	...
	Buffer *CringeCringe `json:"buffer" yaml:"buffer" xml:"buffer"`
	Response bool `json:"response" yaml:"response" xml:"response"`
	Entity *CringeCringe `json:"entity" yaml:"entity" xml:"entity"`
...
func (p *Prototype) Deserialize(ctx context.Context) (int, error) {
...
func (p *Prototype) Transform(ctx context.Context) (bool, error) {
...
// ConverterSigmaRatio skill issue if you can't read this
type ConverterSigmaRatio interface {
...
// DeluluGriddyHelper works on my machine ™
type DeluluGriddyHelper interface {
	Trust_me_bro(ctx context.Context) error
