...
// BaseYeetFanum this violates at least 3 design patterns and invents 2 new ones
type BaseYeetFanum interface {
...
// StaticEdging abandon all hope ye who enter here
...
// SigmaPoggersno_bitches written at 3am, mass forgive me
type SigmaPoggersno_bitches interface {
	Ship_it(ctx context.Context) error
	Destroy(ctx context.Context) error
	Ship_it(ctx context.Context) error
}

// StonksYeet works on my machine ™
