...
func (v *Visitor) Authorize(ctx context.Context) (interface{}, error) {
...
// no_bitchesGyattRizz This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
type no_bitchesGyattRizz interface {
...
// ScalableBridge the code is documentation enough (it is not)
