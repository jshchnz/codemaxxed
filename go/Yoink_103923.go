...
type Yoink struct {
	...
	Params *GlobalEdgingState `json:"params" yaml:"params" xml:"params"`
	Value func() error `json:"value" yaml:"value" xml:"value"`
	Dont_ask float64 `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
	Input_data []byte `json:"input_data" yaml:"input_data" xml:"input_data"`
	Source []byte `json:"source" yaml:"source" xml:"source"`
	Source *sync.Mutex `json:"source" yaml:"source" xml:"source"`
	Haunted_reference *GlobalEdgingState `json:"haunted_reference" yaml:"haunted_reference" xml:"haunted_reference"`
...
func (y *Yoink) Deserialize(ctx context.Context) (interface{}, error) {
...
func (y *Yoink) Decrypt(ctx context.Context) error {
...
// OptimizedGriddyRizz i dont know what this does but removing it breaks everything
type OptimizedGriddyRizz interface {
