...
type Ohio struct {
	...
	Dont_ask *DeserializerBonkChain `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
	This_shouldnt_work error `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
	Thingy int64 `json:"thingy" yaml:"thingy" xml:"thingy"`
	Instance *DeserializerBonkChain `json:"instance" yaml:"instance" xml:"instance"`
	...
	Params *DeserializerBonkChain `json:"params" yaml:"params" xml:"params"`
...
// FanumPrototypeMiddleware ¯\_(ツ)_/¯
type FanumPrototypeMiddleware interface {
...
// BridgeBussinNoobContext the compiler demanded a blood sacrifice and this was it
type BridgeBussinNoobContext interface {
