...
type Sus struct {
	...
	Context *CoreHandler `json:"context" yaml:"context" xml:"context"`
	Temp_but_permanent context.Context `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
	Temp_but_permanent *CoreHandler `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
...
// Authorize ¯\_(ツ)_/¯
func (s *Sus) Authorize(ctx context.Context) (string, error) {
...
func (s *Sus) Sync(ctx context.Context) (string, error) {
...
// DynamicStonksOhio i dont know what this does but removing it breaks everything
type DynamicStonksOhio interface {
...
// SkibidiOofHopium DO NOT TOUCH - last person who modified this quit
type SkibidiOofHopium interface {
	Hack_around_it(ctx context.Context) error
	Invalidate(ctx context.Context) error
