...
// BaseMaldingUtils Reviewed and approved by the Technical Steering Committee.
type BaseMaldingUtils interface {
...
// CoreDeadassAuraGoated this function is cursed
type CoreDeadassAuraGoated interface {
