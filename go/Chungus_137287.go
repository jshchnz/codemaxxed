...
func (c *Chungus) Refresh(ctx context.Context) error {
...
func (c *Chungus) Pray_to_the_machine_spirit(ctx context.Context) (int, error) {
...
// L_plus_ratioAuraSerializer DO NOT TOUCH - last person who modified this quit
type L_plus_ratioAuraSerializer interface {
...
// BeanOhioCopium works on my machine ™
type BeanOhioCopium interface {
	Hack_around_it(ctx context.Context) error
	Touch_grass(ctx context.Context) error
