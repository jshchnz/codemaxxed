...
type Ohio struct {
	...
	Result *SigmaSlayUtil `json:"result" yaml:"result" xml:"result"`
...
// GoatedGatewayBuilder This is a critical path component - do not remove without VP approval.
type GoatedGatewayBuilder interface {
...
// OofDeserializer TODO: Refactor this in Q3 (written in 2019).
...
// SussyDecorator if you're reading this, turn back now
