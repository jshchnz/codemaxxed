...
func (d *Delegate) Configure(ctx context.Context) (string, error) {
...
// EnterpriseMaldingBruhBussin i asked chatgpt to write this and even it said no
type EnterpriseMaldingBruhBussin interface {
...
// GooningRizz past me was a different person and i dont trust them
