...
// EdgingBridgeTransformerBase if this breaks, blame the intern (there is no intern)
type EdgingBridgeTransformerBase interface {
...
// PrototypeDecoratorMalding DO NOT MODIFY - This is load-bearing architecture.
type PrototypeDecoratorMalding interface {
	Bussin_fr(ctx context.Context) error
