...
func (r *Repository) Save(ctx context.Context) (bool, error) {
...
func (r *Repository) No_cap(ctx context.Context) (string, error) {
...
// HandlerUtil This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
