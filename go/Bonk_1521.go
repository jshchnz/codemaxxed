...
// AbstractNoCapWrapperChain i will mass NOT be explaining this in the PR
type AbstractNoCapWrapperChain interface {
...
// ProxySlapsGoated certified bruh moment
type ProxySlapsGoated interface {
...
// GoatedBussin Implements the AbstractFactory pattern for maximum extensibility.
