...
type Hopium struct {
	...
	Fix_me_please *DefaultYoink `json:"fix_me_please" yaml:"fix_me_please" xml:"fix_me_please"`
	Payload int `json:"payload" yaml:"payload" xml:"payload"`
	Element func() error `json:"element" yaml:"element" xml:"element"`
	Result map[string]interface{} `json:"result" yaml:"result" xml:"result"`
	X context.Context `json:"x" yaml:"x" xml:"x"`
	Spaghetti int `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
	Context *DefaultYoink `json:"context" yaml:"context" xml:"context"`
...
func (h *Hopium) Register(ctx context.Context) error {
...
// RizzMapper works on my machine ™
type RizzMapper interface {
...
// GigachadGyattSussy i will mass NOT be explaining this in the PR
type GigachadGyattSussy interface {
