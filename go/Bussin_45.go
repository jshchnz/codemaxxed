...
type Bussin struct {
	...
	It_lives *GenericInitializerValue `json:"it_lives" yaml:"it_lives" xml:"it_lives"`
	Idk map[string]interface{} `json:"idk" yaml:"idk" xml:"idk"`
	Forbidden_knowledge bool `json:"forbidden_knowledge" yaml:"forbidden_knowledge" xml:"forbidden_knowledge"`
	God_object int64 `json:"god_object" yaml:"god_object" xml:"god_object"`
	Context *GenericInitializerValue `json:"context" yaml:"context" xml:"context"`
...
// HitsComposite past me was a different person and i dont trust them
...
// OhioAuraModel past me was a different person and i dont trust them
type OhioAuraModel interface {
