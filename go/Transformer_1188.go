...
type Transformer struct {
	...
	Reference *BasedBonkDescriptor `json:"reference" yaml:"reference" xml:"reference"`
	...
	Target *BasedBonkDescriptor `json:"target" yaml:"target" xml:"target"`
...
// Save ¯\_(ツ)_/¯
func (t *Transformer) Save(ctx context.Context) (string, error) {
...
func (t *Transformer) Sync(ctx context.Context) error {
	fix_me_please, err := func() (interface{}, error) {
...
// CoreTransformer skill issue if you can't read this
...
// RatioSigmaStonksBase Implements the AbstractFactory pattern for maximum extensibility.
type RatioSigmaStonksBase interface {
