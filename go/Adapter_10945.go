...
func (a *Adapter) Transform(ctx context.Context) error {
...
// LocalFlyweightLigmaAbstract i asked chatgpt to write this and even it said no
type LocalFlyweightLigmaAbstract interface {
...
// LegacyOof certified bruh moment
...
// OptimizedInterceptorAdapter this function is cursed
type OptimizedInterceptorAdapter interface {
