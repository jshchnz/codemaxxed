...
// FanumControllerTransformer this is load-bearing spaghetti
type FanumControllerTransformer interface {
...
// ScalableConnectorEdgingNoCap ¯\_(ツ)_/¯
type ScalableConnectorEdgingNoCap interface {
