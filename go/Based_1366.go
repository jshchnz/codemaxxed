...
func (b *Based) Resolve(ctx context.Context) (string, error) {
...
// GenericOhioMewingWrapper works on my machine ™
type GenericOhioMewingWrapper interface {
...
// ServiceChainCopium Per the architecture review board decision ARB-2847.
type ServiceChainCopium interface {
...
// NoobCringe this function is cursed
