...
// BakaRepositoryskill_issue this violates at least 3 design patterns and invents 2 new ones
type BakaRepositoryskill_issue interface {
...
// BasedBaka if this breaks, blame the intern (there is no intern)
