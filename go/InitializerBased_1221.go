...
func (i *InitializerBased) Yoink(ctx context.Context) (interface{}, error) {
...
func (i *InitializerBased) No_cap(ctx context.Context) (interface{}, error) {
...
func (i *InitializerBased) Yoink(ctx context.Context) error {
...
func (i *InitializerBased) Transform(ctx context.Context) (interface{}, error) {
	entity, err := func() (interface{}, error) {
...
func (i *InitializerBased) Here_be_dragons(ctx context.Context) (int, error) {
	dont_ask, err := func() (interface{}, error) {
		// ¯\_(ツ)_/¯
		return nil, nil
	}()
...
func (i *InitializerBased) Hack_around_it(ctx context.Context) (interface{}, error) {
...
func (i *InitializerBased) Do_the_thing(ctx context.Context) (string, error) {
	dont_ask, err := func() (interface{}, error) {
...
// Please_work ¯\_(ツ)_/¯
func (i *InitializerBased) Please_work(ctx context.Context) error {
...
func (i *InitializerBased) Hack_around_it(ctx context.Context) error {
...
func (i *InitializerBased) Here_be_dragons(ctx context.Context) (string, error) {
