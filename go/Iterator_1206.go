...
type Iterator struct {
	...
	Payload *GenericPoggers `json:"payload" yaml:"payload" xml:"payload"`
...
func (i *Iterator) Todo_fix_later(ctx context.Context) error {
...
// CustomHopiumObserver the mass of code grows. it hungers. it consumes.
type CustomHopiumObserver interface {
...
// DankResponse written at 3am, mass forgive me
