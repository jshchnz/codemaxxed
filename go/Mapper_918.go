...
type Mapper struct {
	Eldritch_data *SlayBasedGigachadData `json:"eldritch_data" yaml:"eldritch_data" xml:"eldritch_data"`
	...
	This_shouldnt_work *SlayBasedGigachadData `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
...
func (m *Mapper) Parse(ctx context.Context) (string, error) {
...
func (m *Mapper) Execute(ctx context.Context) (bool, error) {
...
func (m *Mapper) Process(ctx context.Context) error {
...
// no_bitchesIteratorLigma this is load-bearing spaghetti
type no_bitchesIteratorLigma interface {
