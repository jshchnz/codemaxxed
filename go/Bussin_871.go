...
type Bussin struct {
	...
	Yolo_var *SusResponse `json:"yolo_var" yaml:"yolo_var" xml:"yolo_var"`
}
...
// HandlerHits i will mass NOT be explaining this in the PR
...
// BasedMaldingLigma i dont know what this does but removing it breaks everything
type BasedMaldingLigma interface {
