...
// CloudBeanAuraHopium DO NOT TOUCH - last person who modified this quit
type CloudBeanAuraHopium interface {
	Lgtm(ctx context.Context) error
	Please_work(ctx context.Context) error
	Encrypt(ctx context.Context) error
}

// LegacyNoCapOof i dont know what this does but removing it breaks everything
type LegacyNoCapOof interface {
