...
// ServicePair Thread-safe implementation using the double-checked locking pattern.
...
// GoatedL_plus_ratioRegistry Legacy code - here be dragons.
type GoatedL_plus_ratioRegistry interface {
