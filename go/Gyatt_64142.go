...
func (g *Gyatt) Persist(ctx context.Context) (int, error) {
...
// DeluluGateway the mass of code grows. it hungers. it consumes.
type DeluluGateway interface {
	Here_be_dragons(ctx context.Context) error
	Go_outside(ctx context.Context) error
	Cry(ctx context.Context) error
}

// LigmaRatio this violates at least 3 design patterns and invents 2 new ones
