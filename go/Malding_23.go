...
type Malding struct {
	...
	Item *ConnectorGriddyGateway `json:"item" yaml:"item" xml:"item"`
...
// xX_Destroyer_XxDelulu the compiler demanded a blood sacrifice and this was it
...
// DripBussinInitializerSpec Legacy code - here be dragons.
type DripBussinInitializerSpec interface {
	Do_the_thing(ctx context.Context) error
