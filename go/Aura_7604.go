...
type Aura struct {
	...
	Context *CloudSlayHelper `json:"context" yaml:"context" xml:"context"`
...
func (a *Aura) Decompress(ctx context.Context) (bool, error) {
...
func (a *Aura) Fetch(ctx context.Context) (bool, error) {
...
// OrchestratorSingletonBussin i asked chatgpt to write this and even it said no
type OrchestratorSingletonBussin interface {
...
// GigachadBonkInterface i will mass NOT be explaining this in the PR
type GigachadBonkInterface interface {
