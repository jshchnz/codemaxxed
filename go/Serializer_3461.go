...
func (s *Serializer) Render(ctx context.Context) (bool, error) {
...
// DankDrip written at 3am, mass forgive me
...
// ProcessorProxy certified bruh moment
type ProcessorProxy interface {
