...
type NoCap struct {
	...
	Magic_number *ChungusSussy `json:"magic_number" yaml:"magic_number" xml:"magic_number"`
...
// GoatedSlapsMapper Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type GoatedSlapsMapper interface {
...
// DeadassGriddyNoob the code is documentation enough (it is not)
type DeadassGriddyNoob interface {
