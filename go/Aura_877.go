...
func (a *Aura) Denormalize(ctx context.Context) (int, error) {
...
func (a *Aura) Evaluate(ctx context.Context) (interface{}, error) {
...
// Authenticate ¯\_(ツ)_/¯
func (a *Aura) Authenticate(ctx context.Context) (interface{}, error) {
...
// GatewayBruhno_bitches this violates at least 3 design patterns and invents 2 new ones
type GatewayBruhno_bitches interface {
	Pray_to_the_machine_spirit(ctx context.Context) error
	Decompress(ctx context.Context) error
	Resolve(ctx context.Context) error
}

// GigachadEndpointLigma certified bruh moment
type GigachadEndpointLigma interface {
