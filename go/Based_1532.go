...
type Based struct {
	Dont_ask *AbstractYoink `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
	...
	Xx *AbstractYoink `json:"xx" yaml:"xx" xml:"xx"`
}
...
func (b *Based) Encrypt(ctx context.Context) (int, error) {
...
// StonksConverterUtils i dont know what this does but removing it breaks everything
type StonksConverterUtils interface {
...
// StonksBussin the code is documentation enough (it is not)
