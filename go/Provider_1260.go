...
func (p *Provider) Cache(ctx context.Context) (bool, error) {
...
func (p *Provider) Deserialize(ctx context.Context) error {
...
// CringeRatioBridgeKind past me was a different person and i dont trust them
type CringeRatioBridgeKind interface {
