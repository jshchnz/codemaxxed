...
func (b *Bridge) Sacrifice_to_the_compiler(ctx context.Context) (interface{}, error) {
...
// GenericWrapperAuraDeadassAbstract i will mass NOT be explaining this in the PR
type GenericWrapperAuraDeadassAbstract interface {
