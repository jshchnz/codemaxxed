...
func (c *Coordinator) Authorize(ctx context.Context) (bool, error) {
...
func (c *Coordinator) Seethe(ctx context.Context) (bool, error) {
...
func (c *Coordinator) Parse(ctx context.Context) (interface{}, error) {
...
func (c *Coordinator) Aggregate(ctx context.Context) (interface{}, error) {
