...
type Proxy struct {
	...
	Bruh *GoatedSheesh `json:"bruh" yaml:"bruh" xml:"bruh"`
...
func (p *Proxy) Encrypt(ctx context.Context) error {
...
func (p *Proxy) Persist(ctx context.Context) (int, error) {
...
// ModernSlaps TODO: figure out why this works
