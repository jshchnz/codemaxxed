...
type Processor struct {
	Index *skill_issueSusProxy `json:"index" yaml:"index" xml:"index"`
...
// GlizzySussy the compiler demanded a blood sacrifice and this was it
...
// EndpointRatioError past me was a different person and i dont trust them
type EndpointRatioError interface {
...
// SlayGooningGyatt i will mass NOT be explaining this in the PR
type SlayGooningGyatt interface {
