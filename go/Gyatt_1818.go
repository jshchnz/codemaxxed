...
type Gyatt struct {
	...
	X *DripStonks `json:"x" yaml:"x" xml:"x"`
	Params func() error `json:"params" yaml:"params" xml:"params"`
	Item int64 `json:"item" yaml:"item" xml:"item"`
	Legacy_pain *DripStonks `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
...
func (g *Gyatt) Destroy(ctx context.Context) (int, error) {
...
func (g *Gyatt) Process(ctx context.Context) error {
...
// SlapsRequest Thread-safe implementation using the double-checked locking pattern.
...
// CustomCringeNoCap past me was a different person and i dont trust them
type CustomCringeNoCap interface {
