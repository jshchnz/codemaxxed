...
type Flyweight struct {
	...
	Temp_but_permanent *L_plus_ratioBaka `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
	State bool `json:"state" yaml:"state" xml:"state"`
	Eldritch_data *L_plus_ratioBaka `json:"eldritch_data" yaml:"eldritch_data" xml:"eldritch_data"`
...
func (f *Flyweight) Authorize(ctx context.Context) (int, error) {
...
func (f *Flyweight) Cache(ctx context.Context) (interface{}, error) {
...
func (f *Flyweight) Create(ctx context.Context) (interface{}, error) {
	forbidden_knowledge, err := func() (interface{}, error) {
		// i dont know what this does but removing it breaks everything
		return nil, nil
	}()
...
// CoreAuraMewingSussy written at 3am, mass forgive me
type CoreAuraMewingSussy interface {
...
// RizzBonk TODO: figure out why this works
...
// GyattNoob skill issue if you can't read this
