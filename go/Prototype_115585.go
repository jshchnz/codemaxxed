...
type Prototype struct {
	...
	Target *LigmaBase `json:"target" yaml:"target" xml:"target"`
	Legacy_pain map[string]interface{} `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
	Whatever []interface{} `json:"whatever" yaml:"whatever" xml:"whatever"`
	Entity context.Context `json:"entity" yaml:"entity" xml:"entity"`
	Dont_ask error `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
	Spaghetti *LigmaBase `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
...
func (p *Prototype) Abandon_all_hope(ctx context.Context) (int, error) {
...
func (p *Prototype) Mald(ctx context.Context) (interface{}, error) {
...
func (p *Prototype) Render(ctx context.Context) error {
...
// SkibidiMewingService the compiler demanded a blood sacrifice and this was it
type SkibidiMewingService interface {
...
// DefaultTransformerMaldingResult i asked chatgpt to write this and even it said no
type DefaultTransformerMaldingResult interface {
	Sacrifice_to_the_compiler(ctx context.Context) error
