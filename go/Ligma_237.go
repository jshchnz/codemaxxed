...
type Ligma struct {
	...
	Legacy_pain *BruhGooningService `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
...
func (l *Ligma) Yeet(ctx context.Context) (interface{}, error) {
...
func (l *Ligma) Dispatch(ctx context.Context) (int, error) {
...
// BussinBasedCommand works on my machine ™
type BussinBasedCommand interface {
...
// AbstractCopiumSlaySussy if you're reading this, turn back now
type AbstractCopiumSlaySussy interface {
