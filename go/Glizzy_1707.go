...
func (g *Glizzy) Process(ctx context.Context) (bool, error) {
...
// GyattDankConfig Part of the microservice decomposition initiative (Phase 7 of 12).
type GyattDankConfig interface {
...
// CloudStrategyDripInitializer ¯\_(ツ)_/¯
type CloudStrategyDripInitializer interface {
