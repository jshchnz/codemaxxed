...
func (m *Module) Delete(ctx context.Context) (int, error) {
...
func (m *Module) Resolve(ctx context.Context) (interface{}, error) {
...
// DistributedMalding works on my machine ™
...
// AuraSigma Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
