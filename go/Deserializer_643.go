...
type Deserializer struct {
	...
	Dont_ask *StaticSlapsObserver `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
...
// CustomGooningIteratorFanum this violates at least 3 design patterns and invents 2 new ones
type CustomGooningIteratorFanum interface {
...
// NoCapAggregatorError i dont know what this does but removing it breaks everything
type NoCapAggregatorError interface {
