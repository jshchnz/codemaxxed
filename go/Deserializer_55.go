...
type Deserializer struct {
	...
	Whatever *CopiumOhio `json:"whatever" yaml:"whatever" xml:"whatever"`
...
func (d *Deserializer) Delete(ctx context.Context) (interface{}, error) {
...
func (d *Deserializer) Normalize(ctx context.Context) (int, error) {
...
// SigmaFanumskill_issue i asked chatgpt to write this and even it said no
type SigmaFanumskill_issue interface {
...
// DeadassSigmaEntity vibe coded, do not question
type DeadassSigmaEntity interface {
