...
type Oof struct {
	...
	Stuff *NoobBased `json:"stuff" yaml:"stuff" xml:"stuff"`
	Yolo_var *NoobBased `json:"yolo_var" yaml:"yolo_var" xml:"yolo_var"`
...
func (o *Oof) Delete(ctx context.Context) (string, error) {
...
func (o *Oof) Update(ctx context.Context) error {
...
// StandardGlizzyVibeDelulu i dont know what this does but removing it breaks everything
type StandardGlizzyVibeDelulu interface {
	Sacrifice_to_the_compiler(ctx context.Context) error
...
// xX_Destroyer_XxValue abandon all hope ye who enter here
...
// CringeHits if you're reading this, turn back now
