...
func (i *Initializer) Sync(ctx context.Context) (interface{}, error) {
...
// DeadassAbstract this function is cursed
...
// MaldingSkibidiVibeEntity no tests needed, it's perfect (copium)
type MaldingSkibidiVibeEntity interface {
