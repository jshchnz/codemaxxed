...
type Repository struct {
	...
	Legacy_pain *Slaps `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
...
func (r *Repository) Yoink(ctx context.Context) (bool, error) {
...
// StandardAggregatorOhio the compiler demanded a blood sacrifice and this was it
type StandardAggregatorOhio interface {
	Todo_fix_later(ctx context.Context) error
	Seethe(ctx context.Context) error
	Idk_what_this_does(ctx context.Context) error
}

// OrchestratorGriddyGriddy the compiler demanded a blood sacrifice and this was it
type OrchestratorGriddyGriddy interface {
...
// LegacyGoatedGooning ¯\_(ツ)_/¯
type LegacyGoatedGooning interface {
	Seethe(ctx context.Context) error
	Cry(ctx context.Context) error
