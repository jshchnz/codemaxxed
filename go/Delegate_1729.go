...
type Delegate struct {
	Temp_but_permanent *Resolver `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
...
func (d *Delegate) Sanitize(ctx context.Context) (bool, error) {
...
// AbstractOof This is a critical path component - do not remove without VP approval.
