...
type Resolver struct {
	...
	This_shouldnt_work *EnterprisePoggers `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
	Eldritch_data interface{} `json:"eldritch_data" yaml:"eldritch_data" xml:"eldritch_data"`
	Stuff interface{} `json:"stuff" yaml:"stuff" xml:"stuff"`
	Xxx float64 `json:"xxx" yaml:"xxx" xml:"xxx"`
	Tech_debt *EnterprisePoggers `json:"tech_debt" yaml:"tech_debt" xml:"tech_debt"`
...
// StaticVibeStrategyNoCap the compiler demanded a blood sacrifice and this was it
type StaticVibeStrategyNoCap interface {
	No_cap(ctx context.Context) error
