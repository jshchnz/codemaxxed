...
func (s *Sheesh) Build(ctx context.Context) (int, error) {
...
func (s *Sheesh) Authorize(ctx context.Context) (string, error) {
...
func (s *Sheesh) Serialize(ctx context.Context) error {
...
func (s *Sheesh) Convert(ctx context.Context) (interface{}, error) {
...
// RepositoryNoob This method handles the core business logic for the enterprise workflow.
...
// BaseSigmaValidator written at 3am, mass forgive me
type BaseSigmaValidator interface {
...
// NoCapSlaySigmaType if this breaks, blame the intern (there is no intern)
type NoCapSlaySigmaType interface {
