...
// DecoratorHitsMiddleware written at 3am, mass forgive me
type DecoratorHitsMiddleware interface {
	Pray_to_the_machine_spirit(ctx context.Context) error
	Refresh(ctx context.Context) error
	Bussin_fr(ctx context.Context) error
}

// HitsFlyweight The previous implementation was 3 lines but didn't meet enterprise standards.
