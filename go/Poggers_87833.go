...
type Poggers struct {
	...
	Fix_me_please *MiddlewareDecorator `json:"fix_me_please" yaml:"fix_me_please" xml:"fix_me_please"`
	Whatever chan struct{} `json:"whatever" yaml:"whatever" xml:"whatever"`
	Legacy_pain bool `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
	Thingy *MiddlewareDecorator `json:"thingy" yaml:"thingy" xml:"thingy"`
	Legacy_pain string `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
	It_lives error `json:"it_lives" yaml:"it_lives" xml:"it_lives"`
	Tech_debt *MiddlewareDecorator `json:"tech_debt" yaml:"tech_debt" xml:"tech_debt"`
...
func (p *Poggers) Update(ctx context.Context) (string, error) {
...
func (p *Poggers) Notify(ctx context.Context) (int, error) {
	fix_me_please, err := func() (interface{}, error) {
		// skill issue if you can't read this
		return nil, nil
	}()
...
// BasedDeluluInterface This was the simplest solution after 6 months of design review.
type BasedDeluluInterface interface {
...
// SingletonxX_Destroyer_XxHits Thread-safe implementation using the double-checked locking pattern.
type SingletonxX_Destroyer_XxHits interface {
