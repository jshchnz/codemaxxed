...
type Resolver struct {
	...
	Haunted_reference *CringeBussin `json:"haunted_reference" yaml:"haunted_reference" xml:"haunted_reference"`
	Whatever *CringeBussin `json:"whatever" yaml:"whatever" xml:"whatever"`
...
// LocalVibe the code is documentation enough (it is not)
