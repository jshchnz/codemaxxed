...
func (p *Poggers) Build(ctx context.Context) (int, error) {
...
func (p *Poggers) Fetch(ctx context.Context) (string, error) {
...
// GenericMewingValue DO NOT MODIFY - This is load-bearing architecture.
type GenericMewingValue interface {
...
// BakaMaldingAura certified bruh moment
type BakaMaldingAura interface {
