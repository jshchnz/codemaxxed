...
func (p *Poggers) Load(ctx context.Context) (bool, error) {
...
func (p *Poggers) Resolve(ctx context.Context) (interface{}, error) {
...
// AbstractCompositeEndpoint i dont know what this does but removing it breaks everything
type AbstractCompositeEndpoint interface {
