...
func (c *Connector) Marshal(ctx context.Context) (int, error) {
	temp_but_permanent, err := func() (interface{}, error) {
...
// GenericProxySusCringe i dont know what this does but removing it breaks everything
type GenericProxySusCringe interface {
...
// GlizzyDeadass this function is cursed
...
// BasedSigmaOof this function is cursed
type BasedSigmaOof interface {
