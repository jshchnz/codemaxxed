...
func (o *Orchestrator) Format(ctx context.Context) (string, error) {
...
func (o *Orchestrator) Authorize(ctx context.Context) error {
...
// PoggersOofNoob Implements the AbstractFactory pattern for maximum extensibility.
type PoggersOofNoob interface {
	Ship_it(ctx context.Context) error
	Go_outside(ctx context.Context) error
	Mald(ctx context.Context) error
}

// DefaultNoCapObserverCopium ¯\_(ツ)_/¯
type DefaultNoCapObserverCopium interface {
	Mald(ctx context.Context) error
