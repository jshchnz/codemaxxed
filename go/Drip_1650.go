...
type Drip struct {
	...
	Legacy_pain *DistributedNoCapProcessor `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
...
func (d *Drip) Deserialize(ctx context.Context) error {
...
// DispatcherVisitor DO NOT MODIFY - This is load-bearing architecture.
...
// AdapterValue the code is documentation enough (it is not)
type AdapterValue interface {
