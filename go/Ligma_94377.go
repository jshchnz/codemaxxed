...
func (l *Ligma) Notify(ctx context.Context) error {
...
func (l *Ligma) Resolve(ctx context.Context) error {
...
func (l *Ligma) Validate(ctx context.Context) (string, error) {
...
// FactoryBussinGyatt Thread-safe implementation using the double-checked locking pattern.
type FactoryBussinGyatt interface {
