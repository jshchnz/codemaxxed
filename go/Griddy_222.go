...
func (g *Griddy) Deserialize(ctx context.Context) (int, error) {
...
// CloudBruhConverter this function is cursed
type CloudBruhConverter interface {
...
// SussySussy Thread-safe implementation using the double-checked locking pattern.
...
// EndpointDescriptor works on my machine ™
