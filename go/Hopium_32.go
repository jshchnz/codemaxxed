...
type Hopium struct {
	...
	Value *Dispatcher `json:"value" yaml:"value" xml:"value"`
...
func (h *Hopium) Normalize(ctx context.Context) (bool, error) {
...
// GoatedDelulu written at 3am, mass forgive me
...
// SusDescriptor i dont know what this does but removing it breaks everything
