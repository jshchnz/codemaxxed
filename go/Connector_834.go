...
func (c *Connector) Evaluate(ctx context.Context) (bool, error) {
...
// DistributedWrapperFlyweight the code is documentation enough (it is not)
type DistributedWrapperFlyweight interface {
