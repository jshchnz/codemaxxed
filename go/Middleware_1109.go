...
type Middleware struct {
	X *RatioProviderVibe `json:"x" yaml:"x" xml:"x"`
...
func (m *Middleware) Fetch(ctx context.Context) (string, error) {
	xxx, err := func() (interface{}, error) {
		// past me was a different person and i dont trust them
		return nil, nil
	}()
...
// InternalPrototypeRizz past me was a different person and i dont trust them
type InternalPrototypeRizz interface {
...
// BakaYeetObserverType this violates at least 3 design patterns and invents 2 new ones
type BakaYeetObserverType interface {
