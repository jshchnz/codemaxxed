...
type Registry struct {
	...
	Whatever *DynamicGyatt `json:"whatever" yaml:"whatever" xml:"whatever"`
	X *DynamicGyatt `json:"x" yaml:"x" xml:"x"`
...
func (r *Registry) Decrypt(ctx context.Context) (interface{}, error) {
...
// VisitorSigmaSheesh This abstraction layer provides necessary indirection for future scalability.
type VisitorSigmaSheesh interface {
