...
// BruhConverterNoob no tests needed, it's perfect (copium)
type BruhConverterNoob interface {
	Pray_to_the_machine_spirit(ctx context.Context) error
	Abandon_all_hope(ctx context.Context) error
	Rizz_up(ctx context.Context) error
}

// BaseGoatedL_plus_ratioRatio vibe coded, do not question
type BaseGoatedL_plus_ratioRatio interface {
