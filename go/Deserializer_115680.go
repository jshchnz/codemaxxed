...
type Deserializer struct {
	...
	Destination *Command `json:"destination" yaml:"destination" xml:"destination"`
...
func (d *Deserializer) Pray_to_the_machine_spirit(ctx context.Context) error {
...
func (d *Deserializer) Execute(ctx context.Context) (bool, error) {
...
func (d *Deserializer) Dispatch(ctx context.Context) (bool, error) {
...
// BakaGlizzy the code is documentation enough (it is not)
...
// PipelineBussinConfig certified bruh moment
type PipelineBussinConfig interface {
...
// BaseGooningPrototypeSussy the code is documentation enough (it is not)
type BaseGooningPrototypeSussy interface {
