...
// StandardOhio i asked chatgpt to write this and even it said no
...
// no_bitchesGriddyPrototype TODO: Refactor this in Q3 (written in 2019).
type no_bitchesGriddyPrototype interface {
...
// CoreGriddyDelulu ¯\_(ツ)_/¯
type CoreGriddyDelulu interface {
...
// DefaultOofSussyCommand DO NOT MODIFY - This is load-bearing architecture.
type DefaultOofSussyCommand interface {
	No_cap(ctx context.Context) error
	Yeet(ctx context.Context) error
	Trust_me_bro(ctx context.Context) error
