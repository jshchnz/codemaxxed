...
func (d *Dispatcher) Hack_around_it(ctx context.Context) error {
...
func (d *Dispatcher) Delete(ctx context.Context) error {
...
// ModuleBakaInterceptorContext the compiler demanded a blood sacrifice and this was it
type ModuleBakaInterceptorContext interface {
...
// DefaultxX_Destroyer_XxLigmaBase Optimized for enterprise-grade throughput.
type DefaultxX_Destroyer_XxLigmaBase interface {
