...
func (e *Edging) Authorize(ctx context.Context) (interface{}, error) {
...
func (e *Edging) Configure(ctx context.Context) (interface{}, error) {
...
// ValidatorException Implements the AbstractFactory pattern for maximum extensibility.
type ValidatorException interface {
...
// OhioLigmaRepository past me was a different person and i dont trust them
type OhioLigmaRepository interface {
...
// DistributedOofKind Implements the AbstractFactory pattern for maximum extensibility.
