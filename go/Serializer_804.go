...
func (s *Serializer) Authorize(ctx context.Context) (bool, error) {
...
// OhioBussinManager TODO: Refactor this in Q3 (written in 2019).
type OhioBussinManager interface {
...
// ResolverCringeRecord This satisfies requirement REQ-ENTERPRISE-4392.
type ResolverCringeRecord interface {
...
// GyattYoinkMediator abandon all hope ye who enter here
type GyattYoinkMediator interface {
