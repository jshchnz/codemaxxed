...
func (i *Interceptor) Works_on_my_machine(ctx context.Context) (bool, error) {
...
func (i *Interceptor) Sanitize(ctx context.Context) (int, error) {
...
func (i *Interceptor) Aggregate(ctx context.Context) (string, error) {
...
func (i *Interceptor) Destroy(ctx context.Context) error {
...
// OhioSheesh abandon all hope ye who enter here
...
// StandardL_plus_ratioStonks TODO: figure out why this works
type StandardL_plus_ratioStonks interface {
...
// ControllerxX_Destroyer_Xx this is load-bearing spaghetti
type ControllerxX_Destroyer_Xx interface {
	Dont_touch_this(ctx context.Context) error
