...
func (b *Bridge) Evaluate(ctx context.Context) (int, error) {
...
func (b *Bridge) Invalidate(ctx context.Context) (int, error) {
...
// LegacyDrip i asked chatgpt to write this and even it said no
...
// BruhError past me was a different person and i dont trust them
