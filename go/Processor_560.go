...
type Processor struct {
	...
	Destination *Mapperskill_issueSusBase `json:"destination" yaml:"destination" xml:"destination"`
...
func (p *Processor) Serialize(ctx context.Context) (bool, error) {
...
func (p *Processor) Format(ctx context.Context) (interface{}, error) {
	legacy_pain, err := func() (interface{}, error) {
...
// ChungusSheesh Per the architecture review board decision ARB-2847.
...
// InternalRatioFanumModel i asked chatgpt to write this and even it said no
type InternalRatioFanumModel interface {
...
// ProcessorHopiumFanum the compiler demanded a blood sacrifice and this was it
type ProcessorHopiumFanum interface {
