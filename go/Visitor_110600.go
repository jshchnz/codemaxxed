...
// StandardDelegateProviderObserverState the mass of code grows. it hungers. it consumes.
type StandardDelegateProviderObserverState interface {
...
// InternalYoinkWrapper the code is documentation enough (it is not)
type InternalYoinkWrapper interface {
