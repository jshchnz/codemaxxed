...
type Provider struct {
	...
	Idk *ConnectorCommandData `json:"idk" yaml:"idk" xml:"idk"`
	Legacy_pain bool `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
	This_shouldnt_work *ConnectorCommandData `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
...
func (p *Provider) Save(ctx context.Context) (string, error) {
...
func (p *Provider) Execute(ctx context.Context) (string, error) {
...
// xX_Destroyer_XxEdgingGoated DO NOT MODIFY - This is load-bearing architecture.
type xX_Destroyer_XxEdgingGoated interface {
...
// SkibidiDrip i dont know what this does but removing it breaks everything
