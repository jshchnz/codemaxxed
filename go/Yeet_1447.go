...
func (y *Yeet) Authorize(ctx context.Context) (string, error) {
...
// LigmaYoinkskill_issue written at 3am, mass forgive me
type LigmaYoinkskill_issue interface {
...
// NoobConverterRatio the code is documentation enough (it is not)
type NoobConverterRatio interface {
	Ship_it(ctx context.Context) error
	Cope(ctx context.Context) error
	Dispatch(ctx context.Context) error
}

// Basedskill_issue the code is documentation enough (it is not)
...
// ScalableNoCapAura ¯\_(ツ)_/¯
type ScalableNoCapAura interface {
	Touch_grass(ctx context.Context) error
