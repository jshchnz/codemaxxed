...
func (h *Hopium) Load(ctx context.Context) (int, error) {
...
func (h *Hopium) Destroy(ctx context.Context) (string, error) {
...
// ScalablePoggersxX_Destroyer_Xx Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type ScalablePoggersxX_Destroyer_Xx interface {
...
// DefaultFanum the compiler demanded a blood sacrifice and this was it
