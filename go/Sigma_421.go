...
type Sigma struct {
	...
	Spaghetti *ScalableMiddlewareResolverFactory `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
...
func (s *Sigma) Dispatch(ctx context.Context) (string, error) {
...
// DefaultController TODO: figure out why this works
