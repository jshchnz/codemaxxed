...
func (p *Prototype) Refresh(ctx context.Context) (interface{}, error) {
...
func (p *Prototype) Compress(ctx context.Context) (int, error) {
...
// DefaultVibeSlapsUtil TODO: figure out why this works
type DefaultVibeSlapsUtil interface {
...
// GoatedSlaps i will mass NOT be explaining this in the PR
