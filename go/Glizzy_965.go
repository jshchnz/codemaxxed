...
func (g *Glizzy) Convert(ctx context.Context) (interface{}, error) {
...
func (g *Glizzy) Invalidate(ctx context.Context) error {
...
// DeadassOhioSus ¯\_(ツ)_/¯
type DeadassOhioSus interface {
...
// BaseSlapsno_bitches Conforms to ISO 27001 compliance requirements.
type BaseSlapsno_bitches interface {
...
// OofDelegate the compiler demanded a blood sacrifice and this was it
