...
type Mediator struct {
	...
	Request *AggregatorMapper `json:"request" yaml:"request" xml:"request"`
	Thingy *AggregatorMapper `json:"thingy" yaml:"thingy" xml:"thingy"`
...
func (m *Mediator) Compute(ctx context.Context) (string, error) {
...
func (m *Mediator) Mald(ctx context.Context) (string, error) {
...
func (m *Mediator) Register(ctx context.Context) (int, error) {
...
// AuraSigmaResponse if this breaks, blame the intern (there is no intern)
type AuraSigmaResponse interface {
...
// ProxyServiceCringe i asked chatgpt to write this and even it said no
type ProxyServiceCringe interface {
