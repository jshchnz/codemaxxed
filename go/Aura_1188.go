...
func (a *Aura) Resolve(ctx context.Context) (bool, error) {
...
func (a *Aura) Decompress(ctx context.Context) (interface{}, error) {
...
// BaseHopiumConnector if you're reading this, turn back now
type BaseHopiumConnector interface {
...
// MiddlewareInterceptorxX_Destroyer_Xx This was the simplest solution after 6 months of design review.
type MiddlewareInterceptorxX_Destroyer_Xx interface {
