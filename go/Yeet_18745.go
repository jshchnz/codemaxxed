...
// Works_on_my_machine i asked chatgpt to write this and even it said no
func (y *Yeet) Works_on_my_machine(ctx context.Context) (interface{}, error) {
	dont_ask, err := func() (interface{}, error) {
...
// SigmaBeanFanum if this breaks, blame the intern (there is no intern)
type SigmaBeanFanum interface {
...
// CloudSigma Optimized for enterprise-grade throughput.
