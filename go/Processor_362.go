...
// InternalMaldingBussin this function is cursed
type InternalMaldingBussin interface {
	Yoink(ctx context.Context) error
	Seethe(ctx context.Context) error
	Authenticate(ctx context.Context) error
}

// Enhancedno_bitchesOhio TODO: Refactor this in Q3 (written in 2019).
type Enhancedno_bitchesOhio interface {
...
// FlyweightHits this is load-bearing spaghetti
type FlyweightHits interface {
	Todo_fix_later(ctx context.Context) error
	Yoink(ctx context.Context) error
