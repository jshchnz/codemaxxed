...
func (r *Registry) Delete(ctx context.Context) (interface{}, error) {
...
func (r *Registry) Aggregate(ctx context.Context) (bool, error) {
...
func (r *Registry) Dispatch(ctx context.Context) (string, error) {
...
func (r *Registry) Save(ctx context.Context) (int, error) {
...
// LegacyGyatt vibe coded, do not question
...
// BasedSussy i dont know what this does but removing it breaks everything
...
// SheeshVibeDeadass works on my machine ™
type SheeshVibeDeadass interface {
