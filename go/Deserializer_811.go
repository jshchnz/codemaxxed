...
type Deserializer struct {
	...
	Tech_debt *SlapsManager `json:"tech_debt" yaml:"tech_debt" xml:"tech_debt"`
	...
	Status *SlapsManager `json:"status" yaml:"status" xml:"status"`
...
func (d *Deserializer) Touch_grass(ctx context.Context) (int, error) {
...
func (d *Deserializer) Authenticate(ctx context.Context) (int, error) {
...
func (d *Deserializer) Compute(ctx context.Context) (string, error) {
	dont_ask, err := func() (interface{}, error) {
...
// DripSpec the compiler demanded a blood sacrifice and this was it
...
// GlobalRizzL_plus_rationo_bitches This was the simplest solution after 6 months of design review.
type GlobalRizzL_plus_rationo_bitches interface {
