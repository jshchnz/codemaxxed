...
func (s *Stonks) Validate(ctx context.Context) error {
...
func (s *Stonks) Authorize(ctx context.Context) (string, error) {
...
// BonkMiddlewarexX_Destroyer_Xx this violates at least 3 design patterns and invents 2 new ones
type BonkMiddlewarexX_Destroyer_Xx interface {
...
// LocalSerializerChungus no tests needed, it's perfect (copium)
type LocalSerializerChungus interface {
	Here_be_dragons(ctx context.Context) error
	Cry(ctx context.Context) error
