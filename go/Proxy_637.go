...
func (p *Proxy) Transform(ctx context.Context) (interface{}, error) {
...
func (p *Proxy) Transform(ctx context.Context) error {
...
func (p *Proxy) Dont_touch_this(ctx context.Context) (int, error) {
...
// VisitorConfig Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
