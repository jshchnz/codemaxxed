...
type Aggregator struct {
	...
	Tech_debt *SheeshPair `json:"tech_debt" yaml:"tech_debt" xml:"tech_debt"`
...
func (a *Aggregator) Persist(ctx context.Context) (interface{}, error) {
...
// DefaultBridgeGoated certified bruh moment
type DefaultBridgeGoated interface {
...
// ProxyDank this is load-bearing spaghetti
type ProxyDank interface {
...
// OrchestratorOof Legacy code - here be dragons.
