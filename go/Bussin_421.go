...
// skill_issueDecorator Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
...
// LocalChungusHitsPrototype the code is documentation enough (it is not)
type LocalChungusHitsPrototype interface {
...
// SigmaSlayGyatt past me was a different person and i dont trust them
type SigmaSlayGyatt interface {
	Resolve(ctx context.Context) error
