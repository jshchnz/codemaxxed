...
type Based struct {
	...
	Target *CoreRepository `json:"target" yaml:"target" xml:"target"`
...
// DripDeadassRizz Thread-safe implementation using the double-checked locking pattern.
type DripDeadassRizz interface {
