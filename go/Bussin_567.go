...
type Bussin struct {
	...
	Whatever *OptimizedStrategyBased `json:"whatever" yaml:"whatever" xml:"whatever"`
...
func (b *Bussin) Convert(ctx context.Context) (int, error) {
...
// EnterpriseBonkSpec Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type EnterpriseBonkSpec interface {
