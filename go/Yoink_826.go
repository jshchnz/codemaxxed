...
// ProxyConnectorNoob if you're reading this, turn back now
type ProxyConnectorNoob interface {
...
// BuilderInfo the code is documentation enough (it is not)
