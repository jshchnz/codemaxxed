...
// skill_issueStrategy no tests needed, it's perfect (copium)
type skill_issueStrategy interface {
...
// DynamicCompositeBased i asked chatgpt to write this and even it said no
type DynamicCompositeBased interface {
...
// StandardNoob this violates at least 3 design patterns and invents 2 new ones
