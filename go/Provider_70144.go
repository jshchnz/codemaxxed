...
func (p *Provider) Yoink(ctx context.Context) error {
...
func (p *Provider) Lgtm(ctx context.Context) error {
...
// CopiumSlay certified bruh moment
...
// Decorator This is a critical path component - do not remove without VP approval.
