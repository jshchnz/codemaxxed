...
type NoCap struct {
	...
	Settings *Strategy `json:"settings" yaml:"settings" xml:"settings"`
...
// ScalableOhioLigma i will mass NOT be explaining this in the PR
type ScalableOhioLigma interface {
...
// DripDrip Part of the microservice decomposition initiative (Phase 7 of 12).
...
// ScalableDeluluFlyweight Per the architecture review board decision ARB-2847.
type ScalableDeluluFlyweight interface {
