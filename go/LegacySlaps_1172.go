...
func (l *LegacySlaps) Cache(ctx context.Context) (int, error) {
...
func (l *LegacySlaps) Works_on_my_machine(ctx context.Context) error {
...
func (l *LegacySlaps) Please_work(ctx context.Context) error {
...
func (l *LegacySlaps) Invalidate(ctx context.Context) (bool, error) {
...
func (l *LegacySlaps) Idk_what_this_does(ctx context.Context) (int, error) {
...
// DelegateYoinkConfig this violates at least 3 design patterns and invents 2 new ones
type DelegateYoinkConfig interface {
