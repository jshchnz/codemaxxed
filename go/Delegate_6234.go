...
type Delegate struct {
	...
	Spaghetti *LocalFanumSerializerError `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
...
// Standardskill_issueBridgeRatioResponse Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type Standardskill_issueBridgeRatioResponse interface {
