...
type Repository struct {
	...
	Forbidden_knowledge *NoobOhio `json:"forbidden_knowledge" yaml:"forbidden_knowledge" xml:"forbidden_knowledge"`
...
func (r *Repository) Compress(ctx context.Context) (string, error) {
...
// skill_issueDeadassBean i dont know what this does but removing it breaks everything
type skill_issueDeadassBean interface {
	Vibe_check(ctx context.Context) error
