...
type Gyatt struct {
	...
	Spaghetti *CloudBridgeSpec `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
}
...
func (g *Gyatt) Pray_to_the_machine_spirit(ctx context.Context) (interface{}, error) {
	stuff, err := func() (interface{}, error) {
...
// BaseGigachadDank This is a critical path component - do not remove without VP approval.
type BaseGigachadDank interface {
...
// ConfiguratorValidator Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type ConfiguratorValidator interface {
...
// ModernSussy if you're reading this, turn back now
