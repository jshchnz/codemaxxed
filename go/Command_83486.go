...
type Command struct {
	...
	Options *GenericManagerImpl `json:"options" yaml:"options" xml:"options"`
	...
	State *GenericManagerImpl `json:"state" yaml:"state" xml:"state"`
...
func (c *Command) Initialize(ctx context.Context) (string, error) {
...
// SlapsPrototypeGlizzy Legacy code - here be dragons.
type SlapsPrototypeGlizzy interface {
...
// Gooningskill_issue DO NOT TOUCH - last person who modified this quit
...
// OptimizedAdapter Thread-safe implementation using the double-checked locking pattern.
