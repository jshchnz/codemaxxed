...
func (d *Dank) Cache(ctx context.Context) (bool, error) {
...
func (d *Dank) Format(ctx context.Context) error {
...
// CloudLigmaRepositoryWrapper written at 3am, mass forgive me
type CloudLigmaRepositoryWrapper interface {
