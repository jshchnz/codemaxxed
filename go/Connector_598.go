...
type Connector struct {
	...
	Status *GyattGlizzyInfo `json:"status" yaml:"status" xml:"status"`
	Node int `json:"node" yaml:"node" xml:"node"`
	X *sync.Mutex `json:"x" yaml:"x" xml:"x"`
	Index *GyattGlizzyInfo `json:"index" yaml:"index" xml:"index"`
	Dont_ask string `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
	X *GyattGlizzyInfo `json:"x" yaml:"x" xml:"x"`
...
func (c *Connector) Load(ctx context.Context) (int, error) {
...
// DynamicStonksxX_Destroyer_XxHelper TODO: figure out why this works
type DynamicStonksxX_Destroyer_XxHelper interface {
