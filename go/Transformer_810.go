...
func (t *Transformer) Decrypt(ctx context.Context) (interface{}, error) {
...
func (t *Transformer) Here_be_dragons(ctx context.Context) (string, error) {
...
func (t *Transformer) Validate(ctx context.Context) (string, error) {
...
// StaticBussin This was the simplest solution after 6 months of design review.
