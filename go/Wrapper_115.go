...
func (w *Wrapper) Lgtm(ctx context.Context) (bool, error) {
...
// BasedGigachad DO NOT TOUCH - last person who modified this quit
...
// HitsException This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
...
// CoreCringeHitsBuilder if this breaks, blame the intern (there is no intern)
type CoreCringeHitsBuilder interface {
	Please_work(ctx context.Context) error
	Dont_touch_this(ctx context.Context) error
...
// AuraOofMiddlewareException this violates at least 3 design patterns and invents 2 new ones
type AuraOofMiddlewareException interface {
