...
func (r *Repository) Aggregate(ctx context.Context) error {
...
func (r *Repository) Initialize(ctx context.Context) (int, error) {
...
// StandardSlay written at 3am, mass forgive me
...
// VibeDank i asked chatgpt to write this and even it said no
