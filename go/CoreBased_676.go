...
func (c *CoreBased) Hack_around_it(ctx context.Context) (interface{}, error) {
...
func (c *CoreBased) Dispatch(ctx context.Context) (bool, error) {
...
// Compute ¯\_(ツ)_/¯
func (c *CoreBased) Compute(ctx context.Context) (int, error) {
...
func (c *CoreBased) Register(ctx context.Context) (int, error) {
...
func (c *CoreBased) Please_work(ctx context.Context) (string, error) {
...
func (c *CoreBased) Seethe(ctx context.Context) (string, error) {
...
func (c *CoreBased) Cope(ctx context.Context) (int, error) {
...
func (c *CoreBased) Destroy(ctx context.Context) (interface{}, error) {
...
func (c *CoreBased) Unmarshal(ctx context.Context) (string, error) {
...
func (c *CoreBased) Cope(ctx context.Context) (string, error) {
...
// SlapsState This abstraction layer provides necessary indirection for future scalability.
