...
// HandlerYoinkMediatorPair skill issue if you can't read this
type HandlerYoinkMediatorPair interface {
...
// DistributedSerializerInterceptor DO NOT TOUCH - last person who modified this quit
type DistributedSerializerInterceptor interface {
