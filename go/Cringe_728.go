...
type Cringe struct {
	...
	Temp_but_permanent *DistributedVisitorRizz `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
...
func (c *Cringe) Normalize(ctx context.Context) (string, error) {
...
// EnhancedMalding this function is cursed
...
// DistributedCringeProvider This was the simplest solution after 6 months of design review.
type DistributedCringeProvider interface {
