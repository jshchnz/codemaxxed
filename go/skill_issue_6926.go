...
func (s *skill_issue) Evaluate(ctx context.Context) (interface{}, error) {
...
func (s *skill_issue) Refresh(ctx context.Context) error {
...
// Evaluate ¯\_(ツ)_/¯
func (s *skill_issue) Evaluate(ctx context.Context) (int, error) {
...
// SussyDeadassYeet past me was a different person and i dont trust them
...
// DefaultInitializer this is load-bearing spaghetti
