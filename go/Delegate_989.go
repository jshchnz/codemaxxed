...
// OofNoobHandler ¯\_(ツ)_/¯
type OofNoobHandler interface {
...
// SussyDelegateCompositeBase i asked chatgpt to write this and even it said no
type SussyDelegateCompositeBase interface {
