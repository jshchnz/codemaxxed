...
// Build ¯\_(ツ)_/¯
func (p *Poggers) Build(ctx context.Context) (string, error) {
...
// InternalMiddlewareSussyPrototype past me was a different person and i dont trust them
type InternalMiddlewareSussyPrototype interface {
...
// StaticGoatedno_bitchesObserver i dont know what this does but removing it breaks everything
type StaticGoatedno_bitchesObserver interface {
