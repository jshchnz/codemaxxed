...
type Decorator struct {
	...
	Config *DistributedEndpointStonksLigma `json:"config" yaml:"config" xml:"config"`
...
func (d *Decorator) Load(ctx context.Context) error {
...
// DelegateGigachadMewingRequest no tests needed, it's perfect (copium)
type DelegateGigachadMewingRequest interface {
	Dont_touch_this(ctx context.Context) error
	Works_on_my_machine(ctx context.Context) error
	Hack_around_it(ctx context.Context) error
}

// BaseHitsSlapsRequest the code is documentation enough (it is not)
type BaseHitsSlapsRequest interface {
