...
type Yoink struct {
	...
	Whatever *Deserializer `json:"whatever" yaml:"whatever" xml:"whatever"`
...
// ConnectorBonk past me was a different person and i dont trust them
...
// ConfiguratorGooningInitializer if you're reading this, turn back now
type ConfiguratorGooningInitializer interface {
