...
// PoggersNoobImpl written at 3am, mass forgive me
type PoggersNoobImpl interface {
	Authorize(ctx context.Context) error
	Configure(ctx context.Context) error
	Works_on_my_machine(ctx context.Context) error
}

// YeetGoatedNoob i dont know what this does but removing it breaks everything
type YeetGoatedNoob interface {
...
// HopiumHopium abandon all hope ye who enter here
