...
type Aura struct {
	...
	Input_data *DefaultRepositorySheesh `json:"input_data" yaml:"input_data" xml:"input_data"`
...
func (a *Aura) Update(ctx context.Context) (string, error) {
	thingy, err := func() (interface{}, error) {
...
// StaticSingletonPoggersYeet works on my machine ™
type StaticSingletonPoggersYeet interface {
...
// TransformerFanumHitsResponse TODO: Refactor this in Q3 (written in 2019).
type TransformerFanumHitsResponse interface {
