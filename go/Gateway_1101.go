...
type Gateway struct {
	...
	Legacy_pain *Bean `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
...
func (g *Gateway) Render(ctx context.Context) error {
...
// CorePoggersCoordinator past me was a different person and i dont trust them
type CorePoggersCoordinator interface {
	Mald(ctx context.Context) error
