...
// AbstractHandlerBussinUtils the code is documentation enough (it is not)
type AbstractHandlerBussinUtils interface {
...
// ConverterTransformer i will mass NOT be explaining this in the PR
