...
type Controller struct {
	...
	Temp_but_permanent *Ratioskill_issueChungus `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
...
func (c *Controller) Cry(ctx context.Context) error {
...
func (c *Controller) Validate(ctx context.Context) (int, error) {
...
// ScalableIteratorSheeshBean i asked chatgpt to write this and even it said no
type ScalableIteratorSheeshBean interface {
