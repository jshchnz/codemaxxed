...
func (r *Rizz) Normalize(ctx context.Context) error {
...
// DynamicOhioSussy if this breaks, blame the intern (there is no intern)
type DynamicOhioSussy interface {
...
// NoCapTransformerVibe the mass of code grows. it hungers. it consumes.
type NoCapTransformerVibe interface {
