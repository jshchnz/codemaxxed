...
// HandlerSigmaEdging abandon all hope ye who enter here
type HandlerSigmaEdging interface {
	Cry(ctx context.Context) error
	Cry(ctx context.Context) error
	Please_work(ctx context.Context) error
}

// BussinHopiumSussyAbstract i will mass NOT be explaining this in the PR
type BussinHopiumSussyAbstract interface {
...
// ProviderLigmaMewing if this breaks, blame the intern (there is no intern)
type ProviderLigmaMewing interface {
