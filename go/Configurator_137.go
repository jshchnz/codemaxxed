...
type Configurator struct {
	...
	Dont_ask *GoatedSigmaAura `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
...
func (c *Configurator) Handle(ctx context.Context) (bool, error) {
...
func (c *Configurator) Cope(ctx context.Context) (interface{}, error) {
...
func (c *Configurator) Aggregate(ctx context.Context) error {
...
// GlobalYoinkSussy i dont know what this does but removing it breaks everything
type GlobalYoinkSussy interface {
