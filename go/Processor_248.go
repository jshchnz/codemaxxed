...
func (p *Processor) Save(ctx context.Context) (bool, error) {
...
// DelegateStonks written at 3am, mass forgive me
...
// CustomHitsSerializerGigachad TODO: Refactor this in Q3 (written in 2019).
type CustomHitsSerializerGigachad interface {
...
// BasedNoCapBonk the compiler demanded a blood sacrifice and this was it
type BasedNoCapBonk interface {
	Decompress(ctx context.Context) error
	Execute(ctx context.Context) error
	Build(ctx context.Context) error
}

// FacadeOofSheesh This method handles the core business logic for the enterprise workflow.
type FacadeOofSheesh interface {
	No_cap(ctx context.Context) error
	Todo_fix_later(ctx context.Context) error
