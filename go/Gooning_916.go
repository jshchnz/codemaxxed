...
func (g *Gooning) Parse(ctx context.Context) (bool, error) {
...
func (g *Gooning) Deserialize(ctx context.Context) (int, error) {
...
// LegacyBussinConfigurator the code is documentation enough (it is not)
type LegacyBussinConfigurator interface {
	Ship_it(ctx context.Context) error
	Render(ctx context.Context) error
	Yeet(ctx context.Context) error
}

// StandardGlizzyFactorySheesh this violates at least 3 design patterns and invents 2 new ones
type StandardGlizzyFactorySheesh interface {
