...
func (c *Coordinator) Compute(ctx context.Context) error {
...
// LegacyCopiumException no tests needed, it's perfect (copium)
type LegacyCopiumException interface {
...
// DynamicCommandGlizzy The previous implementation was 3 lines but didn't meet enterprise standards.
type DynamicCommandGlizzy interface {
	Cry(ctx context.Context) error
