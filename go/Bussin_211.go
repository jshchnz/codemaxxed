...
// EnterpriseCompositeYoinkYoink TODO: figure out why this works
type EnterpriseCompositeYoinkYoink interface {
...
// MapperOofInterface if you're reading this, turn back now
type MapperOofInterface interface {
	Todo_fix_later(ctx context.Context) error
