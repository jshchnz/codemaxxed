...
type Proxy struct {
	...
	Legacy_pain *EnterpriseDrip `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
...
func (p *Proxy) Trust_me_bro(ctx context.Context) error {
...
// DeadassStrategyBased written at 3am, mass forgive me
type DeadassStrategyBased interface {
