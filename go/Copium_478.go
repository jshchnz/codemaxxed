...
type Copium struct {
	...
	Legacy_pain *LocalFacade `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
...
func (c *Copium) Transform(ctx context.Context) (interface{}, error) {
...
// CoreYoinkValue TODO: figure out why this works
type CoreYoinkValue interface {
