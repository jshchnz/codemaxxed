...
func (v *Visitor) Parse(ctx context.Context) (bool, error) {
...
func (v *Visitor) Process(ctx context.Context) (int, error) {
...
// BaseBakaGlizzyBased i asked chatgpt to write this and even it said no
type BaseBakaGlizzyBased interface {
...
// SigmaLigmaDeserializerResponse DO NOT MODIFY - This is load-bearing architecture.
type SigmaLigmaDeserializerResponse interface {
