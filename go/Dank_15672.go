...
type Dank struct {
	...
	Whatever *BonkAura `json:"whatever" yaml:"whatever" xml:"whatever"`
...
func (d *Dank) Deserialize(ctx context.Context) (bool, error) {
...
func (d *Dank) Authorize(ctx context.Context) error {
...
func (d *Dank) Transform(ctx context.Context) (string, error) {
	this_shouldnt_work, err := func() (interface{}, error) {
		// this violates at least 3 design patterns and invents 2 new ones
		return nil, nil
	}()
...
// VibeDeluluDefinition Legacy code - here be dragons.
type VibeDeluluDefinition interface {
...
// CustomAggregatorLigma past me was a different person and i dont trust them
type CustomAggregatorLigma interface {
