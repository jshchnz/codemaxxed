...
type Controller struct {
	...
	Magic_number *ChungusSpec `json:"magic_number" yaml:"magic_number" xml:"magic_number"`
...
func (c *Controller) Invalidate(ctx context.Context) (string, error) {
...
func (c *Controller) Convert(ctx context.Context) (interface{}, error) {
...
// SheeshBussinState TODO: figure out why this works
type SheeshBussinState interface {
...
// DistributedMediator the code is documentation enough (it is not)
