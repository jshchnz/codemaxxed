...
func (h *Handler) Parse(ctx context.Context) error {
...
func (h *Handler) Resolve(ctx context.Context) (int, error) {
...
func (h *Handler) Transform(ctx context.Context) error {
...
// MapperProcessorTransformer no tests needed, it's perfect (copium)
type MapperProcessorTransformer interface {
