...
func (s *Stonks) Invalidate(ctx context.Context) (int, error) {
...
// ProviderMewing Lorem ipsum dolor sit amet, consectetur adipiscing elit.
...
// InterceptorSerializer i asked chatgpt to write this and even it said no
type InterceptorSerializer interface {
	Please_work(ctx context.Context) error
...
// ScalableHitsUtil Legacy code - here be dragons.
type ScalableHitsUtil interface {
