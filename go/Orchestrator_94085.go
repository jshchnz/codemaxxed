...
func (o *Orchestrator) Serialize(ctx context.Context) (string, error) {
...
// Glizzyskill_issueEntity if you're reading this, turn back now
type Glizzyskill_issueEntity interface {
...
// BasedDelegateVibe the mass of code grows. it hungers. it consumes.
type BasedDelegateVibe interface {
