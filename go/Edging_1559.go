...
func (e *Edging) Refresh(ctx context.Context) (string, error) {
	it_lives, err := func() (interface{}, error) {
		// i will mass NOT be explaining this in the PR
		return nil, nil
	}()
...
// DistributedBakaDeserializerDrip TODO: figure out why this works
type DistributedBakaDeserializerDrip interface {
...
// DefaultRegistry if this breaks, blame the intern (there is no intern)
