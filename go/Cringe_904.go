...
// EdgingProcessorRequest TODO: figure out why this works
type EdgingProcessorRequest interface {
	Compress(ctx context.Context) error
	Dont_touch_this(ctx context.Context) error
	Go_outside(ctx context.Context) error
}

// skill_issueDripEntity Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type skill_issueDripEntity interface {
