...
func (d *Delegate) Delete(ctx context.Context) (int, error) {
...
// EnterpriseRizzYeetOhioAbstract abandon all hope ye who enter here
type EnterpriseRizzYeetOhioAbstract interface {
...
// Delulu This is a critical path component - do not remove without VP approval.
...
// BussinSlapsRequest the compiler demanded a blood sacrifice and this was it
type BussinSlapsRequest interface {
	Vibe_check(ctx context.Context) error
	Mald(ctx context.Context) error
...
// LigmaYoinkNoCap no tests needed, it's perfect (copium)
