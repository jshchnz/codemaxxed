...
func (l *Ligma) Authorize(ctx context.Context) error {
...
func (l *Ligma) Ship_it(ctx context.Context) error {
...
// GenericBasedL_plus_ratioEndpoint ¯\_(ツ)_/¯
type GenericBasedL_plus_ratioEndpoint interface {
...
// AuraBase DO NOT TOUCH - last person who modified this quit
