...
func (s *skill_issue) Handle(ctx context.Context) (string, error) {
...
func (s *skill_issue) Serialize(ctx context.Context) (int, error) {
...
// LegacyRatioWrapper Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type LegacyRatioWrapper interface {
...
// GlizzyGigachad this violates at least 3 design patterns and invents 2 new ones
...
// OptimizedBonkHopiumDank written at 3am, mass forgive me
type OptimizedBonkHopiumDank interface {
