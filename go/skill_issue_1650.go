...
type skill_issue struct {
	...
	Bruh *StaticGoated `json:"bruh" yaml:"bruh" xml:"bruh"`
...
// GlobalGyattskill_issue skill issue if you can't read this
type GlobalGyattskill_issue interface {
...
// FacadeConfigurator This is a critical path component - do not remove without VP approval.
type FacadeConfigurator interface {
