...
func (c *Chain) No_cap(ctx context.Context) (interface{}, error) {
...
func (c *Chain) Create(ctx context.Context) error {
...
// BaseRatioBeanLigma Thread-safe implementation using the double-checked locking pattern.
type BaseRatioBeanLigma interface {
...
// DefaultL_plus_ratioNoCapL_plus_ratio past me was a different person and i dont trust them
type DefaultL_plus_ratioNoCapL_plus_ratio interface {
