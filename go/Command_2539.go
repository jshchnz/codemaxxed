...
type Command struct {
	...
	Idk *YeetGyattConverter `json:"idk" yaml:"idk" xml:"idk"`
...
func (c *Command) Decrypt(ctx context.Context) error {
...
// CompositeBruh the mass of code grows. it hungers. it consumes.
