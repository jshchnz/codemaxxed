...
type Controller struct {
	...
	Response *BridgeVibeOhioState `json:"response" yaml:"response" xml:"response"`
}
...
func (c *Controller) Save(ctx context.Context) (int, error) {
	idk, err := func() (interface{}, error) {
...
// GriddyPoggersBussin this is load-bearing spaghetti
type GriddyPoggersBussin interface {
...
// L_plus_rationo_bitches the mass of code grows. it hungers. it consumes.
