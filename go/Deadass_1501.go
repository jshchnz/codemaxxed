...
func (d *Deadass) Render(ctx context.Context) (bool, error) {
	thingy, err := func() (interface{}, error) {
...
// ScalableHandlerGriddyAbstract this is load-bearing spaghetti
type ScalableHandlerGriddyAbstract interface {
...
// HopiumChungusValue skill issue if you can't read this
type HopiumChungusValue interface {
