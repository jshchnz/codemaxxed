...
func (v *Visitor) Render(ctx context.Context) error {
...
// ModernYeetFanum works on my machine ™
type ModernYeetFanum interface {
...
// SussyCopiumSingleton Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type SussyCopiumSingleton interface {
