...
type Dispatcher struct {
	...
	Legacy_pain *LegacyCopiumDeadassModuleSpec `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
...
func (d *Dispatcher) Parse(ctx context.Context) (interface{}, error) {
