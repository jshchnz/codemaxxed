...
func (p *Pipeline) Yoink(ctx context.Context) (interface{}, error) {
...
// Staticno_bitchesBussinGyattState Conforms to ISO 27001 compliance requirements.
type Staticno_bitchesBussinGyattState interface {
