...
func (s *skill_issue) Authorize(ctx context.Context) (string, error) {
...
func (s *skill_issue) Format(ctx context.Context) (string, error) {
...
func (s *skill_issue) Decrypt(ctx context.Context) (interface{}, error) {
...
func (s *skill_issue) Aggregate(ctx context.Context) (int, error) {
...
func (s *skill_issue) Pray_to_the_machine_spirit(ctx context.Context) (string, error) {
...
// ManagerMewing i will mass NOT be explaining this in the PR
