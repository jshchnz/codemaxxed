...
func (g *Gigachad) Invalidate(ctx context.Context) error {
...
func (g *Gigachad) Sacrifice_to_the_compiler(ctx context.Context) (string, error) {
...
func (g *Gigachad) Sync(ctx context.Context) (int, error) {
...
// SingletonPoggersBruh abandon all hope ye who enter here
type SingletonPoggersBruh interface {
...
// PipelineRequest the compiler demanded a blood sacrifice and this was it
