...
func (g *Glizzy) Aggregate(ctx context.Context) (string, error) {
...
// BasedChungusIterator Reviewed and approved by the Technical Steering Committee.
type BasedChungusIterator interface {
...
// HitsGoatedCringe works on my machine ™
type HitsGoatedCringe interface {
