...
type Sigma struct {
	...
	Thingy *ProviderL_plus_ratioSpec `json:"thingy" yaml:"thingy" xml:"thingy"`
...
// AbstractPoggersRequest The previous implementation was 3 lines but didn't meet enterprise standards.
type AbstractPoggersRequest interface {
