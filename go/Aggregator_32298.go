...
type Aggregator struct {
	...
	Source *Hits `json:"source" yaml:"source" xml:"source"`
...
func (a *Aggregator) Build(ctx context.Context) (string, error) {
	xxx, err := func() (interface{}, error) {
...
func (a *Aggregator) Handle(ctx context.Context) (int, error) {
...
// DistributedGriddyNoCap abandon all hope ye who enter here
type DistributedGriddyNoCap interface {
...
// GlobalDispatcher This was the simplest solution after 6 months of design review.
