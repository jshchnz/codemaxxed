...
func (p *Prototype) Resolve(ctx context.Context) (int, error) {
...
func (p *Prototype) Cache(ctx context.Context) error {
...
// skill_issueVibeImpl DO NOT MODIFY - This is load-bearing architecture.
type skill_issueVibeImpl interface {
...
// StaticBonkGlizzyError no tests needed, it's perfect (copium)
type StaticBonkGlizzyError interface {
