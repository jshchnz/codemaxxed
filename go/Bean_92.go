...
func (b *Bean) Format(ctx context.Context) error {
...
// GooningBussinAggregator the compiler demanded a blood sacrifice and this was it
type GooningBussinAggregator interface {
