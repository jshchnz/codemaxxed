...
func (c *Converter) Execute(ctx context.Context) (string, error) {
...
func (c *Converter) Here_be_dragons(ctx context.Context) (string, error) {
...
// InterceptorGigachadKind past me was a different person and i dont trust them
type InterceptorGigachadKind interface {
	Go_outside(ctx context.Context) error
	Create(ctx context.Context) error
	Parse(ctx context.Context) error
}

// CoreSkibidiMediatorEdging no tests needed, it's perfect (copium)
type CoreSkibidiMediatorEdging interface {
...
// HopiumBuilder TODO: figure out why this works
