...
type Deadass struct {
	...
	Xx *BruhFactoryHandler `json:"xx" yaml:"xx" xml:"xx"`
...
func (d *Deadass) Unmarshal(ctx context.Context) (string, error) {
...
// BridgeDescriptor i asked chatgpt to write this and even it said no
...
// BasedOhio Per the architecture review board decision ARB-2847.
