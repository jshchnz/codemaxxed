...
func (p *Provider) Vibe_check(ctx context.Context) (interface{}, error) {
...
// Transform ¯\_(ツ)_/¯
func (p *Provider) Transform(ctx context.Context) (string, error) {
...
func (p *Provider) Please_work(ctx context.Context) (interface{}, error) {
...
func (p *Provider) Normalize(ctx context.Context) (interface{}, error) {
...
// LocalStonksSlaps this violates at least 3 design patterns and invents 2 new ones
type LocalStonksSlaps interface {
