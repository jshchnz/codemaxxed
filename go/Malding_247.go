...
type Malding struct {
	...
	Xxx *Defaultskill_issueGooningResult `json:"xxx" yaml:"xxx" xml:"xxx"`
...
// LegacyDeadassBussinController DO NOT TOUCH - last person who modified this quit
type LegacyDeadassBussinController interface {
...
// CoreOofDescriptor DO NOT MODIFY - This is load-bearing architecture.
type CoreOofDescriptor interface {
	Pray_to_the_machine_spirit(ctx context.Context) error
...
// GlizzyGlizzyxX_Destroyer_Xx the code is documentation enough (it is not)
type GlizzyGlizzyxX_Destroyer_Xx interface {
	Abandon_all_hope(ctx context.Context) error
