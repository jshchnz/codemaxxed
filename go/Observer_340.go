...
// GyattAuraL_plus_ratio Implements the AbstractFactory pattern for maximum extensibility.
type GyattAuraL_plus_ratio interface {
...
// StaticDelegateSussyBruh abandon all hope ye who enter here
type StaticDelegateSussyBruh interface {
