...
// BaseBakaYeetBussin Implements the AbstractFactory pattern for maximum extensibility.
type BaseBakaYeetBussin interface {
...
// RizzBakaBean this violates at least 3 design patterns and invents 2 new ones
type RizzBakaBean interface {
	No_cap(ctx context.Context) error
