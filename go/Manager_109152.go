...
type Manager struct {
	...
	Index *skill_issueskill_issueDeserializer `json:"index" yaml:"index" xml:"index"`
	...
	Xx *skill_issueskill_issueDeserializer `json:"xx" yaml:"xx" xml:"xx"`
	Input_data map[string]interface{} `json:"input_data" yaml:"input_data" xml:"input_data"`
	Instance *skill_issueskill_issueDeserializer `json:"instance" yaml:"instance" xml:"instance"`
...
func (m *Manager) Decompress(ctx context.Context) (interface{}, error) {
...
// ConfiguratorGooningSkibidi if you're reading this, turn back now
type ConfiguratorGooningSkibidi interface {
...
// StaticMiddlewareLigmaSheeshDefinition abandon all hope ye who enter here
type StaticMiddlewareLigmaSheeshDefinition interface {
