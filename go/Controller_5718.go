...
type Controller struct {
	...
	Options *GenericBussin `json:"options" yaml:"options" xml:"options"`
	Dont_ask *GenericBussin `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
...
func (c *Controller) Transform(ctx context.Context) (interface{}, error) {
...
func (c *Controller) Authenticate(ctx context.Context) (int, error) {
...
// Defaultskill_issueYoink if you're reading this, turn back now
type Defaultskill_issueYoink interface {
