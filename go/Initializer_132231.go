...
type Initializer struct {
	...
	Result *BuilderRegistry `json:"result" yaml:"result" xml:"result"`
...
func (i *Initializer) Go_outside(ctx context.Context) (interface{}, error) {
...
func (i *Initializer) Execute(ctx context.Context) (interface{}, error) {
...
// BasexX_Destroyer_Xx TODO: figure out why this works
...
// EdgingVibeWrapper abandon all hope ye who enter here
type EdgingVibeWrapper interface {
	Cope(ctx context.Context) error
