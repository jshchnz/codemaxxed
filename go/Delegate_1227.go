...
type Delegate struct {
	...
	Config *SigmaDefinition `json:"config" yaml:"config" xml:"config"`
	Cursed_value error `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
	The_darkness chan struct{} `json:"the_darkness" yaml:"the_darkness" xml:"the_darkness"`
	Bruh interface{} `json:"bruh" yaml:"bruh" xml:"bruh"`
	Status *SigmaDefinition `json:"status" yaml:"status" xml:"status"`
...
func (d *Delegate) Resolve(ctx context.Context) (int, error) {
...
// DefaultBussinLigma TODO: Refactor this in Q3 (written in 2019).
type DefaultBussinLigma interface {
	Decrypt(ctx context.Context) error
	Trust_me_bro(ctx context.Context) error
	Yeet(ctx context.Context) error
	Pray_to_the_machine_spirit(ctx context.Context) error
