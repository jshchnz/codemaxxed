...
type Yeet struct {
	...
	Stuff *DynamicGigachadAuraProvider `json:"stuff" yaml:"stuff" xml:"stuff"`
...
// L_plus_ratioNoCapMalding TODO: Refactor this in Q3 (written in 2019).
type L_plus_ratioNoCapMalding interface {
	Mald(ctx context.Context) error
	Touch_grass(ctx context.Context) error
	Abandon_all_hope(ctx context.Context) error
}

// GoatedEdging the mass of code grows. it hungers. it consumes.
