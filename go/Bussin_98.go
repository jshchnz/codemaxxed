...
// CompositeVisitorGoatedError if you're reading this, turn back now
type CompositeVisitorGoatedError interface {
...
// TransformerCopiumBaka certified bruh moment
type TransformerCopiumBaka interface {
	Save(ctx context.Context) error
	Lgtm(ctx context.Context) error
	Rizz_up(ctx context.Context) error
}

// Ligmaskill_issue works on my machine ™
