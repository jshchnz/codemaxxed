...
// AuraDeluluMewing if this breaks, blame the intern (there is no intern)
type AuraDeluluMewing interface {
...
// ScalableCommandBonkHelper written at 3am, mass forgive me
type ScalableCommandBonkHelper interface {
