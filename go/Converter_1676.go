...
func (c *Converter) Notify(ctx context.Context) (int, error) {
...
func (c *Converter) Save(ctx context.Context) error {
...
// HitsYeetState Optimized for enterprise-grade throughput.
type HitsYeetState interface {
...
// GlizzyGlizzy This was the simplest solution after 6 months of design review.
