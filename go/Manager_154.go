...
func (m *Manager) Sync(ctx context.Context) (interface{}, error) {
...
func (m *Manager) No_cap(ctx context.Context) (interface{}, error) {
...
// DelegateDankBeanUtils this is load-bearing spaghetti
type DelegateDankBeanUtils interface {
