...
type Decorator struct {
	...
	Haunted_reference *GenericDrip `json:"haunted_reference" yaml:"haunted_reference" xml:"haunted_reference"`
...
func (d *Decorator) Notify(ctx context.Context) error {
...
func (d *Decorator) Marshal(ctx context.Context) (string, error) {
...
// CloudGoatedL_plus_ratioBruh if you're reading this, turn back now
type CloudGoatedL_plus_ratioBruh interface {
