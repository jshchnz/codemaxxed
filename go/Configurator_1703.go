...
func (c *Configurator) Sync(ctx context.Context) (int, error) {
...
func (c *Configurator) Authenticate(ctx context.Context) (interface{}, error) {
...
// CopiumNoCapVibe TODO: figure out why this works
type CopiumNoCapVibe interface {
