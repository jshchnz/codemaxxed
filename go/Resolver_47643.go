...
type Resolver struct {
	...
	Destination *L_plus_ratioYeetSlayResult `json:"destination" yaml:"destination" xml:"destination"`
...
func (r *Resolver) Handle(ctx context.Context) (interface{}, error) {
...
// StaticGigachadEdgingCommandRecord TODO: Refactor this in Q3 (written in 2019).
type StaticGigachadEdgingCommandRecord interface {
