...
func (o *Orchestrator) Aggregate(ctx context.Context) (string, error) {
...
func (o *Orchestrator) Register(ctx context.Context) (bool, error) {
...
// GoatedHelper i asked chatgpt to write this and even it said no
...
// GooningHopiumGoated This is a critical path component - do not remove without VP approval.
type GooningHopiumGoated interface {
	Do_the_thing(ctx context.Context) error
