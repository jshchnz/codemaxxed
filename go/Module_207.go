...
type Module struct {
	...
	Settings *Builder `json:"settings" yaml:"settings" xml:"settings"`
	Eldritch_data map[string]interface{} `json:"eldritch_data" yaml:"eldritch_data" xml:"eldritch_data"`
	Idk interface{} `json:"idk" yaml:"idk" xml:"idk"`
	Whatever *Builder `json:"whatever" yaml:"whatever" xml:"whatever"`
}
...
// GriddyPoggers i will mass NOT be explaining this in the PR
...
// Gooning Reviewed and approved by the Technical Steering Committee.
