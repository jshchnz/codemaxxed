...
type Builder struct {
	...
	Entry *Chain `json:"entry" yaml:"entry" xml:"entry"`
...
func (b *Builder) Works_on_my_machine(ctx context.Context) (int, error) {
...
// DistributedRepositoryGriddyGriddy This was the simplest solution after 6 months of design review.
type DistributedRepositoryGriddyGriddy interface {
...
// InternalGoatedHopiumBridge This was the simplest solution after 6 months of design review.
type InternalGoatedHopiumBridge interface {
