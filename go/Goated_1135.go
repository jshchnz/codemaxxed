...
type Goated struct {
	...
	Count *CloudProviderDank `json:"count" yaml:"count" xml:"count"`
	Haunted_reference chan struct{} `json:"haunted_reference" yaml:"haunted_reference" xml:"haunted_reference"`
	Whatever []byte `json:"whatever" yaml:"whatever" xml:"whatever"`
	Cursed_value float64 `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
	This_shouldnt_work []byte `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
	Options *CloudProviderDank `json:"options" yaml:"options" xml:"options"`
}
...
func (g *Goated) Abandon_all_hope(ctx context.Context) error {
...
func (g *Goated) Compress(ctx context.Context) (interface{}, error) {
...
func (g *Goated) Ship_it(ctx context.Context) (interface{}, error) {
...
func (g *Goated) Decompress(ctx context.Context) (bool, error) {
...
func (g *Goated) Handle(ctx context.Context) (int, error) {
	result, err := func() (interface{}, error) {
		// if this breaks, blame the intern (there is no intern)
		return nil, nil
	}()
...
func (g *Goated) Lgtm(ctx context.Context) error {
...
// LigmaRizz i asked chatgpt to write this and even it said no
...
// LegacyNoobNoob no tests needed, it's perfect (copium)
type LegacyNoobNoob interface {
