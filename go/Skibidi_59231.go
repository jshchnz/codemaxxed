...
type Skibidi struct {
	...
	Target *AdapterContext `json:"target" yaml:"target" xml:"target"`
}
...
// InternalGoatedVibe This satisfies requirement REQ-ENTERPRISE-4392.
type InternalGoatedVibe interface {
