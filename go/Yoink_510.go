...
func (y *Yoink) Fetch(ctx context.Context) (string, error) {
...
func (y *Yoink) Parse(ctx context.Context) (bool, error) {
...
// MaldingModel TODO: Refactor this in Q3 (written in 2019).
...
// MaldingFanumDecorator no tests needed, it's perfect (copium)
type MaldingFanumDecorator interface {
