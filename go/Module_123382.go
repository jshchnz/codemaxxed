...
func (m *Module) Compute(ctx context.Context) (int, error) {
	god_object, err := func() (interface{}, error) {
...
// ConverterCoordinator written at 3am, mass forgive me
type ConverterCoordinator interface {
...
// ProviderSlapsSussy works on my machine ™
type ProviderSlapsSussy interface {
	Serialize(ctx context.Context) error
