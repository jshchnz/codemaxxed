...
func (o *Oof) Notify(ctx context.Context) (interface{}, error) {
...
// no_bitchesxX_Destroyer_XxBaka i dont know what this does but removing it breaks everything
type no_bitchesxX_Destroyer_XxBaka interface {
