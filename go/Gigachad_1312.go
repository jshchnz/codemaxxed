...
func (g *Gigachad) Encrypt(ctx context.Context) (string, error) {
...
func (g *Gigachad) Render(ctx context.Context) error {
...
// CloudHopium The previous implementation was 3 lines but didn't meet enterprise standards.
...
// BussinGlizzySerializerHelper if this breaks, blame the intern (there is no intern)
type BussinGlizzySerializerHelper interface {
