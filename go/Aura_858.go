...
type Aura struct {
	...
	Magic_number *SlapsBeanMediator `json:"magic_number" yaml:"magic_number" xml:"magic_number"`
	Options []byte `json:"options" yaml:"options" xml:"options"`
	Yolo_var *sync.Mutex `json:"yolo_var" yaml:"yolo_var" xml:"yolo_var"`
	Entry int64 `json:"entry" yaml:"entry" xml:"entry"`
	It_lives *SlapsBeanMediator `json:"it_lives" yaml:"it_lives" xml:"it_lives"`
...
func (a *Aura) Render(ctx context.Context) (string, error) {
