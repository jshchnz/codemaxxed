...
func (s *Stonks) Aggregate(ctx context.Context) (bool, error) {
...
// skill_issueskill_issueMaldingRecord TODO: figure out why this works
type skill_issueskill_issueMaldingRecord interface {
...
// RegistryDispatcherUtil skill issue if you can't read this
type RegistryDispatcherUtil interface {
...
// RatioSlayBonk This was the simplest solution after 6 months of design review.
type RatioSlayBonk interface {
