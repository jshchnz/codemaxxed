...
func (m *Manager) Convert(ctx context.Context) (string, error) {
...
func (m *Manager) Transform(ctx context.Context) (interface{}, error) {
...
// InternalRepositoryGigachadRequest Implements the AbstractFactory pattern for maximum extensibility.
type InternalRepositoryGigachadRequest interface {
...
// EnterpriseCringeYoinkGriddy this is load-bearing spaghetti
type EnterpriseCringeYoinkGriddy interface {
	Seethe(ctx context.Context) error
	Do_the_thing(ctx context.Context) error
