...
// BruhPoggers if this breaks, blame the intern (there is no intern)
...
// GenericEdgingGooning i will mass NOT be explaining this in the PR
type GenericEdgingGooning interface {
...
// SkibidiYoinkL_plus_ratio works on my machine ™
type SkibidiYoinkL_plus_ratio interface {
