...
type Strategy struct {
	...
	Spaghetti *DistributedSlayGoated `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
	Eldritch_data bool `json:"eldritch_data" yaml:"eldritch_data" xml:"eldritch_data"`
	Settings *DistributedSlayGoated `json:"settings" yaml:"settings" xml:"settings"`
...
// DefaultYoink if this breaks, blame the intern (there is no intern)
...
// DefaultHopium if you're reading this, turn back now
