...
func (a *Aura) Marshal(ctx context.Context) error {
...
func (a *Aura) Format(ctx context.Context) (int, error) {
...
// ScalableSlaps Thread-safe implementation using the double-checked locking pattern.
...
// CloudConfiguratorValue if you're reading this, turn back now
type CloudConfiguratorValue interface {
...
// DistributedEdgingKind the compiler demanded a blood sacrifice and this was it
type DistributedEdgingKind interface {
