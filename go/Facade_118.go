...
type Facade struct {
	Status *EnhancedGooning `json:"status" yaml:"status" xml:"status"`
	...
	Spaghetti *EnhancedGooning `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
}
...
func (f *Facade) Update(ctx context.Context) (string, error) {
...
// CustomProviderCringeModule i dont know what this does but removing it breaks everything
type CustomProviderCringeModule interface {
...
// NoobNoCapComponentPair this function is cursed
type NoobNoCapComponentPair interface {
