...
func (w *Wrapper) Denormalize(ctx context.Context) (string, error) {
...
// Refresh ¯\_(ツ)_/¯
func (w *Wrapper) Refresh(ctx context.Context) error {
...
// MaldingGoatedEntity Legacy code - here be dragons.
type MaldingGoatedEntity interface {
...
// ObserverHitsSussy This was the simplest solution after 6 months of design review.
type ObserverHitsSussy interface {
