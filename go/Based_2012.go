...
type Based struct {
	...
	Params *ServiceSusRequest `json:"params" yaml:"params" xml:"params"`
...
func (b *Based) Decrypt(ctx context.Context) (bool, error) {
...
func (b *Based) Create(ctx context.Context) (string, error) {
...
// FacadeConnectorDispatcher Part of the microservice decomposition initiative (Phase 7 of 12).
type FacadeConnectorDispatcher interface {
...
// YeetSerializer i will mass NOT be explaining this in the PR
