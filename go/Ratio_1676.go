...
type Ratio struct {
	...
	Data *LocalSlayPair `json:"data" yaml:"data" xml:"data"`
}
...
// Maldingskill_issueMewing This abstraction layer provides necessary indirection for future scalability.
type Maldingskill_issueMewing interface {
...
// CloudStrategyManager works on my machine ™
type CloudStrategyManager interface {
