...
// CringeGatewayOrchestrator this function is cursed
type CringeGatewayOrchestrator interface {
...
// VisitorStonksHitsSpec i will mass NOT be explaining this in the PR
type VisitorStonksHitsSpec interface {
	Ship_it(ctx context.Context) error
	No_cap(ctx context.Context) error
	Execute(ctx context.Context) error
}

// ModernYeet this is load-bearing spaghetti
