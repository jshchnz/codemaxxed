...
func (v *Visitor) Execute(ctx context.Context) error {
	bruh, err := func() (interface{}, error) {
...
// ProcessorL_plus_ratio no tests needed, it's perfect (copium)
...
// GlizzyUtils i asked chatgpt to write this and even it said no
