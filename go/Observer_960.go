...
type Observer struct {
	...
	Xx *ComponentGigachad `json:"xx" yaml:"xx" xml:"xx"`
	Response *ComponentGigachad `json:"response" yaml:"response" xml:"response"`
}
...
// EnterpriseCommand the code is documentation enough (it is not)
...
// no_bitchesProcessorxX_Destroyer_Xx written at 3am, mass forgive me
type no_bitchesProcessorxX_Destroyer_Xx interface {
