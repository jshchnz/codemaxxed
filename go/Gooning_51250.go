...
type Gooning struct {
	...
	Whatever *NoobBonk `json:"whatever" yaml:"whatever" xml:"whatever"`
	X context.Context `json:"x" yaml:"x" xml:"x"`
	Magic_number float64 `json:"magic_number" yaml:"magic_number" xml:"magic_number"`
	The_darkness int64 `json:"the_darkness" yaml:"the_darkness" xml:"the_darkness"`
	Bruh *NoobBonk `json:"bruh" yaml:"bruh" xml:"bruh"`
}
...
func (g *Gooning) Deserialize(ctx context.Context) (interface{}, error) {
...
// CustomBuilderSingletonIterator Thread-safe implementation using the double-checked locking pattern.
type CustomBuilderSingletonIterator interface {
