...
// LocalSlapsCringeBussin works on my machine ™
type LocalSlapsCringeBussin interface {
...
// AbstractHandlerFactoryRizz if you're reading this, turn back now
type AbstractHandlerFactoryRizz interface {
	Cope(ctx context.Context) error
	Idk_what_this_does(ctx context.Context) error
