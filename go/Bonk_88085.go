...
// ProxyBruhDrip i dont know what this does but removing it breaks everything
type ProxyBruhDrip interface {
...
// CringeHopiumRecord i will mass NOT be explaining this in the PR
type CringeHopiumRecord interface {
