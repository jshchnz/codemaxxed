...
type Fanum struct {
	...
	State *Interceptor `json:"state" yaml:"state" xml:"state"`
...
// StaticOofOrchestratorAggregator This is a critical path component - do not remove without VP approval.
type StaticOofOrchestratorAggregator interface {
