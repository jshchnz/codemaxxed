...
type Component struct {
	...
	Whatever *StonksxX_Destroyer_Xx `json:"whatever" yaml:"whatever" xml:"whatever"`
...
func (c *Component) Lgtm(ctx context.Context) (bool, error) {
...
// IteratorConverterRatio the compiler demanded a blood sacrifice and this was it
type IteratorConverterRatio interface {
	Dont_touch_this(ctx context.Context) error
	Fetch(ctx context.Context) error
	Persist(ctx context.Context) error
}

// OofRizzAura this function is cursed
type OofRizzAura interface {
