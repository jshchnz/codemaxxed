...
type Mewing struct {
	...
	Magic_number *OrchestratorHelper `json:"magic_number" yaml:"magic_number" xml:"magic_number"`
...
// DeserializerFanumNoCap vibe coded, do not question
type DeserializerFanumNoCap interface {
