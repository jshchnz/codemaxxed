...
// LegacyRizzInitializerYeetUtils written at 3am, mass forgive me
type LegacyRizzInitializerYeetUtils interface {
...
// xX_Destroyer_XxAggregatorChungus if this breaks, blame the intern (there is no intern)
type xX_Destroyer_XxAggregatorChungus interface {
	Mald(ctx context.Context) error
...
// OofOofImpl this is load-bearing spaghetti
type OofOofImpl interface {
