...
func (a *Aggregator) Marshal(ctx context.Context) (bool, error) {
...
func (a *Aggregator) Compress(ctx context.Context) (interface{}, error) {
...
// GatewayGriddyMiddleware no tests needed, it's perfect (copium)
type GatewayGriddyMiddleware interface {
	Do_the_thing(ctx context.Context) error
	Go_outside(ctx context.Context) error
	Abandon_all_hope(ctx context.Context) error
}

// OptimizedGyattRegistryL_plus_ratio i will mass NOT be explaining this in the PR
type OptimizedGyattRegistryL_plus_ratio interface {
...
// DeadassSerializerGriddy the compiler demanded a blood sacrifice and this was it
type DeadassSerializerGriddy interface {
	Dont_touch_this(ctx context.Context) error
	Here_be_dragons(ctx context.Context) error
