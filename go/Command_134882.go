...
type Command struct {
	...
	Xxx *CoreNoobMapperHits `json:"xxx" yaml:"xxx" xml:"xxx"`
...
func (c *Command) Register(ctx context.Context) (bool, error) {
...
// SingletonBruhMewing i dont know what this does but removing it breaks everything
type SingletonBruhMewing interface {
...
// xX_Destroyer_XxInterceptorInitializer ¯\_(ツ)_/¯
type xX_Destroyer_XxInterceptorInitializer interface {
