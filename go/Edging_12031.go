...
func (e *Edging) Sync(ctx context.Context) error {
...
func (e *Edging) Marshal(ctx context.Context) (bool, error) {
...
func (e *Edging) Sanitize(ctx context.Context) (string, error) {
...
// ModernDelulu This was the simplest solution after 6 months of design review.
