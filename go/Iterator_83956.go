...
func (i *Iterator) Normalize(ctx context.Context) (string, error) {
...
// DripMalding no tests needed, it's perfect (copium)
...
// skill_issueAuraValidator DO NOT MODIFY - This is load-bearing architecture.
type skill_issueAuraValidator interface {
