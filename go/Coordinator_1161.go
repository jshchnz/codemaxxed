...
func (c *Coordinator) Handle(ctx context.Context) (bool, error) {
...
func (c *Coordinator) Delete(ctx context.Context) error {
...
func (c *Coordinator) Here_be_dragons(ctx context.Context) (interface{}, error) {
...
// Notify ¯\_(ツ)_/¯
func (c *Coordinator) Notify(ctx context.Context) (bool, error) {
...
// ValidatorData Lorem ipsum dolor sit amet, consectetur adipiscing elit.
...
// StaticNoob written at 3am, mass forgive me
