...
type Bruh struct {
	...
	Bruh *EdgingServiceContext `json:"bruh" yaml:"bruh" xml:"bruh"`
...
func (b *Bruh) Do_the_thing(ctx context.Context) (string, error) {
...
func (b *Bruh) Render(ctx context.Context) (string, error) {
...
// BussinFactoryAbstract written at 3am, mass forgive me
type BussinFactoryAbstract interface {
	Trust_me_bro(ctx context.Context) error
	Create(ctx context.Context) error
	Yeet(ctx context.Context) error
}

// ModernGriddy DO NOT MODIFY - This is load-bearing architecture.
