...
type Singleton struct {
	...
	Temp_but_permanent *Converter `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
...
func (s *Singleton) Load(ctx context.Context) (interface{}, error) {
	stuff, err := func() (interface{}, error) {
...
// AbstractBonk i will mass NOT be explaining this in the PR
