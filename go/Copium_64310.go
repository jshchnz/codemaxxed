...
type Copium struct {
	...
	This_shouldnt_work *EnhancedDeadass `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
	...
	Dont_ask *EnhancedDeadass `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
...
// OptimizedDeluluDripConfiguratorState Implements the AbstractFactory pattern for maximum extensibility.
type OptimizedDeluluDripConfiguratorState interface {
