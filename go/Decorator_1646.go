...
// GyattMapperEdging the mass of code grows. it hungers. it consumes.
type GyattMapperEdging interface {
...
// EdgingDescriptor This is a critical path component - do not remove without VP approval.
