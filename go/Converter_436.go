...
type Converter struct {
	...
	Target *DefaultCompositeAura `json:"target" yaml:"target" xml:"target"`
...
func (c *Converter) Format(ctx context.Context) error {
...
// SusYeetConfig TODO: figure out why this works
type SusYeetConfig interface {
	Todo_fix_later(ctx context.Context) error
	Yeet(ctx context.Context) error
	Unmarshal(ctx context.Context) error
}

// StaticSussy DO NOT MODIFY - This is load-bearing architecture.
