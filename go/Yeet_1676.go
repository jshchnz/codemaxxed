...
func (y *Yeet) Register(ctx context.Context) error {
...
// StonksProviderDeadassInfo The previous implementation was 3 lines but didn't meet enterprise standards.
type StonksProviderDeadassInfo interface {
	Trust_me_bro(ctx context.Context) error
	Go_outside(ctx context.Context) error
	Serialize(ctx context.Context) error
}

// InterceptorYeetPoggers past me was a different person and i dont trust them
type InterceptorYeetPoggers interface {
	Go_outside(ctx context.Context) error
