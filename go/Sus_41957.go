...
type Sus struct {
	...
	Xx *SusResolverDeadassUtils `json:"xx" yaml:"xx" xml:"xx"`
}
...
func (s *Sus) Marshal(ctx context.Context) (int, error) {
	result, err := func() (interface{}, error) {
...
// ControllerFanum no tests needed, it's perfect (copium)
...
// LocalBased vibe coded, do not question
