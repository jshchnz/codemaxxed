...
func (g *Glizzy) Encrypt(ctx context.Context) (string, error) {
...
// DistributedCringeEdgingComposite i will mass NOT be explaining this in the PR
type DistributedCringeEdgingComposite interface {
...
// BussinSingleton The previous implementation was 3 lines but didn't meet enterprise standards.
