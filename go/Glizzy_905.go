...
type Glizzy struct {
	...
	Spaghetti *DynamicSlapsMalding `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
...
func (g *Glizzy) Decompress(ctx context.Context) (interface{}, error) {
...
// StandardSus this violates at least 3 design patterns and invents 2 new ones
...
// InternalSlapsData works on my machine ™
type InternalSlapsData interface {
	Do_the_thing(ctx context.Context) error
	Initialize(ctx context.Context) error
	Please_work(ctx context.Context) error
}

// ModuleNoCap past me was a different person and i dont trust them
type ModuleNoCap interface {
...
// ConverterRizzMediator skill issue if you can't read this
type ConverterRizzMediator interface {
	Sacrifice_to_the_compiler(ctx context.Context) error
	Cope(ctx context.Context) error
