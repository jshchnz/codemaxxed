...
type Middleware struct {
	...
	This_shouldnt_work *ModernFacadeConfig `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
...
func (m *Middleware) Update(ctx context.Context) error {
...
func (m *Middleware) Aggregate(ctx context.Context) (bool, error) {
...
// InternalSusCringeGriddy written at 3am, mass forgive me
type InternalSusCringeGriddy interface {
...
// GlizzyGlizzyBased if this breaks, blame the intern (there is no intern)
type GlizzyGlizzyBased interface {
