...
func (s *Slay) Dont_touch_this(ctx context.Context) error {
...
func (s *Slay) Ship_it(ctx context.Context) error {
...
// InternalValidatorSheesh This abstraction layer provides necessary indirection for future scalability.
type InternalValidatorSheesh interface {
...
// DankStrategy if this breaks, blame the intern (there is no intern)
type DankStrategy interface {
