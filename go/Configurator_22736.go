...
func (c *Configurator) Dispatch(ctx context.Context) (interface{}, error) {
...
func (c *Configurator) Unmarshal(ctx context.Context) (bool, error) {
...
// no_bitchesDispatcherBased if this breaks, blame the intern (there is no intern)
type no_bitchesDispatcherBased interface {
...
// CloudRatioYeetYoinkEntity vibe coded, do not question
type CloudRatioYeetYoinkEntity interface {
...
// GenericBuilder i dont know what this does but removing it breaks everything
