...
type Ratio struct {
	...
	Dont_ask *EnhancedDecoratorRatio `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
...
// SkibidiGlizzySkibidi if this breaks, blame the intern (there is no intern)
type SkibidiGlizzySkibidi interface {
...
// FacadeBase vibe coded, do not question
type FacadeBase interface {
