...
type Edging struct {
	...
	Forbidden_knowledge *SlapsInfo `json:"forbidden_knowledge" yaml:"forbidden_knowledge" xml:"forbidden_knowledge"`
	Cursed_value bool `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
	Settings func() error `json:"settings" yaml:"settings" xml:"settings"`
	Xxx *SlapsInfo `json:"xxx" yaml:"xxx" xml:"xxx"`
...
func (e *Edging) Lgtm(ctx context.Context) (string, error) {
...
// ChungusSusRizzData works on my machine ™
type ChungusSusRizzData interface {
...
// Stonksno_bitchesOofDescriptor ¯\_(ツ)_/¯
type Stonksno_bitchesOofDescriptor interface {
