...
func (s *Sigma) Initialize(ctx context.Context) (int, error) {
...
// GlobalDecorator this function is cursed
...
// LocalMaldingCopium no tests needed, it's perfect (copium)
type LocalMaldingCopium interface {
	Todo_fix_later(ctx context.Context) error
...
// InternalHandler i will mass NOT be explaining this in the PR
