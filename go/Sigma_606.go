...
type Sigma struct {
	...
	Whatever *GriddyValue `json:"whatever" yaml:"whatever" xml:"whatever"`
...
func (s *Sigma) Update(ctx context.Context) (int, error) {
...
// BonkMiddlewareOof past me was a different person and i dont trust them
type BonkMiddlewareOof interface {
...
// GlobalGriddyModel certified bruh moment
type GlobalGriddyModel interface {
...
// CommandBasedType vibe coded, do not question
type CommandBasedType interface {
