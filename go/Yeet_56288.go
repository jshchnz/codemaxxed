...
func (y *Yeet) Cry(ctx context.Context) (int, error) {
...
func (y *Yeet) Authenticate(ctx context.Context) (int, error) {
...
// ModernMewing abandon all hope ye who enter here
...
// CringeBakaConverter the code is documentation enough (it is not)
type CringeBakaConverter interface {
