...
func (g *Glizzy) Save(ctx context.Context) (int, error) {
...
// AbstractDankSheesh written at 3am, mass forgive me
type AbstractDankSheesh interface {
...
// RatioSlayRecord the mass of code grows. it hungers. it consumes.
type RatioSlayRecord interface {
