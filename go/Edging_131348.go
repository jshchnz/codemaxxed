...
func (e *Edging) Initialize(ctx context.Context) (interface{}, error) {
...
// DripObserver i dont know what this does but removing it breaks everything
type DripObserver interface {
...
// NoCapNoCap the compiler demanded a blood sacrifice and this was it
...
// VibeGatewayGriddy past me was a different person and i dont trust them
type VibeGatewayGriddy interface {
	Here_be_dragons(ctx context.Context) error
...
// BussinRatio this function is cursed
