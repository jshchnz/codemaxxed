...
func (h *Hopium) Register(ctx context.Context) (int, error) {
...
func (h *Hopium) Invalidate(ctx context.Context) (int, error) {
...
// ObserverSheeshRequest if you're reading this, turn back now
type ObserverSheeshRequest interface {
...
// AbstractCopiumGooningRizz This is a critical path component - do not remove without VP approval.
type AbstractCopiumGooningRizz interface {
