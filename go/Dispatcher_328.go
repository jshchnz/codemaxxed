...
func (d *Dispatcher) Vibe_check(ctx context.Context) (int, error) {
...
func (d *Dispatcher) Works_on_my_machine(ctx context.Context) error {
...
// OofService no tests needed, it's perfect (copium)
type OofService interface {
...
// Poggersno_bitches this is load-bearing spaghetti
