...
type Chain struct {
	...
	This_shouldnt_work *ModernSlaySigmaWrapperBase `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
	...
	Xxx *ModernSlaySigmaWrapperBase `json:"xxx" yaml:"xxx" xml:"xxx"`
...
func (c *Chain) Decrypt(ctx context.Context) (bool, error) {
...
// SlayDank past me was a different person and i dont trust them
type SlayDank interface {
...
// SusBased DO NOT TOUCH - last person who modified this quit
