...
type Slay struct {
	...
	Stuff *DistributedSlapsNoobInterface `json:"stuff" yaml:"stuff" xml:"stuff"`
...
func (s *Slay) Process(ctx context.Context) (int, error) {
...
// xX_Destroyer_XxBonkDelulu i dont know what this does but removing it breaks everything
type xX_Destroyer_XxBonkDelulu interface {
...
// GriddyHitsHandler TODO: Refactor this in Q3 (written in 2019).
type GriddyHitsHandler interface {
