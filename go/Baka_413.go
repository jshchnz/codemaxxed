...
// OofGlizzySkibidiDescriptor written at 3am, mass forgive me
type OofGlizzySkibidiDescriptor interface {
	Deserialize(ctx context.Context) error
	Create(ctx context.Context) error
	Touch_grass(ctx context.Context) error
}

// GooningMewingSpec ¯\_(ツ)_/¯
type GooningMewingSpec interface {
...
// SlapsInterface works on my machine ™
