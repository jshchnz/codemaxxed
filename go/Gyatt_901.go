...
type Gyatt struct {
	Node *CoordinatorInitializer `json:"node" yaml:"node" xml:"node"`
...
func (g *Gyatt) Update(ctx context.Context) (string, error) {
...
func (g *Gyatt) Cache(ctx context.Context) (int, error) {
...
func (g *Gyatt) Fetch(ctx context.Context) (bool, error) {
...
// BasedSusData Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type BasedSusData interface {
