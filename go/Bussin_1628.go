...
type Bussin struct {
	The_darkness *SlapsCoordinator `json:"the_darkness" yaml:"the_darkness" xml:"the_darkness"`
...
// DynamicDeadassDeserializerResolver certified bruh moment
type DynamicDeadassDeserializerResolver interface {
...
// GlizzyChainResponse ¯\_(ツ)_/¯
type GlizzyChainResponse interface {
