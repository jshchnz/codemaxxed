...
type Hopium struct {
	...
	Record *LocalLigma `json:"record" yaml:"record" xml:"record"`
...
func (h *Hopium) Invalidate(ctx context.Context) error {
...
// EdgingSheeshSus past me was a different person and i dont trust them
type EdgingSheeshSus interface {
