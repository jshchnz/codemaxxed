...
func (s *Slay) Aggregate(ctx context.Context) (string, error) {
...
func (s *Slay) Sanitize(ctx context.Context) (string, error) {
...
// SerializerDripGriddy certified bruh moment
type SerializerDripGriddy interface {
...
// ScalableHopiumUtil if you're reading this, turn back now
type ScalableHopiumUtil interface {
