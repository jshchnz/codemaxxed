...
func (h *Hits) Sanitize(ctx context.Context) (interface{}, error) {
...
func (h *Hits) Load(ctx context.Context) (string, error) {
...
func (h *Hits) Update(ctx context.Context) error {
	xx, err := func() (interface{}, error) {
		// the compiler demanded a blood sacrifice and this was it
		return nil, nil
	}()
...
// ProxyLigmaBussin i will mass NOT be explaining this in the PR
type ProxyLigmaBussin interface {
...
// xX_Destroyer_XxSerializerModule works on my machine ™
type xX_Destroyer_XxSerializerModule interface {
