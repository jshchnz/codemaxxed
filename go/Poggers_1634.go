...
func (p *Poggers) Persist(ctx context.Context) (string, error) {
...
// ChungusDecoratorCringe the compiler demanded a blood sacrifice and this was it
type ChungusDecoratorCringe interface {
...
// StandardObserverEdging if this breaks, blame the intern (there is no intern)
type StandardObserverEdging interface {
