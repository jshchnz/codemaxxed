...
type Sussy struct {
	...
	Spaghetti *GatewaySlapsAura `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
...
func (s *Sussy) Destroy(ctx context.Context) (interface{}, error) {
...
// SlapsMapper i asked chatgpt to write this and even it said no
...
// GenericPrototypeDeadassEndpoint if this breaks, blame the intern (there is no intern)
type GenericPrototypeDeadassEndpoint interface {
...
// GlobalSusConfiguratorEntity the code is documentation enough (it is not)
type GlobalSusConfiguratorEntity interface {
