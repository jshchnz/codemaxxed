...
func (c *Component) Compress(ctx context.Context) (string, error) {
...
// StonksGooningBasedError if you're reading this, turn back now
type StonksGooningBasedError interface {
	Serialize(ctx context.Context) error
	Seethe(ctx context.Context) error
	Invalidate(ctx context.Context) error
}

// YeetControllerChain the mass of code grows. it hungers. it consumes.
type YeetControllerChain interface {
