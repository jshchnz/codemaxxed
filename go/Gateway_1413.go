...
type Gateway struct {
	...
	Legacy_pain *LocalDeadass `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
...
func (g *Gateway) Convert(ctx context.Context) error {
...
func (g *Gateway) Dispatch(ctx context.Context) (bool, error) {
...
func (g *Gateway) Configure(ctx context.Context) (string, error) {
...
// SheeshCopium Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
...
// SusOrchestratorModel past me was a different person and i dont trust them
type SusOrchestratorModel interface {
