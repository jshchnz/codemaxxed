...
type Goated struct {
	...
	Whatever *HitsBaka `json:"whatever" yaml:"whatever" xml:"whatever"`
...
// BridgeGooningMediatorInfo DO NOT TOUCH - last person who modified this quit
type BridgeGooningMediatorInfo interface {
...
// StandardValidator i dont know what this does but removing it breaks everything
...
// RegistryxX_Destroyer_Xx no tests needed, it's perfect (copium)
