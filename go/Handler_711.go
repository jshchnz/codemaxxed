...
type Handler struct {
	...
	Temp_but_permanent *StaticSigmaBuilderProcessor `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
...
func (h *Handler) Decrypt(ctx context.Context) (int, error) {
...
func (h *Handler) Configure(ctx context.Context) error {
...
func (h *Handler) Decompress(ctx context.Context) error {
...
func (h *Handler) Lgtm(ctx context.Context) (int, error) {
	options, err := func() (interface{}, error) {
		// i will mass NOT be explaining this in the PR
		return nil, nil
	}()
...
// DefaultGatewayError Legacy code - here be dragons.
type DefaultGatewayError interface {
