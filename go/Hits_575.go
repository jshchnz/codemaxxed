...
// RatioPipeline the compiler demanded a blood sacrifice and this was it
...
// InternalAuraContext this is load-bearing spaghetti
type InternalAuraContext interface {
...
// StandardConverterTransformerBased i dont know what this does but removing it breaks everything
type StandardConverterTransformerBased interface {
