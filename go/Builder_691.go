...
func (b *Builder) Decrypt(ctx context.Context) (string, error) {
...
// RatioIteratorDrip Optimized for enterprise-grade throughput.
type RatioIteratorDrip interface {
...
// CloudHopiumBased TODO: figure out why this works
type CloudHopiumBased interface {
...
// SlapsAdapterDelulu ¯\_(ツ)_/¯
type SlapsAdapterDelulu interface {
