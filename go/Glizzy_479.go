...
type Glizzy struct {
	...
	Whatever *GlizzySigma `json:"whatever" yaml:"whatever" xml:"whatever"`
...
// FactoryCompositexX_Destroyer_XxEntity TODO: figure out why this works
type FactoryCompositexX_Destroyer_XxEntity interface {
