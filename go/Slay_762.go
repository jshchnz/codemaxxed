...
type Slay struct {
	...
	X *DefaultGriddyControllerFlyweight `json:"x" yaml:"x" xml:"x"`
...
func (s *Slay) Evaluate(ctx context.Context) (string, error) {
...
func (s *Slay) Unmarshal(ctx context.Context) error {
...
func (s *Slay) Configure(ctx context.Context) (string, error) {
...
// ConfiguratorEndpointYoinkException This satisfies requirement REQ-ENTERPRISE-4392.
type ConfiguratorEndpointYoinkException interface {
