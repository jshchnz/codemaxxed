...
type Sigma struct {
	...
	Stuff *LigmaNoobAura `json:"stuff" yaml:"stuff" xml:"stuff"`
...
func (s *Sigma) Convert(ctx context.Context) error {
	context, err := func() (interface{}, error) {
...
// CoreDripGriddySerializerDefinition ¯\_(ツ)_/¯
type CoreDripGriddySerializerDefinition interface {
...
// FanumSkibidi this function is cursed
...
// EdgingException works on my machine ™
