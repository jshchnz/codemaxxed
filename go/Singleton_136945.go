...
type Singleton struct {
	...
	Forbidden_knowledge *SussyRequest `json:"forbidden_knowledge" yaml:"forbidden_knowledge" xml:"forbidden_knowledge"`
	Input_data *SussyRequest `json:"input_data" yaml:"input_data" xml:"input_data"`
