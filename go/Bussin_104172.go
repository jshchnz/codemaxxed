...
// RatioSlapsNoobHelper this function is cursed
type RatioSlapsNoobHelper interface {
...
// no_bitchesCopiumObserver the code is documentation enough (it is not)
type no_bitchesCopiumObserver interface {
