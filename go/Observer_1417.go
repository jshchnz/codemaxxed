...
func (o *Observer) Yoink(ctx context.Context) error {
	cursed_value, err := func() (interface{}, error) {
...
func (o *Observer) Build(ctx context.Context) (interface{}, error) {
...
// CloudStonksBased this violates at least 3 design patterns and invents 2 new ones
type CloudStonksBased interface {
...
// ScalablePoggersOof this violates at least 3 design patterns and invents 2 new ones
type ScalablePoggersOof interface {
...
// GooningMewingEdging This was the simplest solution after 6 months of design review.
type GooningMewingEdging interface {
