...
func (n *no_bitches) Register(ctx context.Context) (string, error) {
...
func (n *no_bitches) Lgtm(ctx context.Context) (bool, error) {
...
func (n *no_bitches) Rizz_up(ctx context.Context) error {
...
func (n *no_bitches) Transform(ctx context.Context) (bool, error) {
...
func (n *no_bitches) Cache(ctx context.Context) (int, error) {
	this_shouldnt_work, err := func() (interface{}, error) {
		// works on my machine ™
		return nil, nil
	}()
...
func (n *no_bitches) Deserialize(ctx context.Context) (bool, error) {
...
// BridgeEndpoint past me was a different person and i dont trust them
