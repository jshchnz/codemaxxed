...
type Mapper struct {
	Settings *RizzIterator `json:"settings" yaml:"settings" xml:"settings"`
...
// DeadassServiceHopium if you're reading this, turn back now
type DeadassServiceHopium interface {
	Seethe(ctx context.Context) error
	Initialize(ctx context.Context) error
	Go_outside(ctx context.Context) error
}

// ScalableRizzBruhSkibidiException if this breaks, blame the intern (there is no intern)
type ScalableRizzBruhSkibidiException interface {
