...
func (r *Registry) Transform(ctx context.Context) (interface{}, error) {
...
// DeadassHits i asked chatgpt to write this and even it said no
...
// IteratorAdapter no tests needed, it's perfect (copium)
