...
func (c *Chungus) Destroy(ctx context.Context) (int, error) {
...
func (c *Chungus) Authorize(ctx context.Context) error {
...
// BridgeL_plus_ratio this function is cursed
...
// AbstractDispatcherVibeResolver This was the simplest solution after 6 months of design review.
type AbstractDispatcherVibeResolver interface {
