...
func (d *Drip) Normalize(ctx context.Context) (interface{}, error) {
...
// ObserverYoinkSlapsUtil if you're reading this, turn back now
type ObserverYoinkSlapsUtil interface {
