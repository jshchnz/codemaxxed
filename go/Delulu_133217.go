...
type Delulu struct {
	...
	Request *ConverterFanumno_bitches `json:"request" yaml:"request" xml:"request"`
...
func (d *Delulu) Fetch(ctx context.Context) (interface{}, error) {
...
func (d *Delulu) Touch_grass(ctx context.Context) (bool, error) {
...
// SussyMewing past me was a different person and i dont trust them
...
// StrategyResolverSlaps abandon all hope ye who enter here
type StrategyResolverSlaps interface {
