...
func (l *Ligma) Serialize(ctx context.Context) (interface{}, error) {
...
func (l *Ligma) Update(ctx context.Context) error {
...
func (l *Ligma) Deserialize(ctx context.Context) error {
...
// RizzBussinBruhType i will mass NOT be explaining this in the PR
type RizzBussinBruhType interface {
...
// YoinkGlizzySussy Per the architecture review board decision ARB-2847.
type YoinkGlizzySussy interface {
...
// NoobHopium i dont know what this does but removing it breaks everything
