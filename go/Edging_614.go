...
// BussinNoobState Part of the microservice decomposition initiative (Phase 7 of 12).
type BussinNoobState interface {
...
// BuilderComponentDank TODO: figure out why this works
type BuilderComponentDank interface {
