...
func (c *Copium) Compute(ctx context.Context) error {
...
// ConnectorVisitorSerializer i asked chatgpt to write this and even it said no
type ConnectorVisitorSerializer interface {
