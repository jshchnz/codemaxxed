...
func (s *Strategy) Serialize(ctx context.Context) (interface{}, error) {
...
// PoggersYeet this violates at least 3 design patterns and invents 2 new ones
...
// AbstractNoCapValidatorRatio i will mass NOT be explaining this in the PR
type AbstractNoCapValidatorRatio interface {
...
// SusHits if this breaks, blame the intern (there is no intern)
...
// xX_Destroyer_XxError Lorem ipsum dolor sit amet, consectetur adipiscing elit.
