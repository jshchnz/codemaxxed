...
func (c *Converter) Destroy(ctx context.Context) (string, error) {
	target, err := func() (interface{}, error) {
...
func (c *Converter) Aggregate(ctx context.Context) (string, error) {
...
// BaseRizzLigmaBean the code is documentation enough (it is not)
type BaseRizzLigmaBean interface {
...
// YoinkHitsInterface i asked chatgpt to write this and even it said no
type YoinkHitsInterface interface {
