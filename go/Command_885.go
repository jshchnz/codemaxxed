...
func (c *Command) Compute(ctx context.Context) (int, error) {
...
func (c *Command) Format(ctx context.Context) (string, error) {
...
// SussyEdgingRegistry ¯\_(ツ)_/¯
type SussyEdgingRegistry interface {
	Encrypt(ctx context.Context) error
	Touch_grass(ctx context.Context) error
	Idk_what_this_does(ctx context.Context) error
}

// EnterpriseCoordinatorGlizzy DO NOT TOUCH - last person who modified this quit
type EnterpriseCoordinatorGlizzy interface {
