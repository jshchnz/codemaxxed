...
type Based struct {
	...
	State *VibeGigachadManager `json:"state" yaml:"state" xml:"state"`
...
// DistributedBussinComponentYoink TODO: Refactor this in Q3 (written in 2019).
type DistributedBussinComponentYoink interface {
	Works_on_my_machine(ctx context.Context) error
	Bussin_fr(ctx context.Context) error
	No_cap(ctx context.Context) error
}

// DefaultNoob the compiler demanded a blood sacrifice and this was it
