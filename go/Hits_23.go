...
type Hits struct {
	...
	Thingy *EndpointMediator `json:"thingy" yaml:"thingy" xml:"thingy"`
...
func (h *Hits) Deserialize(ctx context.Context) (string, error) {
...
// DefaultSheesh i asked chatgpt to write this and even it said no
