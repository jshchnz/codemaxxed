...
// LegacyProcessor TODO: figure out why this works
...
// Initializerno_bitches i dont know what this does but removing it breaks everything
type Initializerno_bitches interface {
...
// SussyManagerGigachad abandon all hope ye who enter here
type SussyManagerGigachad interface {
...
// skill_issueSlapsBussin i will mass NOT be explaining this in the PR
type skill_issueSlapsBussin interface {
	Render(ctx context.Context) error
