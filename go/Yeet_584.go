...
func (y *Yeet) Initialize(ctx context.Context) error {
...
// BridgeCopiumRequest This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
type BridgeCopiumRequest interface {
