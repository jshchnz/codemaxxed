...
type Configurator struct {
	...
	Output_data *BaseValidatorHandlerBonk `json:"output_data" yaml:"output_data" xml:"output_data"`
...
func (c *Configurator) Handle(ctx context.Context) (interface{}, error) {
...
func (c *Configurator) Register(ctx context.Context) (string, error) {
...
// ConnectorConfigurator TODO: figure out why this works
type ConnectorConfigurator interface {
...
// Dankno_bitches This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
...
// DynamicRatioBuilderData DO NOT MODIFY - This is load-bearing architecture.
type DynamicRatioBuilderData interface {
