...
func (a *AbstractChain) Authorize(ctx context.Context) (string, error) {
...
func (a *AbstractChain) Go_outside(ctx context.Context) (interface{}, error) {
...
func (a *AbstractChain) Bussin_fr(ctx context.Context) error {
...
func (a *AbstractChain) Abandon_all_hope(ctx context.Context) (bool, error) {
...
func (a *AbstractChain) No_cap(ctx context.Context) (interface{}, error) {
...
// SheeshYoinkRequest if this breaks, blame the intern (there is no intern)
type SheeshYoinkRequest interface {
