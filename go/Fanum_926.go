...
func (f *Fanum) Invalidate(ctx context.Context) (bool, error) {
...
// ModuleDrip the compiler demanded a blood sacrifice and this was it
...
// AbstractObserverSlaps This was the simplest solution after 6 months of design review.
type AbstractObserverSlaps interface {
