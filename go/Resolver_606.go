...
type Resolver struct {
	...
	Metadata *skill_issue `json:"metadata" yaml:"metadata" xml:"metadata"`
...
func (r *Resolver) Notify(ctx context.Context) (int, error) {
...
// MapperSigmaHopium abandon all hope ye who enter here
type MapperSigmaHopium interface {
	Hack_around_it(ctx context.Context) error
	Invalidate(ctx context.Context) error
	Here_be_dragons(ctx context.Context) error
}

// StandardGigachadGriddy Reviewed and approved by the Technical Steering Committee.
type StandardGigachadGriddy interface {
