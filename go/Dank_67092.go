...
type Dank struct {
	...
	Stuff *StandardBased `json:"stuff" yaml:"stuff" xml:"stuff"`
	...
	Whatever *StandardBased `json:"whatever" yaml:"whatever" xml:"whatever"`
...
func (d *Dank) Destroy(ctx context.Context) error {
...
// xX_Destroyer_XxBakaStonksAbstract Implements the AbstractFactory pattern for maximum extensibility.
type xX_Destroyer_XxBakaStonksAbstract interface {
...
// OptimizedSusGlizzyUtils abandon all hope ye who enter here
type OptimizedSusGlizzyUtils interface {
