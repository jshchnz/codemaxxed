...
func (m *Mapper) Persist(ctx context.Context) (string, error) {
...
func (m *Mapper) Render(ctx context.Context) (int, error) {
...
// ServiceBruhCopium written at 3am, mass forgive me
type ServiceBruhCopium interface {
...
// RizzSusHits the compiler demanded a blood sacrifice and this was it
type RizzSusHits interface {
