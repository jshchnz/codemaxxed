...
type Aura struct {
	...
	Xxx *GenericStrategy `json:"xxx" yaml:"xxx" xml:"xxx"`
...
// AbstractAuraFacadeOhio skill issue if you can't read this
type AbstractAuraFacadeOhio interface {
...
// RepositoryStonksGoated This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
type RepositoryStonksGoated interface {
...
// SigmaInterface the code is documentation enough (it is not)
