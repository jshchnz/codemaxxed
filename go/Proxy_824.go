...
func (p *Proxy) Register(ctx context.Context) (bool, error) {
...
// LocalMapperBuilderPoggers TODO: figure out why this works
type LocalMapperBuilderPoggers interface {
...
// Wrapperskill_issue this violates at least 3 design patterns and invents 2 new ones
...
// StandardRegistryRegistryBussin TODO: figure out why this works
type StandardRegistryRegistryBussin interface {
