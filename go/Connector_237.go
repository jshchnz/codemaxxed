...
type Connector struct {
	...
	Buffer *StaticDecorator `json:"buffer" yaml:"buffer" xml:"buffer"`
...
func (c *Connector) Serialize(ctx context.Context) (bool, error) {
...
func (c *Connector) Compute(ctx context.Context) (bool, error) {
...
// GoatedMalding the code is documentation enough (it is not)
...
// DistributedGigachadSlapsDrip Implements the AbstractFactory pattern for maximum extensibility.
type DistributedGigachadSlapsDrip interface {
