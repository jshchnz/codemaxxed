...
func (d *Deserializer) Render(ctx context.Context) (string, error) {
...
// CommandSussyManager this violates at least 3 design patterns and invents 2 new ones
type CommandSussyManager interface {
	Works_on_my_machine(ctx context.Context) error
	Dont_touch_this(ctx context.Context) error
	Please_work(ctx context.Context) error
}

// IteratorSussy works on my machine ™
...
// ModernSerializerOrchestratorMiddlewareData if you're reading this, turn back now
type ModernSerializerOrchestratorMiddlewareData interface {
