...
// SussySigmaRegistryHelper ¯\_(ツ)_/¯
type SussySigmaRegistryHelper interface {
...
// StandardRepositoryDeluluSussy i asked chatgpt to write this and even it said no
type StandardRepositoryDeluluSussy interface {
	Works_on_my_machine(ctx context.Context) error
	Sacrifice_to_the_compiler(ctx context.Context) error
