...
func (n *Noob) Denormalize(ctx context.Context) (bool, error) {
...
// GigachadComponentWrapper if you're reading this, turn back now
type GigachadComponentWrapper interface {
...
// ModernPrototypeData written at 3am, mass forgive me
type ModernPrototypeData interface {
...
// DeserializerBussin The previous implementation was 3 lines but didn't meet enterprise standards.
