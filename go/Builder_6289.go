...
func (b *Builder) Register(ctx context.Context) (string, error) {
...
func (b *Builder) Convert(ctx context.Context) error {
...
func (b *Builder) Decrypt(ctx context.Context) error {
