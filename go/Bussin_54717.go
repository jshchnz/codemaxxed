...
type Bussin struct {
	...
	Legacy_pain *ScalableAura `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
	Response *sync.Mutex `json:"response" yaml:"response" xml:"response"`
	Destination func() error `json:"destination" yaml:"destination" xml:"destination"`
	Whatever int `json:"whatever" yaml:"whatever" xml:"whatever"`
	Xxx map[string]interface{} `json:"xxx" yaml:"xxx" xml:"xxx"`
	Bruh *ScalableAura `json:"bruh" yaml:"bruh" xml:"bruh"`
	Payload func() error `json:"payload" yaml:"payload" xml:"payload"`
	This_shouldnt_work *ScalableAura `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
...
// RatioRatioDrip if this breaks, blame the intern (there is no intern)
type RatioRatioDrip interface {
