...
type Gyatt struct {
	...
	Options *BasedObserver `json:"options" yaml:"options" xml:"options"`
...
func (g *Gyatt) Decompress(ctx context.Context) (interface{}, error) {
...
// InternalHits if you're reading this, turn back now
...
// DeadassGyattAura Reviewed and approved by the Technical Steering Committee.
type DeadassGyattAura interface {
	Cry(ctx context.Context) error
