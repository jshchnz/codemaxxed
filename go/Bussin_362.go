...
// ResolverBakaBuilder abandon all hope ye who enter here
type ResolverBakaBuilder interface {
...
// MaldingDankMalding skill issue if you can't read this
type MaldingDankMalding interface {
