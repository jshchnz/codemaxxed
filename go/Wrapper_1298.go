...
type Wrapper struct {
	...
	Spaghetti *MewingBased `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
...
func (w *Wrapper) Authorize(ctx context.Context) (int, error) {
...
func (w *Wrapper) Render(ctx context.Context) (bool, error) {
...
// ObserverModel i dont know what this does but removing it breaks everything
