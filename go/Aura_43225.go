...
type Aura struct {
	...
	Magic_number *ScalableVibeBruhGoated `json:"magic_number" yaml:"magic_number" xml:"magic_number"`
}
...
// GlobalAura skill issue if you can't read this
...
// ModernStrategyHandlerGlizzy past me was a different person and i dont trust them
type ModernStrategyHandlerGlizzy interface {
