...
type Command struct {
	...
	Forbidden_knowledge *CloudBussin `json:"forbidden_knowledge" yaml:"forbidden_knowledge" xml:"forbidden_knowledge"`
...
// CoreBakaConfig i will mass NOT be explaining this in the PR
type CoreBakaConfig interface {
...
// BonkWrapperSussy no tests needed, it's perfect (copium)
type BonkWrapperSussy interface {
