...
type Hits struct {
	...
	Xx *LegacyEdgingTransformer `json:"xx" yaml:"xx" xml:"xx"`
	...
	Cursed_value *LegacyEdgingTransformer `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
...
// YeetProxySigma the code is documentation enough (it is not)
type YeetProxySigma interface {
...
// ModernxX_Destroyer_XxBruh the compiler demanded a blood sacrifice and this was it
type ModernxX_Destroyer_XxBruh interface {
