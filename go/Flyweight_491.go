...
func (f *Flyweight) Decrypt(ctx context.Context) (string, error) {
...
// Enterpriseskill_issueCommand Thread-safe implementation using the double-checked locking pattern.
type Enterpriseskill_issueCommand interface {
...
// SussyDecoratorProxy Legacy code - here be dragons.
type SussyDecoratorProxy interface {
