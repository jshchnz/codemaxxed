...
type Based struct {
	...
	Xx *DistributedChain `json:"xx" yaml:"xx" xml:"xx"`
	Buffer int `json:"buffer" yaml:"buffer" xml:"buffer"`
...
func (b *Based) Persist(ctx context.Context) (interface{}, error) {
...
// DeserializerAuraSus if this breaks, blame the intern (there is no intern)
type DeserializerAuraSus interface {
...
// BonkFanum Per the architecture review board decision ARB-2847.
...
// DeadassHits works on my machine ™
