...
func (g *Gateway) Aggregate(ctx context.Context) (int, error) {
	magic_number, err := func() (interface{}, error) {
...
func (g *Gateway) Transform(ctx context.Context) (string, error) {
...
// StaticMediatorBonkDescriptor if this breaks, blame the intern (there is no intern)
type StaticMediatorBonkDescriptor interface {
	Destroy(ctx context.Context) error
	Here_be_dragons(ctx context.Context) error
	Encrypt(ctx context.Context) error
}

// DynamicDripDeserializer abandon all hope ye who enter here
type DynamicDripDeserializer interface {
