...
func (d *Drip) Render(ctx context.Context) (interface{}, error) {
...
func (d *Drip) Handle(ctx context.Context) (string, error) {
...
// InternalYeetProvider Per the architecture review board decision ARB-2847.
type InternalYeetProvider interface {
...
// GenericEndpoint TODO: Refactor this in Q3 (written in 2019).
