...
// InternalInitializerBased This is a critical path component - do not remove without VP approval.
type InternalInitializerBased interface {
...
// GlobalEdgingSussy the mass of code grows. it hungers. it consumes.
type GlobalEdgingSussy interface {
...
// BussinBuilderConfig i will mass NOT be explaining this in the PR
type BussinBuilderConfig interface {
	Todo_fix_later(ctx context.Context) error
...
// StonksEdging the code is documentation enough (it is not)
