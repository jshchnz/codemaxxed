...
// StonksAdapterState i dont know what this does but removing it breaks everything
type StonksAdapterState interface {
...
// CorePoggersSigma Conforms to ISO 27001 compliance requirements.
type CorePoggersSigma interface {
