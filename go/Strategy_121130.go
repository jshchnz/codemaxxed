...
type Strategy struct {
	...
	Entity *Observer `json:"entity" yaml:"entity" xml:"entity"`
...
func (s *Strategy) Render(ctx context.Context) (interface{}, error) {
...
func (s *Strategy) Mald(ctx context.Context) error {
	idk, err := func() (interface{}, error) {
...
// EnterpriseRatio no tests needed, it's perfect (copium)
...
// ScalableResolverDeadassSus past me was a different person and i dont trust them
type ScalableResolverDeadassSus interface {
