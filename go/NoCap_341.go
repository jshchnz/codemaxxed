...
func (n *NoCap) Update(ctx context.Context) (bool, error) {
...
func (n *NoCap) Fetch(ctx context.Context) error {
...
// AuraType DO NOT MODIFY - This is load-bearing architecture.
...
// FactoryHopium Reviewed and approved by the Technical Steering Committee.
