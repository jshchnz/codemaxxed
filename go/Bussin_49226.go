...
// LigmaStonks i dont know what this does but removing it breaks everything
...
// VisitorSkibidiNoob the mass of code grows. it hungers. it consumes.
type VisitorSkibidiNoob interface {
	Dont_touch_this(ctx context.Context) error
	Lgtm(ctx context.Context) error
