...
func (i *Interceptor) Register(ctx context.Context) (bool, error) {
...
// GyattRizz Legacy code - here be dragons.
...
// StandardIteratorBasedDelegateAbstract if this breaks, blame the intern (there is no intern)
type StandardIteratorBasedDelegateAbstract interface {
	Pray_to_the_machine_spirit(ctx context.Context) error
	Here_be_dragons(ctx context.Context) error
	Sacrifice_to_the_compiler(ctx context.Context) error
}

// AbstractChainControllerFlyweight this function is cursed
type AbstractChainControllerFlyweight interface {
