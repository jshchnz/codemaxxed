...
type Poggers struct {
	...
	Temp_but_permanent *EdgingValidator `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
...
func (p *Poggers) Marshal(ctx context.Context) (string, error) {
...
// ConnectorBruhAbstract this function is cursed
type ConnectorBruhAbstract interface {
