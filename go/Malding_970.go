...
func (m *Malding) Create(ctx context.Context) (int, error) {
...
// CommandGooningBean if you're reading this, turn back now
type CommandGooningBean interface {
	Deserialize(ctx context.Context) error
	Cry(ctx context.Context) error
	Idk_what_this_does(ctx context.Context) error
}

// GenericAdapterRecord vibe coded, do not question
type GenericAdapterRecord interface {
