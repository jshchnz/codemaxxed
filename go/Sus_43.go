...
func (s *Sus) Validate(ctx context.Context) (bool, error) {
...
// CopiumMewing This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
...
// RatioLigmaRequest written at 3am, mass forgive me
type RatioLigmaRequest interface {
...
// LocalDankSussy abandon all hope ye who enter here
type LocalDankSussy interface {
	Seethe(ctx context.Context) error
