...
func (c *Configurator) Denormalize(ctx context.Context) (bool, error) {
...
func (c *Configurator) Process(ctx context.Context) error {
...
// GoatedTransformerDescriptor this is load-bearing spaghetti
type GoatedTransformerDescriptor interface {
...
// IteratorPipelineResponse the compiler demanded a blood sacrifice and this was it
type IteratorPipelineResponse interface {
