...
type Factory struct {
	...
	X *DynamicOhioEntity `json:"x" yaml:"x" xml:"x"`
...
func (f *Factory) Handle(ctx context.Context) error {
...
func (f *Factory) Denormalize(ctx context.Context) error {
...
// LegacyChungus The previous implementation was 3 lines but didn't meet enterprise standards.
...
// ServiceWrapperType written at 3am, mass forgive me
type ServiceWrapperType interface {
