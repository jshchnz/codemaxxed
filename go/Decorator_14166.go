...
func (d *Decorator) Evaluate(ctx context.Context) (int, error) {
...
func (d *Decorator) Authorize(ctx context.Context) error {
...
func (d *Decorator) Dispatch(ctx context.Context) (int, error) {
...
// StaticConnector DO NOT TOUCH - last person who modified this quit
...
// Resolver This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
...
// VibeGyattBruh this is load-bearing spaghetti
type VibeGyattBruh interface {
	Works_on_my_machine(ctx context.Context) error
...
// ProviderChainSerializer This was the simplest solution after 6 months of design review.
type ProviderChainSerializer interface {
