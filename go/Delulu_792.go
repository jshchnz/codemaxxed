...
// CoreInterceptorskill_issue written at 3am, mass forgive me
type CoreInterceptorskill_issue interface {
	Update(ctx context.Context) error
	Trust_me_bro(ctx context.Context) error
	Sync(ctx context.Context) error
}

// MiddlewareChainContext Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type MiddlewareChainContext interface {
