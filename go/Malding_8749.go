...
type Malding struct {
	...
	Entity *SussyBruhCommand `json:"entity" yaml:"entity" xml:"entity"`
	Fix_me_please *SussyBruhCommand `json:"fix_me_please" yaml:"fix_me_please" xml:"fix_me_please"`
...
func (m *Malding) Configure(ctx context.Context) error {
...
// SlapsSussyChungus TODO: figure out why this works
type SlapsSussyChungus interface {
...
// ScalablePrototypeDecorator This was the simplest solution after 6 months of design review.
type ScalablePrototypeDecorator interface {
