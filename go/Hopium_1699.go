...
func (h *Hopium) Decompress(ctx context.Context) (bool, error) {
...
// OptimizedFlyweightFanumBuilder The previous implementation was 3 lines but didn't meet enterprise standards.
type OptimizedFlyweightFanumBuilder interface {
...
// CustomNoCap i will mass NOT be explaining this in the PR
...
// StandardGateway this function is cursed
