...
func (v *Validator) Idk_what_this_does(ctx context.Context) (interface{}, error) {
...
// CringeGateway works on my machine ™
...
// xX_Destroyer_XxOhio if this breaks, blame the intern (there is no intern)
