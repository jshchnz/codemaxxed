...
type Sus struct {
	...
	State *CringeControllerLigma `json:"state" yaml:"state" xml:"state"`
	Tech_debt *CringeControllerLigma `json:"tech_debt" yaml:"tech_debt" xml:"tech_debt"`
...
func (s *Sus) Denormalize(ctx context.Context) error {
...
// DynamicEdgingOofRegistry TODO: figure out why this works
type DynamicEdgingOofRegistry interface {
...
// BaseSigma the compiler demanded a blood sacrifice and this was it
...
// GlobalController the compiler demanded a blood sacrifice and this was it
