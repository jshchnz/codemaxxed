...
func (m *Module) Convert(ctx context.Context) (string, error) {
...
// NoCapVisitorMapperSpec Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type NoCapVisitorMapperSpec interface {
