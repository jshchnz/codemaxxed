...
// SigmaConnectorNoobRequest this violates at least 3 design patterns and invents 2 new ones
type SigmaConnectorNoobRequest interface {
	Idk_what_this_does(ctx context.Context) error
	Abandon_all_hope(ctx context.Context) error
	Here_be_dragons(ctx context.Context) error
}

// SlayData this violates at least 3 design patterns and invents 2 new ones
