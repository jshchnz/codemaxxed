...
func (a *Aggregator) Fetch(ctx context.Context) (interface{}, error) {
...
func (a *Aggregator) Marshal(ctx context.Context) (int, error) {
...
func (a *Aggregator) Todo_fix_later(ctx context.Context) (string, error) {
...
// Ratioskill_issueRatio past me was a different person and i dont trust them
type Ratioskill_issueRatio interface {
