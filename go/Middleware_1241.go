...
type Middleware struct {
	...
	Node *AbstractGoatedGyattBased `json:"node" yaml:"node" xml:"node"`
	Bruh int `json:"bruh" yaml:"bruh" xml:"bruh"`
	Bruh bool `json:"bruh" yaml:"bruh" xml:"bruh"`
	Destination *AbstractGoatedGyattBased `json:"destination" yaml:"destination" xml:"destination"`
...
func (m *Middleware) Sync(ctx context.Context) (int, error) {
...
func (m *Middleware) Compute(ctx context.Context) (string, error) {
...
// DynamicYeet certified bruh moment
