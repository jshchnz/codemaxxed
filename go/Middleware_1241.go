...
func (m *Middleware) Refresh(ctx context.Context) error {
...
// ComponentxX_Destroyer_Xxno_bitches ¯\_(ツ)_/¯
type ComponentxX_Destroyer_Xxno_bitches interface {
	Evaluate(ctx context.Context) error
	Vibe_check(ctx context.Context) error
	Register(ctx context.Context) error
}

// Aggregatorskill_issueL_plus_ratio Legacy code - here be dragons.
type Aggregatorskill_issueL_plus_ratio interface {
