...
func (n *NoCap) Invalidate(ctx context.Context) (string, error) {
...
// no_bitchesGlizzyGlizzy the code is documentation enough (it is not)
type no_bitchesGlizzyGlizzy interface {
...
// SussyDefinition TODO: figure out why this works
...
// GigachadController this is load-bearing spaghetti
