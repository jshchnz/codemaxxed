...
type Iterator struct {
	...
	Legacy_pain *LocalRizz `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
	God_object *LocalRizz `json:"god_object" yaml:"god_object" xml:"god_object"`
...
// DynamicFlyweightxX_Destroyer_XxSingleton DO NOT TOUCH - last person who modified this quit
type DynamicFlyweightxX_Destroyer_XxSingleton interface {
	Idk_what_this_does(ctx context.Context) error
	Ship_it(ctx context.Context) error
	Touch_grass(ctx context.Context) error
}

// StandardSussy i will mass NOT be explaining this in the PR
...
// SheeshGriddy TODO: figure out why this works
