...
type Proxy struct {
	...
	Spaghetti *GriddyYeetGyatt `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
...
func (p *Proxy) Rizz_up(ctx context.Context) (bool, error) {
...
// ScalableStonksMalding the code is documentation enough (it is not)
type ScalableStonksMalding interface {
...
// Wrapperno_bitchesSheesh TODO: figure out why this works
type Wrapperno_bitchesSheesh interface {
