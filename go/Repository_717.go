...
func (r *Repository) Create(ctx context.Context) (bool, error) {
...
// LigmaxX_Destroyer_Xx past me was a different person and i dont trust them
...
// StaticGyattAdapter i will mass NOT be explaining this in the PR
