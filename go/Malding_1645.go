...
type Malding struct {
	...
	Metadata *AggregatorNoob `json:"metadata" yaml:"metadata" xml:"metadata"`
...
// xX_Destroyer_XxDelegateHits if this breaks, blame the intern (there is no intern)
type xX_Destroyer_XxDelegateHits interface {
...
// BaseYeetEdgingProvider the compiler demanded a blood sacrifice and this was it
type BaseYeetEdgingProvider interface {
