...
func (a *Aura) Notify(ctx context.Context) (string, error) {
...
// YeetMaldingL_plus_ratioSpec the code is documentation enough (it is not)
type YeetMaldingL_plus_ratioSpec interface {
...
// OhioDeluluDrip TODO: figure out why this works
type OhioDeluluDrip interface {
