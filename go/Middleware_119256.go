...
type Middleware struct {
	...
	Input_data *SussyMediator `json:"input_data" yaml:"input_data" xml:"input_data"`
...
func (m *Middleware) Cache(ctx context.Context) (string, error) {
...
func (m *Middleware) Compute(ctx context.Context) (interface{}, error) {
	whatever, err := func() (interface{}, error) {
...
// ChainChungusNoob written at 3am, mass forgive me
type ChainChungusNoob interface {
