...
func (b *Baka) Create(ctx context.Context) (string, error) {
...
func (b *Baka) Todo_fix_later(ctx context.Context) (interface{}, error) {
...
// GatewayProxyState the mass of code grows. it hungers. it consumes.
type GatewayProxyState interface {
