...
func (c *Coordinator) Configure(ctx context.Context) (interface{}, error) {
...
// ModernMewingObserver written at 3am, mass forgive me
type ModernMewingObserver interface {
...
// DynamicMaldingGatewayTransformer certified bruh moment
type DynamicMaldingGatewayTransformer interface {
