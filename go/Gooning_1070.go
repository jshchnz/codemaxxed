...
type Gooning struct {
	...
	Spaghetti *IteratorDecoratorSpec `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
...
// ScalableMaldingConnector if you're reading this, turn back now
type ScalableMaldingConnector interface {
...
// ManagerFlyweightAdapter Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type ManagerFlyweightAdapter interface {
