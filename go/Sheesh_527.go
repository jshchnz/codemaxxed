...
type Sheesh struct {
	Element *ValidatorNoob `json:"element" yaml:"element" xml:"element"`
	Request string `json:"request" yaml:"request" xml:"request"`
	Instance int `json:"instance" yaml:"instance" xml:"instance"`
	X *sync.Mutex `json:"x" yaml:"x" xml:"x"`
	Dont_ask float64 `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
	Node string `json:"node" yaml:"node" xml:"node"`
	This_shouldnt_work *ValidatorNoob `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
...
// GoatedGyattService skill issue if you can't read this
type GoatedGyattService interface {
...
// DynamicHits certified bruh moment
