...
type Based struct {
	...
	Forbidden_knowledge *GlizzyPipeline `json:"forbidden_knowledge" yaml:"forbidden_knowledge" xml:"forbidden_knowledge"`
...
func (b *Based) Compute(ctx context.Context) (interface{}, error) {
...
func (b *Based) Decompress(ctx context.Context) (int, error) {
...
// StandardRatioSpec this violates at least 3 design patterns and invents 2 new ones
type StandardRatioSpec interface {
