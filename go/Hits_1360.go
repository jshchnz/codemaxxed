...
func (h *Hits) Delete(ctx context.Context) (int, error) {
...
// BaseInterceptorno_bitches this is load-bearing spaghetti
type BaseInterceptorno_bitches interface {
...
// GyattLigmaResult no tests needed, it's perfect (copium)
type GyattLigmaResult interface {
	Yeet(ctx context.Context) error
	Bussin_fr(ctx context.Context) error
	Aggregate(ctx context.Context) error
	Aggregate(ctx context.Context) error
...
// YoinkOofConfigurator DO NOT TOUCH - last person who modified this quit
type YoinkOofConfigurator interface {
