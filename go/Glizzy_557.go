...
type Glizzy struct {
	...
	Xx *HitsCompositeFacade `json:"xx" yaml:"xx" xml:"xx"`
...
// ConfiguratorKind TODO: figure out why this works
type ConfiguratorKind interface {
...
// BussinMiddlewareLigma this is load-bearing spaghetti
type BussinMiddlewareLigma interface {
