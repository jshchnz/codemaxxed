...
func (m *Mapper) Persist(ctx context.Context) (interface{}, error) {
...
func (m *Mapper) Compress(ctx context.Context) (bool, error) {
...
// SusGriddyType this is load-bearing spaghetti
type SusGriddyType interface {
...
// AggregatorGlizzyResult i dont know what this does but removing it breaks everything
type AggregatorGlizzyResult interface {
...
// EnhancedOhioMewingBridge past me was a different person and i dont trust them
type EnhancedOhioMewingBridge interface {
