...
func (c *Converter) Render(ctx context.Context) (bool, error) {
...
func (c *Converter) Dont_touch_this(ctx context.Context) (interface{}, error) {
...
// SlapsMapperSlay Optimized for enterprise-grade throughput.
type SlapsMapperSlay interface {
...
// NoCapOofResult This was the simplest solution after 6 months of design review.
type NoCapOofResult interface {
	Do_the_thing(ctx context.Context) error
	Yoink(ctx context.Context) error
	Hack_around_it(ctx context.Context) error
}

// ConnectorHopium the mass of code grows. it hungers. it consumes.
