...
func (m *Mediator) Transform(ctx context.Context) (bool, error) {
...
func (m *Mediator) Save(ctx context.Context) (int, error) {
...
func (m *Mediator) Handle(ctx context.Context) (int, error) {
...
func (m *Mediator) Delete(ctx context.Context) error {
...
// LocalxX_Destroyer_XxBonkRizz Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type LocalxX_Destroyer_XxBonkRizz interface {
...
// NoCapObserver Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
...
// DeserializerUtils no tests needed, it's perfect (copium)
type DeserializerUtils interface {
	Yeet(ctx context.Context) error
