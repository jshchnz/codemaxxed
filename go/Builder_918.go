...
func (b *Builder) Yeet(ctx context.Context) error {
...
// SusWrapper This was the simplest solution after 6 months of design review.
type SusWrapper interface {
...
// GenericxX_Destroyer_XxFanumValidator This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
type GenericxX_Destroyer_XxFanumValidator interface {
