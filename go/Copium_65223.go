...
func (c *Copium) Update(ctx context.Context) (int, error) {
...
func (c *Copium) Sanitize(ctx context.Context) (bool, error) {
...
func (c *Copium) Deserialize(ctx context.Context) (int, error) {
...
func (c *Copium) Create(ctx context.Context) (interface{}, error) {
