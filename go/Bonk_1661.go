...
func (b *Bonk) Process(ctx context.Context) (int, error) {
...
// SerializerFanum abandon all hope ye who enter here
...
// SheeshLigmaBussinException the code is documentation enough (it is not)
type SheeshLigmaBussinException interface {
	Abandon_all_hope(ctx context.Context) error
...
// InternalOhio past me was a different person and i dont trust them
