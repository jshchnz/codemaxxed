...
func (g *Griddy) Serialize(ctx context.Context) (interface{}, error) {
...
// HitsBridgeBussin abandon all hope ye who enter here
type HitsBridgeBussin interface {
...
// SheeshGoatedRizz if this breaks, blame the intern (there is no intern)
type SheeshGoatedRizz interface {
