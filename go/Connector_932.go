...
func (c *Connector) Evaluate(ctx context.Context) error {
...
func (c *Connector) Authorize(ctx context.Context) (int, error) {
...
// LocalxX_Destroyer_XxMalding ¯\_(ツ)_/¯
type LocalxX_Destroyer_XxMalding interface {
...
// AuraType vibe coded, do not question
