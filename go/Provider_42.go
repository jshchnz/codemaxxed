...
type Provider struct {
	...
	The_darkness *AggregatorDecoratorGigachad `json:"the_darkness" yaml:"the_darkness" xml:"the_darkness"`
...
func (p *Provider) Compress(ctx context.Context) (int, error) {
...
func (p *Provider) Seethe(ctx context.Context) (interface{}, error) {
...
// PoggersRatioSussy works on my machine ™
type PoggersRatioSussy interface {
...
// InternalProviderno_bitches this violates at least 3 design patterns and invents 2 new ones
type InternalProviderno_bitches interface {
