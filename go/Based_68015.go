...
type Based struct {
	...
	Payload *BakaDeadassGyatt `json:"payload" yaml:"payload" xml:"payload"`
...
func (b *Based) Format(ctx context.Context) error {
...
func (b *Based) Serialize(ctx context.Context) (string, error) {
...
// LegacyRatioConnector i will mass NOT be explaining this in the PR
type LegacyRatioConnector interface {
...
// MewingGlizzy if this breaks, blame the intern (there is no intern)
