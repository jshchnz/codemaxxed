...
type Command struct {
	...
	Config *ModernService `json:"config" yaml:"config" xml:"config"`
	Source context.Context `json:"source" yaml:"source" xml:"source"`
	Data []byte `json:"data" yaml:"data" xml:"data"`
	This_shouldnt_work *ModernService `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
...
// BuilderSussySpec i dont know what this does but removing it breaks everything
type BuilderSussySpec interface {
