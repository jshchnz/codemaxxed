...
type Baka struct {
	...
	Item *AbstractAdapterError `json:"item" yaml:"item" xml:"item"`
...
// AbstractFanumProcessorGatewayDescriptor TODO: figure out why this works
type AbstractFanumProcessorGatewayDescriptor interface {
	Ship_it(ctx context.Context) error
	Resolve(ctx context.Context) error
	Aggregate(ctx context.Context) error
}

// EnterpriseLigmaAbstract Optimized for enterprise-grade throughput.
type EnterpriseLigmaAbstract interface {
