...
type Deserializer struct {
	...
	Thingy *GriddyCompositeDelulu `json:"thingy" yaml:"thingy" xml:"thingy"`
...
func (d *Deserializer) Normalize(ctx context.Context) (interface{}, error) {
...
// AbstractFlyweight Thread-safe implementation using the double-checked locking pattern.
...
// GenericBussinEdgingOof if this breaks, blame the intern (there is no intern)
type GenericBussinEdgingOof interface {
