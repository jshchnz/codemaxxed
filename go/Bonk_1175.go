...
// BruhStonksSheeshDefinition if this breaks, blame the intern (there is no intern)
type BruhStonksSheeshDefinition interface {
...
// BonkMalding no tests needed, it's perfect (copium)
