...
func (b *Bruh) Configure(ctx context.Context) (bool, error) {
...
func (b *Bruh) Parse(ctx context.Context) (bool, error) {
...
// InternalModuleChain This was the simplest solution after 6 months of design review.
type InternalModuleChain interface {
...
// PrototypeHandlerInitializerAbstract the compiler demanded a blood sacrifice and this was it
type PrototypeHandlerInitializerAbstract interface {
	Todo_fix_later(ctx context.Context) error
