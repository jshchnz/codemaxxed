...
// CringeYeetGlizzyKind this violates at least 3 design patterns and invents 2 new ones
type CringeYeetGlizzyKind interface {
	Serialize(ctx context.Context) error
	Yeet(ctx context.Context) error
	Trust_me_bro(ctx context.Context) error
}

// skill_issueGooning TODO: figure out why this works
...
// ProcessorMediatorMiddleware certified bruh moment
type ProcessorMediatorMiddleware interface {
