...
// DynamicGlizzyRequest abandon all hope ye who enter here
type DynamicGlizzyRequest interface {
...
// GigachadAbstract This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
