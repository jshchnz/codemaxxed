...
type Vibe struct {
	...
	Legacy_pain *PoggersDelulu `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
	Eldritch_data context.Context `json:"eldritch_data" yaml:"eldritch_data" xml:"eldritch_data"`
	Idk *PoggersDelulu `json:"idk" yaml:"idk" xml:"idk"`
}
...
func (v *Vibe) Delete(ctx context.Context) (string, error) {
...
func (v *Vibe) Format(ctx context.Context) (interface{}, error) {
...
// AdapterGlizzy if you're reading this, turn back now
...
// LegacyNoCapHits skill issue if you can't read this
type LegacyNoCapHits interface {
