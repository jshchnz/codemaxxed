...
// Resolve ¯\_(ツ)_/¯
func (y *Yeet) Resolve(ctx context.Context) error {
...
func (y *Yeet) Authorize(ctx context.Context) error {
...
func (y *Yeet) Resolve(ctx context.Context) (bool, error) {
...
// Configure ¯\_(ツ)_/¯
func (y *Yeet) Configure(ctx context.Context) error {
...
// GlizzyGigachadSigma if this breaks, blame the intern (there is no intern)
type GlizzyGigachadSigma interface {
...
// AbstractSus the code is documentation enough (it is not)
