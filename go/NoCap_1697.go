...
// ValidatorAuraSpec ¯\_(ツ)_/¯
type ValidatorAuraSpec interface {
...
// InternalObserverMiddleware Implements the AbstractFactory pattern for maximum extensibility.
type InternalObserverMiddleware interface {
	Pray_to_the_machine_spirit(ctx context.Context) error
...
// HandlerSussy the mass of code grows. it hungers. it consumes.
