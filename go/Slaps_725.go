...
type Slaps struct {
	...
	Params *BonkStonksValidator `json:"params" yaml:"params" xml:"params"`
...
func (s *Slaps) Delete(ctx context.Context) (string, error) {
...
// EnhancedRegistryDank TODO: Refactor this in Q3 (written in 2019).
type EnhancedRegistryDank interface {
