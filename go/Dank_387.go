...
type Dank struct {
	...
	This_shouldnt_work *DankCopiumOofResponse `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
	...
	Tech_debt *DankCopiumOofResponse `json:"tech_debt" yaml:"tech_debt" xml:"tech_debt"`
...
func (d *Dank) Delete(ctx context.Context) (interface{}, error) {
...
// ManagerSlaps i will mass NOT be explaining this in the PR
type ManagerSlaps interface {
	Works_on_my_machine(ctx context.Context) error
	Sanitize(ctx context.Context) error
	Lgtm(ctx context.Context) error
}

// FactoryLigmaSlay TODO: figure out why this works
type FactoryLigmaSlay interface {
