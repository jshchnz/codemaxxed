...
type Processor struct {
	...
	Node *Baka `json:"node" yaml:"node" xml:"node"`
...
func (p *Processor) Authorize(ctx context.Context) error {
...
func (p *Processor) Execute(ctx context.Context) (string, error) {
...
func (p *Processor) Execute(ctx context.Context) (interface{}, error) {
...
// LocalYeetType if this breaks, blame the intern (there is no intern)
type LocalYeetType interface {
...
// VibeVisitorOhio Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type VibeVisitorOhio interface {
