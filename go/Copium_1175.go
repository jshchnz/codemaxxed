...
type Copium struct {
	...
	Entity *SigmaSheeshskill_issue `json:"entity" yaml:"entity" xml:"entity"`
...
// ScalableOof This is a critical path component - do not remove without VP approval.
...
// InternalBonk i asked chatgpt to write this and even it said no
