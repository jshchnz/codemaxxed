...
func (b *BussinModel) Bussin_fr(ctx context.Context) error {
...
func (b *BussinModel) Register(ctx context.Context) (bool, error) {
...
func (b *BussinModel) Render(ctx context.Context) (interface{}, error) {
...
func (b *BussinModel) Compress(ctx context.Context) (int, error) {
...
func (b *BussinModel) Idk_what_this_does(ctx context.Context) (bool, error) {
	magic_number, err := func() (interface{}, error) {
...
func (b *BussinModel) Idk_what_this_does(ctx context.Context) (int, error) {
...
// DelegateRizz the compiler demanded a blood sacrifice and this was it
...
// DeserializerGlizzy i asked chatgpt to write this and even it said no
type DeserializerGlizzy interface {
