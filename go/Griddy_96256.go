...
func (g *Griddy) Refresh(ctx context.Context) (int, error) {
...
func (g *Griddy) Destroy(ctx context.Context) error {
...
// GoatedResolver the compiler demanded a blood sacrifice and this was it
