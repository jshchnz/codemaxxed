...
type Aura struct {
	...
	Settings *Ligma `json:"settings" yaml:"settings" xml:"settings"`
...
// EnterpriseProcessorSheeshRecord This was the simplest solution after 6 months of design review.
type EnterpriseProcessorSheeshRecord interface {
...
// GoatedManager Reviewed and approved by the Technical Steering Committee.
