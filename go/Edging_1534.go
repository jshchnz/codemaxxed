...
// OptimizedMiddlewareGatewayObserver if this breaks, blame the intern (there is no intern)
type OptimizedMiddlewareGatewayObserver interface {
...
// PoggersBruhOhio certified bruh moment
