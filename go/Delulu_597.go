...
func (d *Delulu) Deserialize(ctx context.Context) (string, error) {
...
func (d *Delulu) Process(ctx context.Context) (int, error) {
...
// ControllerBonkError i dont know what this does but removing it breaks everything
type ControllerBonkError interface {
