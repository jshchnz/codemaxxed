...
// HitsSheeshConverter if this breaks, blame the intern (there is no intern)
type HitsSheeshConverter interface {
...
// xX_Destroyer_XxBean Thread-safe implementation using the double-checked locking pattern.
type xX_Destroyer_XxBean interface {
...
// CringeService if you're reading this, turn back now
