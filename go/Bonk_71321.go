...
type Bonk struct {
	...
	This_shouldnt_work *ModernManagerCompositeError `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
...
func (b *Bonk) Register(ctx context.Context) (interface{}, error) {
...
// HitsCopium if this breaks, blame the intern (there is no intern)
...
// CoreSusSussyxX_Destroyer_Xx i will mass NOT be explaining this in the PR
type CoreSusSussyxX_Destroyer_Xx interface {
...
// BonkContext this violates at least 3 design patterns and invents 2 new ones
...
// LigmaMewingBonk if this breaks, blame the intern (there is no intern)
type LigmaMewingBonk interface {
