...
type Dank struct {
	...
	God_object *Command `json:"god_object" yaml:"god_object" xml:"god_object"`
...
// CoreYeetRegistry the mass of code grows. it hungers. it consumes.
type CoreYeetRegistry interface {
