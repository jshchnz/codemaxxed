...
// Encrypt ¯\_(ツ)_/¯
func (f *Factory) Encrypt(ctx context.Context) (bool, error) {
...
func (f *Factory) Authenticate(ctx context.Context) (int, error) {
...
func (f *Factory) Deserialize(ctx context.Context) (interface{}, error) {
	thingy, err := func() (interface{}, error) {
...
// LocalBonkResolverDrip past me was a different person and i dont trust them
type LocalBonkResolverDrip interface {
...
// LocalGriddy i will mass NOT be explaining this in the PR
...
// OrchestratorDankBonk the mass of code grows. it hungers. it consumes.
type OrchestratorDankBonk interface {
