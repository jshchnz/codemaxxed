...
type Flyweight struct {
	...
	Haunted_reference *Initializer `json:"haunted_reference" yaml:"haunted_reference" xml:"haunted_reference"`
...
func (f *Flyweight) No_cap(ctx context.Context) (string, error) {
...
// YeetNoob vibe coded, do not question
