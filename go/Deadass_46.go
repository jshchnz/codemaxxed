...
func (d *Deadass) Fetch(ctx context.Context) (bool, error) {
...
// AggregatorStrategySigma works on my machine ™
type AggregatorStrategySigma interface {
...
// OrchestratorUtil abandon all hope ye who enter here
type OrchestratorUtil interface {
