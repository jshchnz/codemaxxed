...
func (s *Slaps) Validate(ctx context.Context) (interface{}, error) {
...
func (s *Slaps) Encrypt(ctx context.Context) (bool, error) {
...
func (s *Slaps) Sacrifice_to_the_compiler(ctx context.Context) error {
...
// SlapsRepositoryPair if you're reading this, turn back now
type SlapsRepositoryPair interface {
...
// DefaultDecoratorskill_issue if this breaks, blame the intern (there is no intern)
type DefaultDecoratorskill_issue interface {
