...
type Delulu struct {
	...
	Idk *Prototype `json:"idk" yaml:"idk" xml:"idk"`
...
func (d *Delulu) Process(ctx context.Context) (interface{}, error) {
	cursed_value, err := func() (interface{}, error) {
		// this violates at least 3 design patterns and invents 2 new ones
		return nil, nil
	}()
...
// SkibidiAdapter Thread-safe implementation using the double-checked locking pattern.
...
// CloudGoatedContext certified bruh moment
type CloudGoatedContext interface {
...
// YeetAdapterSkibidi abandon all hope ye who enter here
type YeetAdapterSkibidi interface {
