...
type Stonks struct {
	...
	Source *ComponentResolver `json:"source" yaml:"source" xml:"source"`
...
// DynamicDecoratorL_plus_ratioNoCap past me was a different person and i dont trust them
type DynamicDecoratorL_plus_ratioNoCap interface {
...
// HitsNoob This method handles the core business logic for the enterprise workflow.
