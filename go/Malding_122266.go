...
// DistributedStonksMewingGigachad if this breaks, blame the intern (there is no intern)
type DistributedStonksMewingGigachad interface {
...
// skill_issueCoordinator the compiler demanded a blood sacrifice and this was it
