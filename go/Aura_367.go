...
func (a *Aura) Format(ctx context.Context) error {
...
func (a *Aura) Execute(ctx context.Context) (int, error) {
...
// BussinModuleBase works on my machine ™
type BussinModuleBase interface {
...
// InternalInterceptor this function is cursed
