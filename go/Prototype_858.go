...
func (p *Prototype) Update(ctx context.Context) error {
	forbidden_knowledge, err := func() (interface{}, error) {
...
// SerializerRizzEdging This was the simplest solution after 6 months of design review.
type SerializerRizzEdging interface {
	Trust_me_bro(ctx context.Context) error
	Yeet(ctx context.Context) error
	Cry(ctx context.Context) error
}

// CoreConfigurator abandon all hope ye who enter here
