...
type Provider struct {
	Payload *BasedException `json:"payload" yaml:"payload" xml:"payload"`
	Destination bool `json:"destination" yaml:"destination" xml:"destination"`
	Stuff *BasedException `json:"stuff" yaml:"stuff" xml:"stuff"`
	Whatever *BasedException `json:"whatever" yaml:"whatever" xml:"whatever"`
...
func (p *Provider) Render(ctx context.Context) (int, error) {
...
// BakaBonkPrototype Per the architecture review board decision ARB-2847.
type BakaBonkPrototype interface {
	Cry(ctx context.Context) error
