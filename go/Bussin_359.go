...
// AdapterAggregatorYoinkSpec if this breaks, blame the intern (there is no intern)
type AdapterAggregatorYoinkSpec interface {
...
// ChainRatio Lorem ipsum dolor sit amet, consectetur adipiscing elit.
