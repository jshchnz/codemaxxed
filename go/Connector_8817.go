...
type Connector struct {
	Payload *Deserializer `json:"payload" yaml:"payload" xml:"payload"`
...
// CloudGriddyMewingController Legacy code - here be dragons.
type CloudGriddyMewingController interface {
...
// DefaultBruhMediatorSlay TODO: Refactor this in Q3 (written in 2019).
type DefaultBruhMediatorSlay interface {
...
// BruhSingletonBussin the compiler demanded a blood sacrifice and this was it
type BruhSingletonBussin interface {
	Touch_grass(ctx context.Context) error
	Seethe(ctx context.Context) error
