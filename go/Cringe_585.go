...
// AggregatorRecord this violates at least 3 design patterns and invents 2 new ones
type AggregatorRecord interface {
...
// ConverterPoggers i will mass NOT be explaining this in the PR
type ConverterPoggers interface {
