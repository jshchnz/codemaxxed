...
// DeluluEndpointConfig i will mass NOT be explaining this in the PR
type DeluluEndpointConfig interface {
...
// GyattCopiumDeadassModel Per the architecture review board decision ARB-2847.
type GyattCopiumDeadassModel interface {
