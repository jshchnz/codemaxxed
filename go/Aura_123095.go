...
func (a *Aura) Normalize(ctx context.Context) (string, error) {
...
// BaseAdapterMediatorConfiguratorPair Conforms to ISO 27001 compliance requirements.
type BaseAdapterMediatorConfiguratorPair interface {
...
// GigachadData the code is documentation enough (it is not)
