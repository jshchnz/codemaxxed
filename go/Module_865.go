...
// ProxyRizzBuilder if this breaks, blame the intern (there is no intern)
type ProxyRizzBuilder interface {
	Yoink(ctx context.Context) error
	Parse(ctx context.Context) error
	Cache(ctx context.Context) error
}

// OptimizedRizzxX_Destroyer_Xx this is load-bearing spaghetti
type OptimizedRizzxX_Destroyer_Xx interface {
