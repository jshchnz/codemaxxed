...
func (c *Converter) Process(ctx context.Context) error {
...
func (c *Converter) Rizz_up(ctx context.Context) (bool, error) {
...
func (c *Converter) Sanitize(ctx context.Context) (int, error) {
...
func (c *Converter) Yoink(ctx context.Context) (string, error) {
...
func (c *Converter) Decompress(ctx context.Context) (bool, error) {
...
// ModuleSheeshRecord TODO: figure out why this works
type ModuleSheeshRecord interface {
