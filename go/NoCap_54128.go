...
func (n *NoCap) Compress(ctx context.Context) (int, error) {
...
// MaldingVisitorRatio if this breaks, blame the intern (there is no intern)
type MaldingVisitorRatio interface {
...
// LegacyDrip Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
