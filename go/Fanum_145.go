...
func (f *Fanum) Convert(ctx context.Context) error {
	cursed_value, err := func() (interface{}, error) {
		// no tests needed, it's perfect (copium)
		return nil, nil
	}()
...
// LocalDeserializerSussy Conforms to ISO 27001 compliance requirements.
type LocalDeserializerSussy interface {
