...
type Based struct {
	...
	Tech_debt *RatioGyatt `json:"tech_debt" yaml:"tech_debt" xml:"tech_debt"`
	...
	Dont_ask *RatioGyatt `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
...
// SlaySingletonBonkAbstract works on my machine ™
type SlaySingletonBonkAbstract interface {
