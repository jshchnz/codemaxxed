...
type Deadass struct {
	...
	Stuff *HopiumAbstract `json:"stuff" yaml:"stuff" xml:"stuff"`
...
func (d *Deadass) Parse(ctx context.Context) (bool, error) {
...
func (d *Deadass) Deserialize(ctx context.Context) (bool, error) {
	this_shouldnt_work, err := func() (interface{}, error) {
		// past me was a different person and i dont trust them
		return nil, nil
	}()
...
// StaticObserver i will mass NOT be explaining this in the PR
...
// SusWrapperDelulu the compiler demanded a blood sacrifice and this was it
type SusWrapperDelulu interface {
