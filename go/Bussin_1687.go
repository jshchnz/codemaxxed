...
// OptimizedPrototypeRizz certified bruh moment
type OptimizedPrototypeRizz interface {
...
// ScalableSingletonService i will mass NOT be explaining this in the PR
type ScalableSingletonService interface {
