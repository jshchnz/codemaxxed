...
func (g *Griddy) Configure(ctx context.Context) (string, error) {
	request, err := func() (interface{}, error) {
...
// SigmaxX_Destroyer_XxStrategy written at 3am, mass forgive me
...
// MediatorPair past me was a different person and i dont trust them
