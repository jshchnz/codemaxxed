...
func (o *Ohio) Sync(ctx context.Context) (string, error) {
...
// YeetBussinModel TODO: Refactor this in Q3 (written in 2019).
type YeetBussinModel interface {
...
// StandardInterceptorOofKind works on my machine ™
type StandardInterceptorOofKind interface {
...
// HitsValidator This method handles the core business logic for the enterprise workflow.
type HitsValidator interface {
