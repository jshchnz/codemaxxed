...
type BaseMiddleware struct {
	...
	Entry *GyattVisitor `json:"entry" yaml:"entry" xml:"entry"`
...
func (b *BaseMiddleware) Mald(ctx context.Context) error {
...
func (b *BaseMiddleware) Here_be_dragons(ctx context.Context) error {
...
func (b *BaseMiddleware) Works_on_my_machine(ctx context.Context) (interface{}, error) {
...
func (b *BaseMiddleware) Todo_fix_later(ctx context.Context) (bool, error) {
...
func (b *BaseMiddleware) Build(ctx context.Context) (bool, error) {
...
func (b *BaseMiddleware) Cope(ctx context.Context) (int, error) {
...
// BussinRatio written at 3am, mass forgive me
