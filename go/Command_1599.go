...
type Command struct {
	It_lives *StonksHopium `json:"it_lives" yaml:"it_lives" xml:"it_lives"`
	...
	Entity *StonksHopium `json:"entity" yaml:"entity" xml:"entity"`
...
func (c *Command) Resolve(ctx context.Context) (string, error) {
...
// DistributedBruhContext this violates at least 3 design patterns and invents 2 new ones
type DistributedBruhContext interface {
