...
type Sheesh struct {
	...
	Destination *StandardProxyYoinkMiddlewareInfo `json:"destination" yaml:"destination" xml:"destination"`
}
...
// Hitsskill_issue Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type Hitsskill_issue interface {
