...
type Service struct {
	...
	Status *StaticNoobGoated `json:"status" yaml:"status" xml:"status"`
...
// GooningSheeshChungus the compiler demanded a blood sacrifice and this was it
type GooningSheeshChungus interface {
...
// CloudGriddyBussin the compiler demanded a blood sacrifice and this was it
type CloudGriddyBussin interface {
