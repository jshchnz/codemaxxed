...
type skill_issue struct {
	...
	Bruh *ValidatorRizzRizz `json:"bruh" yaml:"bruh" xml:"bruh"`
...
// HitsGyattComponent i dont know what this does but removing it breaks everything
type HitsGyattComponent interface {
