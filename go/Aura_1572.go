...
type Aura struct {
	...
	Item *SingletonSigma `json:"item" yaml:"item" xml:"item"`
...
func (a *Aura) Build(ctx context.Context) (int, error) {
...
func (a *Aura) Register(ctx context.Context) (string, error) {
...
// BruhGyatt certified bruh moment
...
// HitsPair Per the architecture review board decision ARB-2847.
...
// CustomHopiumType if this breaks, blame the intern (there is no intern)
type CustomHopiumType interface {
	Abandon_all_hope(ctx context.Context) error
	Bussin_fr(ctx context.Context) error
	Authorize(ctx context.Context) error
...
// SigmaCopium if you're reading this, turn back now
