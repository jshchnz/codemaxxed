...
// DeadassDeadassValidator works on my machine ™
type DeadassDeadassValidator interface {
...
// LegacyHopiumError if you're reading this, turn back now
type LegacyHopiumError interface {
