...
type Iterator struct {
	...
	Dont_ask *BaseDeadassModuleGlizzyUtil `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
...
func (i *Iterator) Authenticate(ctx context.Context) (bool, error) {
...
// Localskill_issueYoinkBridge past me was a different person and i dont trust them
type Localskill_issueYoinkBridge interface {
