...
func (l *Ligma) Delete(ctx context.Context) (interface{}, error) {
...
// ChungusGooningAdapter Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type ChungusGooningAdapter interface {
...
// CustomGyatt past me was a different person and i dont trust them
