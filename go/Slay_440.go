...
type Slay struct {
	...
	Fix_me_please *EnhancedRepositoryHits `json:"fix_me_please" yaml:"fix_me_please" xml:"fix_me_please"`
...
// InternalLigmaGooningChungus written at 3am, mass forgive me
type InternalLigmaGooningChungus interface {
