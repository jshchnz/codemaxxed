...
type Handler struct {
	...
	Eldritch_data *CustomDispatcherHopiumFacade `json:"eldritch_data" yaml:"eldritch_data" xml:"eldritch_data"`
...
// StonksBakaData this violates at least 3 design patterns and invents 2 new ones
type StonksBakaData interface {
