...
func (m *Module) Aggregate(ctx context.Context) (int, error) {
...
func (m *Module) Notify(ctx context.Context) (interface{}, error) {
...
// DynamicGooningBridge DO NOT MODIFY - This is load-bearing architecture.
type DynamicGooningBridge interface {
