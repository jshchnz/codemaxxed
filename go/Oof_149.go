...
func (o *Oof) Deserialize(ctx context.Context) (int, error) {
...
func (o *Oof) Denormalize(ctx context.Context) (int, error) {
...
// BridgeNoCapDelulu the code is documentation enough (it is not)
type BridgeNoCapDelulu interface {
...
// SkibidiFacadeSigma TODO: figure out why this works
type SkibidiFacadeSigma interface {
