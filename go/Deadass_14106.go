...
type Deadass struct {
	...
	Cursed_value *FanumHopium `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
...
func (d *Deadass) Resolve(ctx context.Context) (interface{}, error) {
...
// AbstractIterator TODO: Refactor this in Q3 (written in 2019).
