...
type Builder struct {
	...
	Element *ModernGoatedskill_issueYeet `json:"element" yaml:"element" xml:"element"`
...
func (b *Builder) Create(ctx context.Context) (interface{}, error) {
	thingy, err := func() (interface{}, error) {
		// past me was a different person and i dont trust them
		return nil, nil
	}()
...
// StandardFactory this violates at least 3 design patterns and invents 2 new ones
...
// BuilderNoobBase This was the simplest solution after 6 months of design review.
type BuilderNoobBase interface {
