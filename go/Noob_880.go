...
// EnterpriseCringeSus i will mass NOT be explaining this in the PR
type EnterpriseCringeSus interface {
...
// SusManagerGyattInfo no tests needed, it's perfect (copium)
type SusManagerGyattInfo interface {
