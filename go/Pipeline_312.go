...
type Pipeline struct {
	...
	Buffer *StaticNoCapHitsGoated `json:"buffer" yaml:"buffer" xml:"buffer"`
...
// RizzWrapper this function is cursed
...
// StandardConverter the mass of code grows. it hungers. it consumes.
