...
type Skibidi struct {
	...
	Stuff *BussinGigachad `json:"stuff" yaml:"stuff" xml:"stuff"`
...
func (s *Skibidi) Persist(ctx context.Context) (bool, error) {
...
// GlobalNoCapGyattConverter this is load-bearing spaghetti
type GlobalNoCapGyattConverter interface {
...
// StaticStonks Reviewed and approved by the Technical Steering Committee.
