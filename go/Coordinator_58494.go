...
func (c *Coordinator) Format(ctx context.Context) (interface{}, error) {
...
func (c *Coordinator) Delete(ctx context.Context) (interface{}, error) {
	xx, err := func() (interface{}, error) {
...
// Wrapperno_bitches Conforms to ISO 27001 compliance requirements.
