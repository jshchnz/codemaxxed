...
func (f *Fanum) Destroy(ctx context.Context) error {
...
// no_bitchesObserverDrip the code is documentation enough (it is not)
type no_bitchesObserverDrip interface {
	Cry(ctx context.Context) error
	Marshal(ctx context.Context) error
	Convert(ctx context.Context) error
}

// CopiumDankProviderState i asked chatgpt to write this and even it said no
type CopiumDankProviderState interface {
