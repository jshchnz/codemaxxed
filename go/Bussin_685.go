...
// ScalableCringe i will mass NOT be explaining this in the PR
...
// BakaConnectorPair the mass of code grows. it hungers. it consumes.
type BakaConnectorPair interface {
