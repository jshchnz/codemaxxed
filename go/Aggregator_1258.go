...
type Aggregator struct {
	...
	Settings *EnhancedPoggersContext `json:"settings" yaml:"settings" xml:"settings"`
...
func (a *Aggregator) Refresh(ctx context.Context) (bool, error) {
...
func (a *Aggregator) Update(ctx context.Context) (interface{}, error) {
...
func (a *Aggregator) Create(ctx context.Context) (interface{}, error) {
...
func (a *Aggregator) Deserialize(ctx context.Context) (interface{}, error) {
...
// EdgingYoinkGooningInfo written at 3am, mass forgive me
type EdgingYoinkGooningInfo interface {
...
// OofBuilderValue DO NOT TOUCH - last person who modified this quit
type OofBuilderValue interface {
