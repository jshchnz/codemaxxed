...
func (p *Proxy) Initialize(ctx context.Context) (interface{}, error) {
...
func (p *Proxy) Authorize(ctx context.Context) error {
...
// DefaultMapperSusBuilder certified bruh moment
type DefaultMapperSusBuilder interface {
	Todo_fix_later(ctx context.Context) error
