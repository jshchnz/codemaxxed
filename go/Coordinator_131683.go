...
type Coordinator struct {
	...
	Payload *BridgeKind `json:"payload" yaml:"payload" xml:"payload"`
...
func (c *Coordinator) Compress(ctx context.Context) (bool, error) {
...
func (c *Coordinator) No_cap(ctx context.Context) error {
...
func (c *Coordinator) Destroy(ctx context.Context) (string, error) {
...
// EnterpriseSussySkibidiPoggers skill issue if you can't read this
type EnterpriseSussySkibidiPoggers interface {
...
// MediatorNoCapOof i dont know what this does but removing it breaks everything
type MediatorNoCapOof interface {
