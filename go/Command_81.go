...
// FanumLigmaComposite skill issue if you can't read this
type FanumLigmaComposite interface {
...
// AbstractLigmaStrategy vibe coded, do not question
...
// ProcessorGooningRecord Legacy code - here be dragons.
type ProcessorGooningRecord interface {
