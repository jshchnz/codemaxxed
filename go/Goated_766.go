...
func (g *Goated) Abandon_all_hope(ctx context.Context) (bool, error) {
...
// SlayController This was the simplest solution after 6 months of design review.
...
// CompositeDeluluConnectorImpl no tests needed, it's perfect (copium)
type CompositeDeluluConnectorImpl interface {
