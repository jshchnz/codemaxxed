...
func (f *Facade) Cache(ctx context.Context) error {
...
// RegistrySussyConverter the mass of code grows. it hungers. it consumes.
type RegistrySussyConverter interface {
	Cry(ctx context.Context) error
