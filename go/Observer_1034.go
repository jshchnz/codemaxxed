...
func (o *Observer) Update(ctx context.Context) error {
...
func (o *Observer) Cry(ctx context.Context) error {
...
// VisitorResolver works on my machine ™
...
// CommandLigma this function is cursed
type CommandLigma interface {
