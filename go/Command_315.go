...
type Command struct {
	...
	Target *CoordinatorGoatedFanum `json:"target" yaml:"target" xml:"target"`
...
// EnterpriseDecoratorGoated if you're reading this, turn back now
type EnterpriseDecoratorGoated interface {
	Save(ctx context.Context) error
	Cry(ctx context.Context) error
	Resolve(ctx context.Context) error
}

// GlizzyModule i will mass NOT be explaining this in the PR
