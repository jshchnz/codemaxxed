...
type Drip struct {
	Tech_debt *InternalWrapperRegistryValue `json:"tech_debt" yaml:"tech_debt" xml:"tech_debt"`
...
func (d *Drip) Convert(ctx context.Context) error {
...
func (d *Drip) Save(ctx context.Context) (string, error) {
...
// LegacySusPrototypeSlay i dont know what this does but removing it breaks everything
type LegacySusPrototypeSlay interface {
...
// EdgingDeadassMapper this function is cursed
type EdgingDeadassMapper interface {
	Cope(ctx context.Context) error
