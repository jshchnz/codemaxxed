...
// OptimizedGigachad This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
...
// CloudDeserializerYoink if you're reading this, turn back now
type CloudDeserializerYoink interface {
	Ship_it(ctx context.Context) error
	Abandon_all_hope(ctx context.Context) error
	Update(ctx context.Context) error
}

// CringeSussy abandon all hope ye who enter here
