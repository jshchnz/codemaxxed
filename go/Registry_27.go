...
func (r *Registry) Validate(ctx context.Context) (string, error) {
...
// FlyweightHopium no tests needed, it's perfect (copium)
...
// FlyweightMapper i dont know what this does but removing it breaks everything
...
// BaseProcessorDescriptor TODO: Refactor this in Q3 (written in 2019).
type BaseProcessorDescriptor interface {
...
// OptimizedSerializer ¯\_(ツ)_/¯
type OptimizedSerializer interface {
