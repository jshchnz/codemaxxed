...
type Fanum struct {
	...
	Cursed_value *SerializerHits `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
...
// skill_issueManagerSpec abandon all hope ye who enter here
type skill_issueManagerSpec interface {
