...
func (b *Based) Persist(ctx context.Context) (int, error) {
...
// EnhancedBonkskill_issue the code is documentation enough (it is not)
type EnhancedBonkskill_issue interface {
