...
type Goated struct {
	...
	Forbidden_knowledge *DistributedBussinRepositoryDelegate `json:"forbidden_knowledge" yaml:"forbidden_knowledge" xml:"forbidden_knowledge"`
	Haunted_reference error `json:"haunted_reference" yaml:"haunted_reference" xml:"haunted_reference"`
	Destination *DistributedBussinRepositoryDelegate `json:"destination" yaml:"destination" xml:"destination"`
...
// ModernAuraMalding past me was a different person and i dont trust them
type ModernAuraMalding interface {
...
// ValidatorConfiguratorEntity the code is documentation enough (it is not)
type ValidatorConfiguratorEntity interface {
