...
func (d *Deadass) Notify(ctx context.Context) error {
...
func (d *Deadass) Configure(ctx context.Context) (int, error) {
...
// YeetMiddlewareChungus works on my machine ™
type YeetMiddlewareChungus interface {
...
// CopiumResult This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
