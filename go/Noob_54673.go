...
type Noob struct {
	...
	Request *LocalOhio `json:"request" yaml:"request" xml:"request"`
...
// BussinPoggersPipeline the mass of code grows. it hungers. it consumes.
type BussinPoggersPipeline interface {
