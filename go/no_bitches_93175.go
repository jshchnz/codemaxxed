...
type no_bitches struct {
	...
	Stuff *AbstractStrategyProviderType `json:"stuff" yaml:"stuff" xml:"stuff"`
}
...
// CoreOofVibeRequest DO NOT TOUCH - last person who modified this quit
type CoreOofVibeRequest interface {
...
// StaticYoinkBussinBasedRecord Reviewed and approved by the Technical Steering Committee.
type StaticYoinkBussinBasedRecord interface {
...
// StandardDispatcherGooningskill_issue past me was a different person and i dont trust them
type StandardDispatcherGooningskill_issue interface {
