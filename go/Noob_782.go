...
func (n *Noob) Render(ctx context.Context) (interface{}, error) {
...
func (n *Noob) Compute(ctx context.Context) (interface{}, error) {
	whatever, err := func() (interface{}, error) {
...
// GlizzyCopium if you're reading this, turn back now
...
// SheeshVibe Reviewed and approved by the Technical Steering Committee.
