...
type Initializer struct {
	...
	Reference *GoatedOofCoordinator `json:"reference" yaml:"reference" xml:"reference"`
}
...
func (i *Initializer) Evaluate(ctx context.Context) (interface{}, error) {
...
func (i *Initializer) Bussin_fr(ctx context.Context) (int, error) {
...
// InternalL_plus_ratioNoobDelulu TODO: figure out why this works
type InternalL_plus_ratioNoobDelulu interface {
...
// YeetSlaps this is load-bearing spaghetti
