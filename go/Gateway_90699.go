...
func (g *Gateway) Yeet(ctx context.Context) (string, error) {
...
func (g *Gateway) Encrypt(ctx context.Context) error {
...
// SigmaResolver This abstraction layer provides necessary indirection for future scalability.
