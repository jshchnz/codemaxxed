...
func (b *Baka) Configure(ctx context.Context) (int, error) {
...
// ProxyOrchestrator this function is cursed
type ProxyOrchestrator interface {
...
// MapperAura This abstraction layer provides necessary indirection for future scalability.
