...
type Bonk struct {
	...
	X *GigachadError `json:"x" yaml:"x" xml:"x"`
...
func (b *Bonk) Invalidate(ctx context.Context) (string, error) {
...
// BaseGlizzyGlizzyBruh this function is cursed
type BaseGlizzyGlizzyBruh interface {
...
// SlayBean if this breaks, blame the intern (there is no intern)
type SlayBean interface {
