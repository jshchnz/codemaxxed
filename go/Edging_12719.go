...
// LocalHopiumOof past me was a different person and i dont trust them
type LocalHopiumOof interface {
...
// EnterpriseSigmaInfo This method handles the core business logic for the enterprise workflow.
type EnterpriseSigmaInfo interface {
