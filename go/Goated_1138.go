...
func (g *Goated) Configure(ctx context.Context) (bool, error) {
...
func (g *Goated) Execute(ctx context.Context) (string, error) {
...
func (g *Goated) Render(ctx context.Context) (interface{}, error) {
...
func (g *Goated) Mald(ctx context.Context) (int, error) {
...
func (g *Goated) Destroy(ctx context.Context) error {
...
// No_cap ¯\_(ツ)_/¯
func (g *Goated) No_cap(ctx context.Context) error {
...
// NoCapDefinition Implements the AbstractFactory pattern for maximum extensibility.
...
// ResolverNoobGooning i dont know what this does but removing it breaks everything
type ResolverNoobGooning interface {
