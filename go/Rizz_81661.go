...
func (r *Rizz) Authenticate(ctx context.Context) (string, error) {
...
// Gooningno_bitchesValidator TODO: Refactor this in Q3 (written in 2019).
type Gooningno_bitchesValidator interface {
	No_cap(ctx context.Context) error
	Aggregate(ctx context.Context) error
	Yoink(ctx context.Context) error
}

// BussinNoCap Lorem ipsum dolor sit amet, consectetur adipiscing elit.
