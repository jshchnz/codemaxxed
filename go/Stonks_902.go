...
func (s *Stonks) Marshal(ctx context.Context) (string, error) {
...
// BonkFlyweight this function is cursed
...
// BaseDeluluIteratorFlyweight Implements the AbstractFactory pattern for maximum extensibility.
type BaseDeluluIteratorFlyweight interface {
