...
func (s *Stonks) Update(ctx context.Context) (interface{}, error) {
...
func (s *Stonks) Unmarshal(ctx context.Context) (bool, error) {
...
func (s *Stonks) Serialize(ctx context.Context) (interface{}, error) {
	dont_ask, err := func() (interface{}, error) {
		// Legacy code - here be dragons.
		return nil, nil
	}()
...
// FactoryDispatcherskill_issue TODO: figure out why this works
type FactoryDispatcherskill_issue interface {
...
// ChungusImpl Lorem ipsum dolor sit amet, consectetur adipiscing elit.
