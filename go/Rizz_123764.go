...
// DefaultPrototypeskill_issue the compiler demanded a blood sacrifice and this was it
type DefaultPrototypeskill_issue interface {
...
// EdgingIteratorDispatcherException certified bruh moment
type EdgingIteratorDispatcherException interface {
	Rizz_up(ctx context.Context) error
