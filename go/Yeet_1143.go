...
// InternalBussinRecord i dont know what this does but removing it breaks everything
type InternalBussinRecord interface {
...
// Customskill_issueAggregator the compiler demanded a blood sacrifice and this was it
type Customskill_issueAggregator interface {
...
// skill_issueSlayModel if you're reading this, turn back now
type skill_issueSlayModel interface {
