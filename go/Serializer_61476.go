...
func (s *Serializer) Abandon_all_hope(ctx context.Context) (int, error) {
...
// GlobalInitializerInitializer DO NOT TOUCH - last person who modified this quit
type GlobalInitializerInitializer interface {
...
// VibeProxyMiddlewareUtils ¯\_(ツ)_/¯
type VibeProxyMiddlewareUtils interface {
