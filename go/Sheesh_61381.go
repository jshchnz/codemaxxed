...
func (s *Sheesh) Marshal(ctx context.Context) (int, error) {
...
func (s *Sheesh) Do_the_thing(ctx context.Context) error {
...
// Gateway This was the simplest solution after 6 months of design review.
...
// BaseMewingCommandDefinition Thread-safe implementation using the double-checked locking pattern.
type BaseMewingCommandDefinition interface {
...
// InterceptorService if you're reading this, turn back now
