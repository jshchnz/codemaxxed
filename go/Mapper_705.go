...
func (m *Mapper) Transform(ctx context.Context) error {
...
func (m *Mapper) Cache(ctx context.Context) (interface{}, error) {
...
func (m *Mapper) Dispatch(ctx context.Context) (bool, error) {
...
func (m *Mapper) Rizz_up(ctx context.Context) (interface{}, error) {
...
func (m *Mapper) Seethe(ctx context.Context) error {
...
func (m *Mapper) Execute(ctx context.Context) (int, error) {
	legacy_pain, err := func() (interface{}, error) {
...
// HitsProcessorNoCap this is load-bearing spaghetti
type HitsProcessorNoCap interface {
