...
type Oof struct {
	...
	Temp_but_permanent *GenericNoCapDank `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
...
func (o *Oof) Authenticate(ctx context.Context) error {
...
// AuraSigmaHits DO NOT MODIFY - This is load-bearing architecture.
type AuraSigmaHits interface {
