...
// RegistryConverter no tests needed, it's perfect (copium)
type RegistryConverter interface {
...
// YeetOhioMewing no tests needed, it's perfect (copium)
type YeetOhioMewing interface {
	Here_be_dragons(ctx context.Context) error
	Idk_what_this_does(ctx context.Context) error
...
// CoreHits if this breaks, blame the intern (there is no intern)
