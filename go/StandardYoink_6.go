...
// Notify ¯\_(ツ)_/¯
func (s *StandardYoink) Notify(ctx context.Context) (interface{}, error) {
...
func (s *StandardYoink) Marshal(ctx context.Context) (bool, error) {
...
func (s *StandardYoink) Lgtm(ctx context.Context) (int, error) {
...
func (s *StandardYoink) Transform(ctx context.Context) (interface{}, error) {
...
func (s *StandardYoink) Invalidate(ctx context.Context) (bool, error) {
...
func (s *StandardYoink) Encrypt(ctx context.Context) (bool, error) {
...
func (s *StandardYoink) Seethe(ctx context.Context) (interface{}, error) {
...
// DynamicCringe DO NOT TOUCH - last person who modified this quit
