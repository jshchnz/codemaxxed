...
func (p *Prototype) Validate(ctx context.Context) (interface{}, error) {
...
// EdgingEdging if this breaks, blame the intern (there is no intern)
...
// FanumMewing no tests needed, it's perfect (copium)
...
// GenericAura i asked chatgpt to write this and even it said no
