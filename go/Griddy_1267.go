...
// CoreFanumHopium Implements the AbstractFactory pattern for maximum extensibility.
type CoreFanumHopium interface {
...
// PoggersEdgingCringe i will mass NOT be explaining this in the PR
type PoggersEdgingCringe interface {
