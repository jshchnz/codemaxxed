...
// AggregatorBonk i asked chatgpt to write this and even it said no
type AggregatorBonk interface {
...
// GooningNoobHelper abandon all hope ye who enter here
type GooningNoobHelper interface {
	Resolve(ctx context.Context) error
	Here_be_dragons(ctx context.Context) error
	Unmarshal(ctx context.Context) error
}

// ResolverLigmaxX_Destroyer_Xx certified bruh moment
type ResolverLigmaxX_Destroyer_Xx interface {
	Yoink(ctx context.Context) error
