...
// SusGigachadGyatt vibe coded, do not question
type SusGigachadGyatt interface {
	Ship_it(ctx context.Context) error
...
// HopiumConfiguratorChungus works on my machine ™
type HopiumConfiguratorChungus interface {
	Sacrifice_to_the_compiler(ctx context.Context) error
