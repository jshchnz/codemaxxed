...
func (c *Converter) Mald(ctx context.Context) error {
...
func (c *Converter) Parse(ctx context.Context) (bool, error) {
...
// StonksValue skill issue if you can't read this
