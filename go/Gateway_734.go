...
type Gateway struct {
	...
	Thingy *Cloudskill_issueBonk `json:"thingy" yaml:"thingy" xml:"thingy"`
}
...
func (g *Gateway) Encrypt(ctx context.Context) (string, error) {
...
func (g *Gateway) Create(ctx context.Context) (int, error) {
...
// NoCapManager if you're reading this, turn back now
...
// CringeEdgingWrapperPair works on my machine ™
type CringeEdgingWrapperPair interface {
