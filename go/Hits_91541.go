...
func (h *Hits) Convert(ctx context.Context) (string, error) {
...
// SheeshGigachad Thread-safe implementation using the double-checked locking pattern.
...
// xX_Destroyer_XxOrchestrator written at 3am, mass forgive me
