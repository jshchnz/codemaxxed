...
func (c *ChungusBase) Trust_me_bro(ctx context.Context) (string, error) {
...
func (c *ChungusBase) Works_on_my_machine(ctx context.Context) error {
...
func (c *ChungusBase) Works_on_my_machine(ctx context.Context) (string, error) {
...
func (c *ChungusBase) Pray_to_the_machine_spirit(ctx context.Context) error {
...
func (c *ChungusBase) Mald(ctx context.Context) (interface{}, error) {
...
func (c *ChungusBase) Lgtm(ctx context.Context) (bool, error) {
