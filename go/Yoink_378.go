...
type Yoink struct {
	...
	Cursed_value *CoreDankSingletonBuilder `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
}
...
func (y *Yoink) Persist(ctx context.Context) (string, error) {
...
// BussinEndpointData abandon all hope ye who enter here
type BussinEndpointData interface {
