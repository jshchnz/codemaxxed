...
type Copium struct {
	...
	The_darkness *Coreskill_issueHandlerHits `json:"the_darkness" yaml:"the_darkness" xml:"the_darkness"`
...
// MapperResponse Per the architecture review board decision ARB-2847.
