...
type Edging struct {
	...
	Settings *LigmaDecorator `json:"settings" yaml:"settings" xml:"settings"`
...
// OofRepository the code is documentation enough (it is not)
...
// YoinkOhioBonk the code is documentation enough (it is not)
type YoinkOhioBonk interface {
