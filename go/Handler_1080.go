...
func (h *Handler) Cache(ctx context.Context) (bool, error) {
...
// GoatedImpl the mass of code grows. it hungers. it consumes.
type GoatedImpl interface {
...
// RepositoryGlizzy abandon all hope ye who enter here
type RepositoryGlizzy interface {
	Please_work(ctx context.Context) error
