...
func (h *Hits) Parse(ctx context.Context) (bool, error) {
...
// VibeConfig skill issue if you can't read this
...
// OofSussyProcessor TODO: Refactor this in Q3 (written in 2019).
type OofSussyProcessor interface {
	Cry(ctx context.Context) error
