...
func (g *Griddy) Marshal(ctx context.Context) (bool, error) {
...
func (g *Griddy) Compress(ctx context.Context) (bool, error) {
...
// ConfiguratorServiceGriddy This abstraction layer provides necessary indirection for future scalability.
type ConfiguratorServiceGriddy interface {
...
// StonksEdging TODO: Refactor this in Q3 (written in 2019).
