...
type Aura struct {
	...
	Value *Ratio `json:"value" yaml:"value" xml:"value"`
...
// CloudDeluluNoCap no tests needed, it's perfect (copium)
type CloudDeluluNoCap interface {
...
// skill_issueContext no tests needed, it's perfect (copium)
