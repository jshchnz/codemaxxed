...
// GoatedStonksYeetResponse if you're reading this, turn back now
type GoatedStonksYeetResponse interface {
...
// StrategyBussin certified bruh moment
...
// InterceptorL_plus_ratioOof no tests needed, it's perfect (copium)
type InterceptorL_plus_ratioOof interface {
