...
func (m *Mediator) Ship_it(ctx context.Context) (string, error) {
...
func (m *Mediator) Sanitize(ctx context.Context) (string, error) {
...
func (m *Mediator) Aggregate(ctx context.Context) error {
...
func (m *Mediator) Persist(ctx context.Context) (interface{}, error) {
...
// BakaBonkGriddy ¯\_(ツ)_/¯
type BakaBonkGriddy interface {
...
// NoCapControllerMiddleware works on my machine ™
type NoCapControllerMiddleware interface {
...
// InternalYoinkMalding works on my machine ™
type InternalYoinkMalding interface {
...
// BonkxX_Destroyer_XxEndpointState past me was a different person and i dont trust them
type BonkxX_Destroyer_XxEndpointState interface {
	Vibe_check(ctx context.Context) error
