...
type Adapter struct {
	...
	Forbidden_knowledge *Bridge `json:"forbidden_knowledge" yaml:"forbidden_knowledge" xml:"forbidden_knowledge"`
...
func (a *Adapter) Transform(ctx context.Context) (string, error) {
...
func (a *Adapter) Notify(ctx context.Context) (int, error) {
...
// NoCapSheeshResolver skill issue if you can't read this
type NoCapSheeshResolver interface {
...
// SusDecorator this is load-bearing spaghetti
type SusDecorator interface {
	Decompress(ctx context.Context) error
