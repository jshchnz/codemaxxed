...
type Bussin struct {
	...
	Index *OhioBussin `json:"index" yaml:"index" xml:"index"`
...
// InternalCopiumxX_Destroyer_Xx if this breaks, blame the intern (there is no intern)
type InternalCopiumxX_Destroyer_Xx interface {
...
// StandardProvider i asked chatgpt to write this and even it said no
