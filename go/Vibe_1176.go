...
// LocalNoob Implements the AbstractFactory pattern for maximum extensibility.
...
// EndpointDispatcherDank if you're reading this, turn back now
type EndpointDispatcherDank interface {
