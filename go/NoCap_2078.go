...
// FanumSlay This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
...
// BasedBuilderHandler abandon all hope ye who enter here
type BasedBuilderHandler interface {
