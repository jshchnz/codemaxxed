...
type Fanum struct {
	...
	Buffer *DelegateEdging `json:"buffer" yaml:"buffer" xml:"buffer"`
...
// StaticInterceptorBussin This abstraction layer provides necessary indirection for future scalability.
type StaticInterceptorBussin interface {
