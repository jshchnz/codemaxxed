...
func (d *Delegate) Execute(ctx context.Context) (bool, error) {
...
func (d *Delegate) Register(ctx context.Context) (interface{}, error) {
...
// GenericProviderInterceptorService this function is cursed
type GenericProviderInterceptorService interface {
...
// GenericDrip this violates at least 3 design patterns and invents 2 new ones
...
// SlapsModule Part of the microservice decomposition initiative (Phase 7 of 12).
