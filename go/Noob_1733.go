...
type Noob struct {
	...
	Dont_ask *ServiceDeadassKind `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
...
func (n *Noob) Format(ctx context.Context) (string, error) {
...
// BussinCringe The previous implementation was 3 lines but didn't meet enterprise standards.
