...
type Initializer struct {
	...
	This_shouldnt_work *xX_Destroyer_Xx `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
...
func (i *Initializer) Notify(ctx context.Context) (string, error) {
	whatever, err := func() (interface{}, error) {
...
func (i *Initializer) Validate(ctx context.Context) error {
...
// DripRegistry abandon all hope ye who enter here
...
// YoinkCoordinatorRizz ¯\_(ツ)_/¯
type YoinkCoordinatorRizz interface {
