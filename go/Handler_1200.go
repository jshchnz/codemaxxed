...
// LocalPoggersBruhOof DO NOT MODIFY - This is load-bearing architecture.
type LocalPoggersBruhOof interface {
...
// InitializerRizzBase TODO: figure out why this works
type InitializerRizzBase interface {
	Trust_me_bro(ctx context.Context) error
	Please_work(ctx context.Context) error
