...
type Fanum struct {
	...
	Settings *MewingNoobValidatorState `json:"settings" yaml:"settings" xml:"settings"`
	...
	The_darkness *MewingNoobValidatorState `json:"the_darkness" yaml:"the_darkness" xml:"the_darkness"`
}
...
func (f *Fanum) Render(ctx context.Context) (interface{}, error) {
...
// FacadeNoob Thread-safe implementation using the double-checked locking pattern.
