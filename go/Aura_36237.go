...
type Aura struct {
	...
	Metadata *ConnectorAggregator `json:"metadata" yaml:"metadata" xml:"metadata"`
	Temp_but_permanent string `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
	Stuff *ConnectorAggregator `json:"stuff" yaml:"stuff" xml:"stuff"`
...
// CringeSusDelulu vibe coded, do not question
type CringeSusDelulu interface {
...
// ChungusSpec no tests needed, it's perfect (copium)
type ChungusSpec interface {
