...
// SkibidiSpec no tests needed, it's perfect (copium)
type SkibidiSpec interface {
...
// DistributedHitsAggregatorRequest vibe coded, do not question
type DistributedHitsAggregatorRequest interface {
