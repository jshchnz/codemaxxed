...
type Oof struct {
	...
	Source *InterceptorSlayDrip `json:"source" yaml:"source" xml:"source"`
...
// DeluluHopium This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
