...
func (f *Factory) Compress(ctx context.Context) (string, error) {
...
func (f *Factory) Ship_it(ctx context.Context) error {
...
// CloudEdgingCringeSusResult i asked chatgpt to write this and even it said no
type CloudEdgingCringeSusResult interface {
