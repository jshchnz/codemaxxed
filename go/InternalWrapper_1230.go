...
// Format ¯\_(ツ)_/¯
func (i *InternalWrapper) Format(ctx context.Context) (interface{}, error) {
...
func (i *InternalWrapper) Trust_me_bro(ctx context.Context) (int, error) {
...
func (i *InternalWrapper) Do_the_thing(ctx context.Context) error {
...
func (i *InternalWrapper) Encrypt(ctx context.Context) (int, error) {
...
func (i *InternalWrapper) Cry(ctx context.Context) (int, error) {
...
// ServiceDrip TODO: figure out why this works
