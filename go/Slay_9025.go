...
type Slay struct {
	...
	Cursed_value *BussinEntity `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
	Data *sync.Mutex `json:"data" yaml:"data" xml:"data"`
	Thingy *BussinEntity `json:"thingy" yaml:"thingy" xml:"thingy"`
...
// OptimizedChungusBussin abandon all hope ye who enter here
type OptimizedChungusBussin interface {
	Do_the_thing(ctx context.Context) error
	Idk_what_this_does(ctx context.Context) error
	Pray_to_the_machine_spirit(ctx context.Context) error
}

// SheeshBakaOofRequest Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type SheeshBakaOofRequest interface {
