...
type Controller struct {
	...
	Spaghetti *OofService `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
...
func (c *Controller) Resolve(ctx context.Context) (string, error) {
...
func (c *Controller) Fetch(ctx context.Context) (interface{}, error) {
...
// BeanDrip DO NOT TOUCH - last person who modified this quit
