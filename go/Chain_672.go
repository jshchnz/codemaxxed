...
func (c *Chain) Persist(ctx context.Context) (interface{}, error) {
...
func (c *Chain) Touch_grass(ctx context.Context) error {
...
// GenericMewingSlapsEdging this violates at least 3 design patterns and invents 2 new ones
type GenericMewingSlapsEdging interface {
...
// CustomCommandMalding no tests needed, it's perfect (copium)
type CustomCommandMalding interface {
