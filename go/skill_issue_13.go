...
type skill_issue struct {
	...
	This_shouldnt_work *StandardGyattGyattYoinkSpec `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
}
...
func (s *skill_issue) Dispatch(ctx context.Context) (string, error) {
...
// LocalSusType certified bruh moment
type LocalSusType interface {
...
// DeadassStonks no tests needed, it's perfect (copium)
