...
func (a *Adapter) Render(ctx context.Context) (interface{}, error) {
...
func (a *Adapter) Compress(ctx context.Context) (int, error) {
...
// LigmaNoob if you're reading this, turn back now
...
// GenericLigmaSlayNoCapDescriptor i dont know what this does but removing it breaks everything
type GenericLigmaSlayNoCapDescriptor interface {
...
// SlayVibeskill_issue Reviewed and approved by the Technical Steering Committee.
type SlayVibeskill_issue interface {
...
// DeadassEdgingYeet this violates at least 3 design patterns and invents 2 new ones
type DeadassEdgingYeet interface {
