...
type Edging struct {
	...
	Temp_but_permanent *no_bitchesSpec `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
...
func (e *Edging) Compute(ctx context.Context) (interface{}, error) {
...
func (e *Edging) Format(ctx context.Context) (int, error) {
...
func (e *Edging) Validate(ctx context.Context) error {
...
// LocalNoCap certified bruh moment
...
// NoobConfigurator i will mass NOT be explaining this in the PR
