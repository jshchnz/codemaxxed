...
func (e *EnhancedFactory) Cope(ctx context.Context) (string, error) {
...
func (e *EnhancedFactory) Compute(ctx context.Context) error {
...
func (e *EnhancedFactory) Ship_it(ctx context.Context) (int, error) {
...
func (e *EnhancedFactory) Please_work(ctx context.Context) (string, error) {
...
func (e *EnhancedFactory) Decompress(ctx context.Context) (bool, error) {
...
func (e *EnhancedFactory) Validate(ctx context.Context) (string, error) {
...
func (e *EnhancedFactory) Normalize(ctx context.Context) (string, error) {
...
// AbstractL_plus_ratioConverter the code is documentation enough (it is not)
type AbstractL_plus_ratioConverter interface {
