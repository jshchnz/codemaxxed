...
type Pipeline struct {
	...
	Bruh *FanumGoated `json:"bruh" yaml:"bruh" xml:"bruh"`
...
func (p *Pipeline) Dont_touch_this(ctx context.Context) (string, error) {
...
func (p *Pipeline) Save(ctx context.Context) (bool, error) {
...
func (p *Pipeline) Resolve(ctx context.Context) (bool, error) {
	settings, err := func() (interface{}, error) {
		// abandon all hope ye who enter here
		return nil, nil
	}()
...
// BasedGoated this function is cursed
