...
type Griddy struct {
	...
	Context *VisitorRizz `json:"context" yaml:"context" xml:"context"`
	Bruh int64 `json:"bruh" yaml:"bruh" xml:"bruh"`
	State *VisitorRizz `json:"state" yaml:"state" xml:"state"`
...
func (g *Griddy) Authenticate(ctx context.Context) (interface{}, error) {
...
// CoreFacadeDelulu this is load-bearing spaghetti
...
// DripHitsDescriptor this function is cursed
type DripHitsDescriptor interface {
