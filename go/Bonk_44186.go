...
type Bonk struct {
	...
	Bruh *CloudRizzMiddlewareResult `json:"bruh" yaml:"bruh" xml:"bruh"`
	The_darkness int64 `json:"the_darkness" yaml:"the_darkness" xml:"the_darkness"`
	Xxx map[string]interface{} `json:"xxx" yaml:"xxx" xml:"xxx"`
	X chan struct{} `json:"x" yaml:"x" xml:"x"`
	Result *CloudRizzMiddlewareResult `json:"result" yaml:"result" xml:"result"`
...
func (b *Bonk) Notify(ctx context.Context) (interface{}, error) {
...
// BasedYoink past me was a different person and i dont trust them
...
// FanumLigma past me was a different person and i dont trust them
...
// EdgingVibeImpl the compiler demanded a blood sacrifice and this was it
type EdgingVibeImpl interface {
