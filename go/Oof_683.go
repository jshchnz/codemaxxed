...
func (o *Oof) Aggregate(ctx context.Context) (interface{}, error) {
...
// ChainOofCringe Part of the microservice decomposition initiative (Phase 7 of 12).
type ChainOofCringe interface {
...
// Sigmano_bitches TODO: figure out why this works
