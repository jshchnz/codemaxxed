...
// AbstractBakaBase Legacy code - here be dragons.
type AbstractBakaBase interface {
...
// GigachadCringe past me was a different person and i dont trust them
...
// MediatorMewingFanum the code is documentation enough (it is not)
type MediatorMewingFanum interface {
	Ship_it(ctx context.Context) error
