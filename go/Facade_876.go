...
type Facade struct {
	...
	Result *Orchestrator `json:"result" yaml:"result" xml:"result"`
...
func (f *Facade) Initialize(ctx context.Context) (string, error) {
...
func (f *Facade) Cache(ctx context.Context) (interface{}, error) {
...
func (f *Facade) Build(ctx context.Context) (int, error) {
...
func (f *Facade) Deserialize(ctx context.Context) (int, error) {
...
// CloudSus the mass of code grows. it hungers. it consumes.
...
// GriddyChainGyatt written at 3am, mass forgive me
type GriddyChainGyatt interface {
