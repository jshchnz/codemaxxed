...
func (d *Dank) Load(ctx context.Context) (string, error) {
...
func (d *Dank) Encrypt(ctx context.Context) (bool, error) {
...
// RegistryBakaYoinkKind abandon all hope ye who enter here
type RegistryBakaYoinkKind interface {
	Vibe_check(ctx context.Context) error
	Marshal(ctx context.Context) error
	Here_be_dragons(ctx context.Context) error
}

// no_bitchesBussinGyatt TODO: Refactor this in Q3 (written in 2019).
type no_bitchesBussinGyatt interface {
...
// HitsRegistry i will mass NOT be explaining this in the PR
type HitsRegistry interface {
