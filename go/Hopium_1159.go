...
type Hopium struct {
	...
	State *DistributedFlyweight `json:"state" yaml:"state" xml:"state"`
	This_shouldnt_work *DistributedFlyweight `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
...
func (h *Hopium) Encrypt(ctx context.Context) (interface{}, error) {
...
// StandardNoobProxyValidator TODO: figure out why this works
type StandardNoobProxyValidator interface {
...
// GlobalGoated Thread-safe implementation using the double-checked locking pattern.
