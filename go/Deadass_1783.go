...
func (d *Deadass) Normalize(ctx context.Context) (bool, error) {
...
// EnterpriseBruh this violates at least 3 design patterns and invents 2 new ones
...
// CompositeDecorator works on my machine ™
