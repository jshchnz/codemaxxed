...
// LegacyOofSkibidiEndpoint this function is cursed
type LegacyOofSkibidiEndpoint interface {
	Vibe_check(ctx context.Context) error
	Go_outside(ctx context.Context) error
	Works_on_my_machine(ctx context.Context) error
}

// ModernNoCapGooningManagerPair Part of the microservice decomposition initiative (Phase 7 of 12).
type ModernNoCapGooningManagerPair interface {
...
// StaticGriddyConverterSlaps abandon all hope ye who enter here
type StaticGriddyConverterSlaps interface {
