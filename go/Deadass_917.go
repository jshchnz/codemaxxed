...
func (d *Deadass) Build(ctx context.Context) (int, error) {
...
// DynamicStonks written at 3am, mass forgive me
...
// CloudOrchestratorDeadassStonks the mass of code grows. it hungers. it consumes.
type CloudOrchestratorDeadassStonks interface {
...
// StandardNoob TODO: Refactor this in Q3 (written in 2019).
