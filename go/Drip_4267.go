...
func (d *Drip) Serialize(ctx context.Context) (string, error) {
...
// GoatedRatioBonk if this breaks, blame the intern (there is no intern)
type GoatedRatioBonk interface {
...
// EnterpriseConfiguratorStonks Legacy code - here be dragons.
type EnterpriseConfiguratorStonks interface {
	Pray_to_the_machine_spirit(ctx context.Context) error
