...
// ModernSlayControllerContext this is load-bearing spaghetti
type ModernSlayControllerContext interface {
...
// StandardLigmaRepository Legacy code - here be dragons.
type StandardLigmaRepository interface {
	Vibe_check(ctx context.Context) error
