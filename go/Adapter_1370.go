...
func (a *Adapter) Vibe_check(ctx context.Context) (string, error) {
...
// Hitsno_bitchesConverterDescriptor Legacy code - here be dragons.
type Hitsno_bitchesConverterDescriptor interface {
...
// PoggersVisitor past me was a different person and i dont trust them
type PoggersVisitor interface {
