...
type Composite struct {
	...
	Bruh *Basedno_bitchesState `json:"bruh" yaml:"bruh" xml:"bruh"`
	Haunted_reference *Basedno_bitchesState `json:"haunted_reference" yaml:"haunted_reference" xml:"haunted_reference"`
...
// YeetStonksConfigurator DO NOT TOUCH - last person who modified this quit
type YeetStonksConfigurator interface {
	Lgtm(ctx context.Context) error
	Trust_me_bro(ctx context.Context) error
	Please_work(ctx context.Context) error
}

// EnterpriseRatio past me was a different person and i dont trust them
