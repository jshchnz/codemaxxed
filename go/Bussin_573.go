...
type Bussin struct {
	...
	Item *SerializerConverter `json:"item" yaml:"item" xml:"item"`
...
// GigachadMiddlewareObserver Conforms to ISO 27001 compliance requirements.
type GigachadMiddlewareObserver interface {
