...
type Skibidi struct {
	...
	Element *Decorator `json:"element" yaml:"element" xml:"element"`
...
// GatewayGyattno_bitches this violates at least 3 design patterns and invents 2 new ones
type GatewayGyattno_bitches interface {
