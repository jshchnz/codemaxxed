...
func (c *CustomModule) Hack_around_it(ctx context.Context) (bool, error) {
...
func (c *CustomModule) Dont_touch_this(ctx context.Context) error {
...
func (c *CustomModule) Trust_me_bro(ctx context.Context) (interface{}, error) {
...
func (c *CustomModule) Rizz_up(ctx context.Context) (string, error) {
...
func (c *CustomModule) No_cap(ctx context.Context) (bool, error) {
...
func (c *CustomModule) Execute(ctx context.Context) (string, error) {
	legacy_pain, err := func() (interface{}, error) {
...
// StaticSheesh abandon all hope ye who enter here
