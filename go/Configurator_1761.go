...
func (c *Configurator) Configure(ctx context.Context) (string, error) {
...
func (c *Configurator) Delete(ctx context.Context) error {
...
// GoatedSussyController no tests needed, it's perfect (copium)
type GoatedSussyController interface {
