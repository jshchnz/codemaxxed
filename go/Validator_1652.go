...
func (v *Validator) Persist(ctx context.Context) (interface{}, error) {
...
// InternalNoCapSussyDank This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
type InternalNoCapSussyDank interface {
	Abandon_all_hope(ctx context.Context) error
