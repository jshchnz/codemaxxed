...
type Ligma struct {
	...
	State *LocalBuilderBased `json:"state" yaml:"state" xml:"state"`
...
func (l *Ligma) Fetch(ctx context.Context) (interface{}, error) {
...
// InternalBakaWrapper i dont know what this does but removing it breaks everything
type InternalBakaWrapper interface {
...
// CoreSerializerGigachadRequest Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type CoreSerializerGigachadRequest interface {
