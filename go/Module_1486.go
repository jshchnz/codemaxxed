...
type Module struct {
	...
	Xx *Stonks `json:"xx" yaml:"xx" xml:"xx"`
...
func (m *Module) Notify(ctx context.Context) (bool, error) {
...
// SusSingletonYoink if this breaks, blame the intern (there is no intern)
type SusSingletonYoink interface {
...
// ChungusGlizzyHelper works on my machine ™
type ChungusGlizzyHelper interface {
	Here_be_dragons(ctx context.Context) error
