...
type Adapter struct {
	...
	Source *ModernSussy `json:"source" yaml:"source" xml:"source"`
	...
	Xx *ModernSussy `json:"xx" yaml:"xx" xml:"xx"`
}
...
func (a *Adapter) Idk_what_this_does(ctx context.Context) error {
...
func (a *Adapter) Authorize(ctx context.Context) (interface{}, error) {
...
func (a *Adapter) Cache(ctx context.Context) (string, error) {
...
// SheeshLigmaComponent certified bruh moment
type SheeshLigmaComponent interface {
...
// SlapsBussinState TODO: figure out why this works
type SlapsBussinState interface {
