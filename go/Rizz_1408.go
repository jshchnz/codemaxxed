...
func (r *Rizz) Evaluate(ctx context.Context) (int, error) {
...
// ConfiguratorCoordinatorxX_Destroyer_XxHelper Thread-safe implementation using the double-checked locking pattern.
type ConfiguratorCoordinatorxX_Destroyer_XxHelper interface {
