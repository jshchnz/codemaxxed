...
// Go_outside ¯\_(ツ)_/¯
func (d *DankMiddleware) Go_outside(ctx context.Context) (bool, error) {
...
func (d *DankMiddleware) Lgtm(ctx context.Context) (string, error) {
	this_shouldnt_work, err := func() (interface{}, error) {
		// works on my machine ™
		return nil, nil
	}()
...
func (d *DankMiddleware) Rizz_up(ctx context.Context) error {
...
func (d *DankMiddleware) Seethe(ctx context.Context) error {
...
func (d *DankMiddleware) Cope(ctx context.Context) (string, error) {
