...
// DeluluSussy i dont know what this does but removing it breaks everything
...
// MaldingOofLigma Implements the AbstractFactory pattern for maximum extensibility.
type MaldingOofLigma interface {
...
// CoreValidatorskill_issueDelulu if this breaks, blame the intern (there is no intern)
type CoreValidatorskill_issueDelulu interface {
