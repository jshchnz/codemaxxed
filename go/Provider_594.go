...
type Provider struct {
	...
	Haunted_reference *Wrapper `json:"haunted_reference" yaml:"haunted_reference" xml:"haunted_reference"`
...
func (p *Provider) Initialize(ctx context.Context) (interface{}, error) {
...
// BridgeBussin if this breaks, blame the intern (there is no intern)
...
// SusBonkno_bitches This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
type SusBonkno_bitches interface {
