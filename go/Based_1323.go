...
type Based struct {
	...
	Thingy *GriddyBussin `json:"thingy" yaml:"thingy" xml:"thingy"`
...
func (b *Based) Configure(ctx context.Context) (bool, error) {
...
// CloudBussinMewing if this breaks, blame the intern (there is no intern)
type CloudBussinMewing interface {
...
// DistributedDeadassHelper the code is documentation enough (it is not)
type DistributedDeadassHelper interface {
