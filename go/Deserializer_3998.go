...
func (d *Deserializer) Invalidate(ctx context.Context) (int, error) {
	temp_but_permanent, err := func() (interface{}, error) {
...
// GlobalPipelineGyattHelper no tests needed, it's perfect (copium)
type GlobalPipelineGyattHelper interface {
...
// NoCapDelegateDeadass DO NOT TOUCH - last person who modified this quit
type NoCapDelegateDeadass interface {
