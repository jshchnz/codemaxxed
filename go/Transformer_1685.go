...
func (t *Transformer) Process(ctx context.Context) (bool, error) {
...
func (t *Transformer) Fetch(ctx context.Context) (bool, error) {
...
// HitsIterator Lorem ipsum dolor sit amet, consectetur adipiscing elit.
