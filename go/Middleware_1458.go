...
type Middleware struct {
	...
	Whatever *DefaultDeserializer `json:"whatever" yaml:"whatever" xml:"whatever"`
...
func (m *Middleware) Cache(ctx context.Context) (bool, error) {
...
// NoCapHelper Optimized for enterprise-grade throughput.
type NoCapHelper interface {
...
// AbstractSlapsConfiguratorDelulu skill issue if you can't read this
type AbstractSlapsConfiguratorDelulu interface {
...
// CringeChain this violates at least 3 design patterns and invents 2 new ones
type CringeChain interface {
