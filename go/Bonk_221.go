...
// StandardSerializerProvider the code is documentation enough (it is not)
type StandardSerializerProvider interface {
	Deserialize(ctx context.Context) error
	Works_on_my_machine(ctx context.Context) error
	Yeet(ctx context.Context) error
}

// MiddlewareRequest DO NOT MODIFY - This is load-bearing architecture.
