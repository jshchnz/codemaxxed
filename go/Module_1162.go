...
func (m *Module) Configure(ctx context.Context) (interface{}, error) {
	the_darkness, err := func() (interface{}, error) {
		// abandon all hope ye who enter here
		return nil, nil
	}()
...
// Rizzskill_issueGriddyRequest written at 3am, mass forgive me
type Rizzskill_issueGriddyRequest interface {
...
// RegistryBased Legacy code - here be dragons.
