...
func (f *Factory) Format(ctx context.Context) (int, error) {
...
// BaseCopiumDescriptor skill issue if you can't read this
type BaseCopiumDescriptor interface {
...
// RatioBonk written at 3am, mass forgive me
