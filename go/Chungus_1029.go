...
type Chungus struct {
	...
	Thingy *StaticRatioState `json:"thingy" yaml:"thingy" xml:"thingy"`
...
func (c *Chungus) Compute(ctx context.Context) error {
...
// EnterpriseCompositeType Conforms to ISO 27001 compliance requirements.
type EnterpriseCompositeType interface {
...
// GyattCringe skill issue if you can't read this
...
// FlyweightWrapper i will mass NOT be explaining this in the PR
type FlyweightWrapper interface {
