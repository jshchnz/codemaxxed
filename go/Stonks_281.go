...
func (s *Stonks) Notify(ctx context.Context) (interface{}, error) {
...
func (s *Stonks) Build(ctx context.Context) (string, error) {
...
// LegacyRatioAdapterPoggers this function is cursed
type LegacyRatioAdapterPoggers interface {
...
// FacadeEdgingNoob Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type FacadeEdgingNoob interface {
...
// Converterskill_issue abandon all hope ye who enter here
type Converterskill_issue interface {
