...
type Component struct {
	...
	Legacy_pain *FlyweightSusModel `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
	...
	Record *FlyweightSusModel `json:"record" yaml:"record" xml:"record"`
...
func (c *Component) No_cap(ctx context.Context) (string, error) {
...
// ModernNoCapMiddlewareGooning TODO: figure out why this works
type ModernNoCapMiddlewareGooning interface {
...
// GriddyFlyweightMewing ¯\_(ツ)_/¯
type GriddyFlyweightMewing interface {
...
// LocalOof if this breaks, blame the intern (there is no intern)
