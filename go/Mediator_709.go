...
func (m *Mediator) Transform(ctx context.Context) (int, error) {
...
// PrototypeBonkImpl the mass of code grows. it hungers. it consumes.
type PrototypeBonkImpl interface {
