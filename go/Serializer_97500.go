...
func (s *Serializer) Lgtm(ctx context.Context) (string, error) {
...
func (s *Serializer) Notify(ctx context.Context) (int, error) {
...
// DefaultCringeYoink Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type DefaultCringeYoink interface {
