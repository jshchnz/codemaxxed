...
// GenericValidatorMediator i will mass NOT be explaining this in the PR
type GenericValidatorMediator interface {
	Unmarshal(ctx context.Context) error
	Dont_touch_this(ctx context.Context) error
	Yoink(ctx context.Context) error
}

// GooningDripMapperDefinition i asked chatgpt to write this and even it said no
type GooningDripMapperDefinition interface {
