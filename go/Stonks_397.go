...
type Stonks struct {
	...
	Target *DripLigma `json:"target" yaml:"target" xml:"target"`
	Haunted_reference float64 `json:"haunted_reference" yaml:"haunted_reference" xml:"haunted_reference"`
	Request int64 `json:"request" yaml:"request" xml:"request"`
	Payload string `json:"payload" yaml:"payload" xml:"payload"`
	Cursed_value error `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
	Legacy_pain *DripLigma `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
...
// FanumPoggersSheesh i dont know what this does but removing it breaks everything
type FanumPoggersSheesh interface {
	Seethe(ctx context.Context) error
