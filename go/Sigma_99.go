...
func (s *Sigma) Compress(ctx context.Context) error {
...
// AbstractSlayAuraCopium i will mass NOT be explaining this in the PR
type AbstractSlayAuraCopium interface {
