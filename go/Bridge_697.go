...
func (b *Bridge) Cry(ctx context.Context) (string, error) {
...
// GenericBuilderHelper Conforms to ISO 27001 compliance requirements.
type GenericBuilderHelper interface {
