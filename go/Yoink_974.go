...
func (y *Yoink) Convert(ctx context.Context) (string, error) {
...
// StandardInterceptorSusDrip TODO: Refactor this in Q3 (written in 2019).
type StandardInterceptorSusDrip interface {
...
// DynamicRatioHopium Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type DynamicRatioHopium interface {
