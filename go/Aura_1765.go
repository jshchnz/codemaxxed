...
type Aura struct {
	...
	Cursed_value *EdgingOofBased `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
...
// EdgingOhio the code is documentation enough (it is not)
type EdgingOhio interface {
...
// RatioMapper TODO: Refactor this in Q3 (written in 2019).
