...
func (d *Deserializer) Dispatch(ctx context.Context) error {
...
func (d *Deserializer) Handle(ctx context.Context) (string, error) {
...
// GooningSpec Legacy code - here be dragons.
...
// GigachadValidator certified bruh moment
