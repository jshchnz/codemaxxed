...
type Dank struct {
	...
	This_shouldnt_work *GlobalGooningOhioNoob `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
	...
	Xxx *GlobalGooningOhioNoob `json:"xxx" yaml:"xxx" xml:"xxx"`
...
// VibeGoatedController no tests needed, it's perfect (copium)
type VibeGoatedController interface {
...
// OptimizedCopiumObserverException if you're reading this, turn back now
type OptimizedCopiumObserverException interface {
	Cry(ctx context.Context) error
	Dont_touch_this(ctx context.Context) error
	No_cap(ctx context.Context) error
}

// DefaultYeet i dont know what this does but removing it breaks everything
