...
func (s *Singleton) Transform(ctx context.Context) (string, error) {
...
// GenericPoggersHopium certified bruh moment
type GenericPoggersHopium interface {
...
// CringeBased written at 3am, mass forgive me
...
// StaticPoggersEdging if you're reading this, turn back now
type StaticPoggersEdging interface {
