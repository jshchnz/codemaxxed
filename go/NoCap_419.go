...
func (n *NoCap) Aggregate(ctx context.Context) (int, error) {
...
func (n *NoCap) Process(ctx context.Context) (int, error) {
...
// YoinkProviderSpec ¯\_(ツ)_/¯
type YoinkProviderSpec interface {
...
// LegacyChungus i asked chatgpt to write this and even it said no
