...
type Chungus struct {
	...
	Tech_debt *DripSkibidiVisitor `json:"tech_debt" yaml:"tech_debt" xml:"tech_debt"`
	...
	Yolo_var *DripSkibidiVisitor `json:"yolo_var" yaml:"yolo_var" xml:"yolo_var"`
}
...
func (c *Chungus) Parse(ctx context.Context) error {
...
func (c *Chungus) Save(ctx context.Context) (bool, error) {
...
// ModuleProcessor this is load-bearing spaghetti
