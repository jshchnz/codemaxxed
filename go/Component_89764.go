...
type Component struct {
	Node *Noob `json:"node" yaml:"node" xml:"node"`
...
func (c *Component) Build(ctx context.Context) (string, error) {
...
func (c *Component) Authorize(ctx context.Context) (string, error) {
...
func (c *Component) Notify(ctx context.Context) (interface{}, error) {
