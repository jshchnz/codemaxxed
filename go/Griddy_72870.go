...
type Griddy struct {
	...
	Entry *SigmaState `json:"entry" yaml:"entry" xml:"entry"`
...
// RatioMaldingValue if this breaks, blame the intern (there is no intern)
type RatioMaldingValue interface {
...
// GenericGatewayValidator this function is cursed
type GenericGatewayValidator interface {
	Sacrifice_to_the_compiler(ctx context.Context) error
