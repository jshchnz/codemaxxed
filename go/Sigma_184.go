...
type Sigma struct {
	...
	Payload *BussinSigmaProvider `json:"payload" yaml:"payload" xml:"payload"`
...
// DynamicSlapsStonksSussy if you're reading this, turn back now
type DynamicSlapsStonksSussy interface {
...
// DelegateL_plus_ratioBuilder Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type DelegateL_plus_ratioBuilder interface {
...
// Oofno_bitchesSlapsValue i will mass NOT be explaining this in the PR
type Oofno_bitchesSlapsValue interface {
