...
func (p *Pipeline) Compress(ctx context.Context) error {
...
// IteratorMaldingCringe This was the simplest solution after 6 months of design review.
type IteratorMaldingCringe interface {
	Hack_around_it(ctx context.Context) error
	Trust_me_bro(ctx context.Context) error
	Works_on_my_machine(ctx context.Context) error
}

// ChungusModuleService written at 3am, mass forgive me
type ChungusModuleService interface {
	Trust_me_bro(ctx context.Context) error
...
// SlapsDankBase Implements the AbstractFactory pattern for maximum extensibility.
type SlapsDankBase interface {
