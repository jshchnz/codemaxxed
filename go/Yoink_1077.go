...
func (y *Yoink) Register(ctx context.Context) (interface{}, error) {
...
// AuraSussyComponent Part of the microservice decomposition initiative (Phase 7 of 12).
type AuraSussyComponent interface {
...
// SusFacadeBonk i will mass NOT be explaining this in the PR
type SusFacadeBonk interface {
	Here_be_dragons(ctx context.Context) error
