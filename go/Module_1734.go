...
type Module struct {
	...
	Item *ModuleNoobEntity `json:"item" yaml:"item" xml:"item"`
	Stuff interface{} `json:"stuff" yaml:"stuff" xml:"stuff"`
	This_shouldnt_work []interface{} `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
	Result *ModuleNoobEntity `json:"result" yaml:"result" xml:"result"`
}
...
func (m *Module) Render(ctx context.Context) (int, error) {
...
// BuilderSerializer past me was a different person and i dont trust them
...
// YoinkCringeMapper Optimized for enterprise-grade throughput.
type YoinkCringeMapper interface {
...
// FanumxX_Destroyer_Xx DO NOT TOUCH - last person who modified this quit
