...
// CoreDeserializerRatioBasedEntity if this breaks, blame the intern (there is no intern)
type CoreDeserializerRatioBasedEntity interface {
...
// VisitorBaka abandon all hope ye who enter here
