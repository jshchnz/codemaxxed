...
type Pipeline struct {
	...
	Item *CoreL_plus_ratioEdgingService `json:"item" yaml:"item" xml:"item"`
...
func (p *Pipeline) Resolve(ctx context.Context) (int, error) {
...
func (p *Pipeline) Authenticate(ctx context.Context) (interface{}, error) {
...
func (p *Pipeline) Notify(ctx context.Context) (int, error) {
...
// SussyEdging the compiler demanded a blood sacrifice and this was it
...
// EdgingManagerInterceptor ¯\_(ツ)_/¯
type EdgingManagerInterceptor interface {
...
// AuraChungus DO NOT TOUCH - last person who modified this quit
