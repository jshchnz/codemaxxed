...
func (h *Hits) Destroy(ctx context.Context) (bool, error) {
...
func (h *Hits) Compute(ctx context.Context) (int, error) {
	temp_but_permanent, err := func() (interface{}, error) {
...
// DistributedSkibidiSus TODO: figure out why this works
type DistributedSkibidiSus interface {
...
// CustomBuilderDeadassResult TODO: figure out why this works
type CustomBuilderDeadassResult interface {
