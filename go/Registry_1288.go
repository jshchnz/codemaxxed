...
// OhioEdgingBruh i asked chatgpt to write this and even it said no
type OhioEdgingBruh interface {
...
// GenericEndpointError no tests needed, it's perfect (copium)
type GenericEndpointError interface {
