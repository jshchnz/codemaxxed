...
type Cringe struct {
	...
	Spaghetti *WrapperAuraSigma `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
...
func (c *Cringe) Fetch(ctx context.Context) (int, error) {
...
// CompositeMewingGlizzyEntity past me was a different person and i dont trust them
type CompositeMewingGlizzyEntity interface {
