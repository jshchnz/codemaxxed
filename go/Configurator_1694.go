...
type Configurator struct {
	...
	Xx *SusHopiumGigachadRecord `json:"xx" yaml:"xx" xml:"xx"`
	...
	Entry *SusHopiumGigachadRecord `json:"entry" yaml:"entry" xml:"entry"`
}
...
func (c *Configurator) Normalize(ctx context.Context) (interface{}, error) {
...
func (c *Configurator) Build(ctx context.Context) (interface{}, error) {
