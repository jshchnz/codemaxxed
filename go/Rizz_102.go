...
type Rizz struct {
	...
	Dont_ask *DynamicConnectorOof `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
	Cursed_value interface{} `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
	Temp_but_permanent bool `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
	Whatever *DynamicConnectorOof `json:"whatever" yaml:"whatever" xml:"whatever"`
...
func (r *Rizz) Save(ctx context.Context) error {
...
func (r *Rizz) Todo_fix_later(ctx context.Context) (bool, error) {
	settings, err := func() (interface{}, error) {
		// i asked chatgpt to write this and even it said no
		return nil, nil
	}()
...
// CompositeInterface i dont know what this does but removing it breaks everything
...
// BasedOof Thread-safe implementation using the double-checked locking pattern.
...
// InternalEndpoint abandon all hope ye who enter here
