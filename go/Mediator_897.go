...
func (m *Mediator) Invalidate(ctx context.Context) (string, error) {
...
func (m *Mediator) Evaluate(ctx context.Context) (string, error) {
...
// AbstractNoCapCopium if this breaks, blame the intern (there is no intern)
type AbstractNoCapCopium interface {
...
// FanumGlizzy this violates at least 3 design patterns and invents 2 new ones
