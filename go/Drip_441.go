...
// CoreResolverVisitorConfigurator written at 3am, mass forgive me
type CoreResolverVisitorConfigurator interface {
	Format(ctx context.Context) error
	Ship_it(ctx context.Context) error
	Cope(ctx context.Context) error
}

// OptimizedHitsSigma this is load-bearing spaghetti
