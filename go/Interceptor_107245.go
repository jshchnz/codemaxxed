...
func (i *Interceptor) Todo_fix_later(ctx context.Context) (interface{}, error) {
...
// RizzProviderSussy this violates at least 3 design patterns and invents 2 new ones
type RizzProviderSussy interface {
...
// HopiumMiddlewareTransformer this is load-bearing spaghetti
type HopiumMiddlewareTransformer interface {
	Todo_fix_later(ctx context.Context) error
	Go_outside(ctx context.Context) error
