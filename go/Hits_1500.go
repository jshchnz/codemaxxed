...
type Hits struct {
	...
	Temp_but_permanent *StandardL_plus_ratioLigma `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
...
func (h *Hits) Execute(ctx context.Context) (bool, error) {
...
// ProviderSlapsDelulu Implements the AbstractFactory pattern for maximum extensibility.
type ProviderSlapsDelulu interface {
