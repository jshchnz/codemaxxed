...
type Bruh struct {
	...
	Whatever *FacadeBakaCringeState `json:"whatever" yaml:"whatever" xml:"whatever"`
...
func (b *Bruh) Serialize(ctx context.Context) (interface{}, error) {
...
func (b *Bruh) Load(ctx context.Context) (int, error) {
...
func (b *Bruh) Fetch(ctx context.Context) error {
...
func (b *Bruh) Update(ctx context.Context) (string, error) {
...
func (b *Bruh) Destroy(ctx context.Context) (bool, error) {
...
// CloudSigmaGoatedRequest i will mass NOT be explaining this in the PR
type CloudSigmaGoatedRequest interface {
