...
// ScalableGigachadHandler this violates at least 3 design patterns and invents 2 new ones
type ScalableGigachadHandler interface {
	Todo_fix_later(ctx context.Context) error
	Yoink(ctx context.Context) error
	Here_be_dragons(ctx context.Context) error
}

// TransformerSpec skill issue if you can't read this
type TransformerSpec interface {
	Do_the_thing(ctx context.Context) error
