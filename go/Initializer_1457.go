...
type Initializer struct {
	...
	Spaghetti *EdgingRequest `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
	...
	Entry *EdgingRequest `json:"entry" yaml:"entry" xml:"entry"`
...
func (i *Initializer) Marshal(ctx context.Context) (string, error) {
...
func (i *Initializer) Save(ctx context.Context) (interface{}, error) {
...
// Sussyno_bitchesHelper written at 3am, mass forgive me
type Sussyno_bitchesHelper interface {
...
// ServiceSkibidi i dont know what this does but removing it breaks everything
