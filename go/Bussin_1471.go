...
// NoCapBasedComposite Per the architecture review board decision ARB-2847.
type NoCapBasedComposite interface {
...
// LigmaBruhOrchestrator ¯\_(ツ)_/¯
type LigmaBruhOrchestrator interface {
	Do_the_thing(ctx context.Context) error
...
// ConnectorAuraskill_issue the compiler demanded a blood sacrifice and this was it
type ConnectorAuraskill_issue interface {
	Do_the_thing(ctx context.Context) error
