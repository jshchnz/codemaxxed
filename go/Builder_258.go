...
// DynamicChain no tests needed, it's perfect (copium)
type DynamicChain interface {
...
// SkibidiSusSigma i dont know what this does but removing it breaks everything
type SkibidiSusSigma interface {
...
// DripAura Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
