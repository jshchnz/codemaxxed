...
type NoCap struct {
	...
	God_object *YoinkDeserializerError `json:"god_object" yaml:"god_object" xml:"god_object"`
	...
	Count *YoinkDeserializerError `json:"count" yaml:"count" xml:"count"`
...
func (n *NoCap) Destroy(ctx context.Context) (string, error) {
...
func (n *NoCap) Encrypt(ctx context.Context) (int, error) {
...
func (n *NoCap) Register(ctx context.Context) (string, error) {
...
// AbstractCoordinatorno_bitches the code is documentation enough (it is not)
type AbstractCoordinatorno_bitches interface {
