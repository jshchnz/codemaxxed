...
func (s *Serializer) Execute(ctx context.Context) (string, error) {
...
// ScalableOhioGateway if you're reading this, turn back now
type ScalableOhioGateway interface {
...
// StonksStonks if you're reading this, turn back now
...
// ProxyMaldingWrapper This is a critical path component - do not remove without VP approval.
type ProxyMaldingWrapper interface {
