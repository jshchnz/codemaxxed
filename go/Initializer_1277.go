...
type Initializer struct {
	...
	Reference *YeetEdgingInterface `json:"reference" yaml:"reference" xml:"reference"`
...
// Load ¯\_(ツ)_/¯
func (i *Initializer) Load(ctx context.Context) (int, error) {
...
func (i *Initializer) Validate(ctx context.Context) (string, error) {
...
// ModuleBaka the compiler demanded a blood sacrifice and this was it
...
// DefaultGooning skill issue if you can't read this
