...
type Endpoint struct {
	...
	Forbidden_knowledge *YoinkStrategy `json:"forbidden_knowledge" yaml:"forbidden_knowledge" xml:"forbidden_knowledge"`
	It_lives interface{} `json:"it_lives" yaml:"it_lives" xml:"it_lives"`
	Legacy_pain int64 `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
	Stuff func() error `json:"stuff" yaml:"stuff" xml:"stuff"`
	Thingy *YoinkStrategy `json:"thingy" yaml:"thingy" xml:"thingy"`
...
func (e *Endpoint) Decompress(ctx context.Context) error {
...
func (e *Endpoint) Render(ctx context.Context) error {
...
func (e *Endpoint) Dispatch(ctx context.Context) (string, error) {
...
// L_plus_ratioSheeshBonk this is load-bearing spaghetti
type L_plus_ratioSheeshBonk interface {
...
// CustomBussinOhio past me was a different person and i dont trust them
