...
// ChainMaldingskill_issueModel the code is documentation enough (it is not)
type ChainMaldingskill_issueModel interface {
...
// GenericCommandBeanPoggers past me was a different person and i dont trust them
type GenericCommandBeanPoggers interface {
