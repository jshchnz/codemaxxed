...
func (e *Edging) Fetch(ctx context.Context) (int, error) {
...
// ResolverLigma written at 3am, mass forgive me
...
// Decoratorno_bitches Thread-safe implementation using the double-checked locking pattern.
