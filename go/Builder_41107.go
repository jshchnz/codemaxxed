...
func (b *Builder) Pray_to_the_machine_spirit(ctx context.Context) error {
...
func (b *Builder) Delete(ctx context.Context) (string, error) {
...
func (b *Builder) Serialize(ctx context.Context) (int, error) {
