...
// works on my machine ™
type Vibe struct {
	Data *DeluluConfigurator `json:"data" yaml:"data" xml:"data"`
	Temp_but_permanent error `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
	Forbidden_knowledge *DeluluConfigurator `json:"forbidden_knowledge" yaml:"forbidden_knowledge" xml:"forbidden_knowledge"`
...
// DeserializerVisitorMewing skill issue if you can't read this
type DeserializerVisitorMewing interface {
	Lgtm(ctx context.Context) error
