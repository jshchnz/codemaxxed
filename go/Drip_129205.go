...
func (d *Drip) Parse(ctx context.Context) (int, error) {
...
// GlizzyOof this is load-bearing spaghetti
...
// YeetRizzMediatorRequest abandon all hope ye who enter here
type YeetRizzMediatorRequest interface {
