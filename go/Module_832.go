...
type Module struct {
	...
	Cache_entry *GlizzyGriddy `json:"cache_entry" yaml:"cache_entry" xml:"cache_entry"`
...
func (m *Module) Cache(ctx context.Context) (bool, error) {
...
// ManagerSkibidi certified bruh moment
