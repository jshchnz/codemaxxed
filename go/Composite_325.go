...
func (c *Composite) Denormalize(ctx context.Context) (string, error) {
...
func (c *Composite) Persist(ctx context.Context) (string, error) {
...
func (c *Composite) Serialize(ctx context.Context) error {
