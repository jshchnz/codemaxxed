...
func (w *Wrapper) Persist(ctx context.Context) (interface{}, error) {
...
// BussinInitializer DO NOT TOUCH - last person who modified this quit
...
// CopiumGlizzyError written at 3am, mass forgive me
type CopiumGlizzyError interface {
...
// BaseChungusValue if this breaks, blame the intern (there is no intern)
type BaseChungusValue interface {
