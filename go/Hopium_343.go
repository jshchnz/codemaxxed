...
func (h *Hopium) Pray_to_the_machine_spirit(ctx context.Context) (string, error) {
...
// DefaultFlyweightSkibidi TODO: figure out why this works
type DefaultFlyweightSkibidi interface {
...
// ProviderCopium i will mass NOT be explaining this in the PR
type ProviderCopium interface {
