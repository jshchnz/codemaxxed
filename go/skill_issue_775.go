...
func (s *skill_issue) Compute(ctx context.Context) error {
...
// ModernSerializerNoobUtil past me was a different person and i dont trust them
type ModernSerializerNoobUtil interface {
...
// DynamicOhioDelegateSussy i dont know what this does but removing it breaks everything
type DynamicOhioDelegateSussy interface {
