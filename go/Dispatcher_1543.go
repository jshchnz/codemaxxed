...
func (d *Dispatcher) Dont_touch_this(ctx context.Context) (string, error) {
	whatever, err := func() (interface{}, error) {
...
func (d *Dispatcher) Compute(ctx context.Context) (int, error) {
...
// LegacyMiddlewareContext ¯\_(ツ)_/¯
type LegacyMiddlewareContext interface {
