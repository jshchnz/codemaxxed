...
type Slay struct {
	...
	Element *DeserializerUtils `json:"element" yaml:"element" xml:"element"`
...
func (s *Slay) Cache(ctx context.Context) (string, error) {
...
// EdgingBonkSpec this is load-bearing spaghetti
type EdgingBonkSpec interface {
...
// L_plus_ratioDeserializer ¯\_(ツ)_/¯
