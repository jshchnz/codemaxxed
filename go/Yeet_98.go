...
func (y *Yeet) Sync(ctx context.Context) (bool, error) {
...
func (y *Yeet) Authorize(ctx context.Context) (interface{}, error) {
...
// ChungusCopiumStonks i will mass NOT be explaining this in the PR
type ChungusCopiumStonks interface {
...
// SussyLigmaRatio if you're reading this, turn back now
