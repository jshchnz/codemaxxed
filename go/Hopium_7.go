...
// CustomGoatedEndpoint i will mass NOT be explaining this in the PR
type CustomGoatedEndpoint interface {
...
// OrchestratorConfigurator This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
