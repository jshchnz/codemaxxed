...
func (n *Noob) Format(ctx context.Context) (interface{}, error) {
...
func (n *Noob) Update(ctx context.Context) error {
...
// CopiumNoob skill issue if you can't read this
...
// YoinkEdgingRequest Reviewed and approved by the Technical Steering Committee.
type YoinkEdgingRequest interface {
