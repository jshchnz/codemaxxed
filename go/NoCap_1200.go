...
type NoCap struct {
	...
	Params *HandlerSigmaHits `json:"params" yaml:"params" xml:"params"`
	...
	Metadata *HandlerSigmaHits `json:"metadata" yaml:"metadata" xml:"metadata"`
}
...
// InitializerNoob Part of the microservice decomposition initiative (Phase 7 of 12).
type InitializerNoob interface {
...
// RatioMaldingContext works on my machine ™
type RatioMaldingContext interface {
	Create(ctx context.Context) error
	Touch_grass(ctx context.Context) error
	Dont_touch_this(ctx context.Context) error
}

// LegacyInitializer This abstraction layer provides necessary indirection for future scalability.
