...
type Manager struct {
	...
	Xx *GigachadSlayRequest `json:"xx" yaml:"xx" xml:"xx"`
...
// CustomBussinGlizzyConverter Legacy code - here be dragons.
type CustomBussinGlizzyConverter interface {
...
// CringeProcessorModel works on my machine ™
type CringeProcessorModel interface {
