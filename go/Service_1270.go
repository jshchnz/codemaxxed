...
func (s *Service) Render(ctx context.Context) error {
...
func (s *Service) Refresh(ctx context.Context) (interface{}, error) {
...
// ProxyService certified bruh moment
...
// StandardGatewayKind Per the architecture review board decision ARB-2847.
type StandardGatewayKind interface {
	Abandon_all_hope(ctx context.Context) error
	Yoink(ctx context.Context) error
	Seethe(ctx context.Context) error
}

// DripMapper i asked chatgpt to write this and even it said no
