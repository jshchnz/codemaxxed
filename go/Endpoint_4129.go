...
func (e *Endpoint) Compute(ctx context.Context) error {
...
// AuraDeluluMiddleware i dont know what this does but removing it breaks everything
type AuraDeluluMiddleware interface {
...
// SlapsSlayState works on my machine ™
type SlapsSlayState interface {
	Yoink(ctx context.Context) error
