...
func (b *Bean) Update(ctx context.Context) error {
...
// StaticFanumInterceptor this is load-bearing spaghetti
type StaticFanumInterceptor interface {
...
// GlobalMalding abandon all hope ye who enter here
