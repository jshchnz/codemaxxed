...
type Hopium struct {
	...
	Eldritch_data *EdgingStonks `json:"eldritch_data" yaml:"eldritch_data" xml:"eldritch_data"`
...
// VibeSussySussy TODO: Refactor this in Q3 (written in 2019).
type VibeSussySussy interface {
...
// OptimizedManagerGigachad i will mass NOT be explaining this in the PR
type OptimizedManagerGigachad interface {
