...
type Bruh struct {
	...
	Metadata *ConverterOhioMediatorImpl `json:"metadata" yaml:"metadata" xml:"metadata"`
...
func (b *Bruh) Convert(ctx context.Context) (string, error) {
...
func (b *Bruh) Execute(ctx context.Context) error {
...
func (b *Bruh) Marshal(ctx context.Context) (bool, error) {
...
// LegacyLigmaMiddleware this violates at least 3 design patterns and invents 2 new ones
...
// MiddlewareConfig no tests needed, it's perfect (copium)
