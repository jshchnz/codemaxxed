...
type Gooning struct {
	...
	Payload *AbstractGatewayIteratorRatio `json:"payload" yaml:"payload" xml:"payload"`
	Haunted_reference error `json:"haunted_reference" yaml:"haunted_reference" xml:"haunted_reference"`
	This_shouldnt_work func() error `json:"this_shouldnt_work" yaml:"this_shouldnt_work" xml:"this_shouldnt_work"`
	Spaghetti chan struct{} `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
	Response *AbstractGatewayIteratorRatio `json:"response" yaml:"response" xml:"response"`
}
...
// ServiceRatioWrapper DO NOT TOUCH - last person who modified this quit
type ServiceRatioWrapper interface {
...
// ModernAggregator this violates at least 3 design patterns and invents 2 new ones
