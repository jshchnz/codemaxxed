...
type Serializer struct {
	...
	Idk *SlapsBuilderGigachad `json:"idk" yaml:"idk" xml:"idk"`
...
func (s *Serializer) Decrypt(ctx context.Context) (bool, error) {
...
// CloudNoobConfig no tests needed, it's perfect (copium)
type CloudNoobConfig interface {
