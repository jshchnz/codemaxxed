...
type Slay struct {
	...
	Input_data *BussinOof `json:"input_data" yaml:"input_data" xml:"input_data"`
...
// ControllerStonks works on my machine ™
type ControllerStonks interface {
...
// SingletonLigmaChainError certified bruh moment
type SingletonLigmaChainError interface {
	Sanitize(ctx context.Context) error
