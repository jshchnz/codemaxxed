...
func (c *Configurator) Decrypt(ctx context.Context) (string, error) {
...
// MewingOofRegistry Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type MewingOofRegistry interface {
