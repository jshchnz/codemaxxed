...
func (s *Sus) Delete(ctx context.Context) (string, error) {
	x, err := func() (interface{}, error) {
...
// DeluluNoobDefinition i will mass NOT be explaining this in the PR
type DeluluNoobDefinition interface {
...
// SussyVibeEdging abandon all hope ye who enter here
type SussyVibeEdging interface {
	Lgtm(ctx context.Context) error
	Cry(ctx context.Context) error
