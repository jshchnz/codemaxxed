...
func (d *Delulu) Serialize(ctx context.Context) error {
...
func (d *Delulu) Parse(ctx context.Context) (interface{}, error) {
...
func (d *Delulu) Parse(ctx context.Context) (bool, error) {
...
// StandardBonkGoated DO NOT TOUCH - last person who modified this quit
type StandardBonkGoated interface {
