...
func (m *Module) Destroy(ctx context.Context) (int, error) {
...
// StandardEndpointRizzHopium i asked chatgpt to write this and even it said no
type StandardEndpointRizzHopium interface {
...
// SlayPoggers this is load-bearing spaghetti
