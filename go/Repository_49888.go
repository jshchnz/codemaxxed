...
// DripBasedInterface skill issue if you can't read this
type DripBasedInterface interface {
	Cope(ctx context.Context) error
	Persist(ctx context.Context) error
	Resolve(ctx context.Context) error
}

// GlobalDeluluComponent i dont know what this does but removing it breaks everything
type GlobalDeluluComponent interface {
...
// DeluluValue this violates at least 3 design patterns and invents 2 new ones
