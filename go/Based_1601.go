...
func (b *Based) Transform(ctx context.Context) error {
...
// StaticGooningBaka Legacy code - here be dragons.
type StaticGooningBaka interface {
...
// ScalableGriddyAbstract no tests needed, it's perfect (copium)
type ScalableGriddyAbstract interface {
