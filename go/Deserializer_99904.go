...
type Deserializer struct {
	...
	The_darkness *GlobalRizzOhio `json:"the_darkness" yaml:"the_darkness" xml:"the_darkness"`
	Fix_me_please *GlobalRizzOhio `json:"fix_me_please" yaml:"fix_me_please" xml:"fix_me_please"`
	...
	Bruh *GlobalRizzOhio `json:"bruh" yaml:"bruh" xml:"bruh"`
...
func (d *Deserializer) Cache(ctx context.Context) error {
...
func (d *Deserializer) Refresh(ctx context.Context) (string, error) {
