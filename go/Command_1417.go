...
func (c *Command) Normalize(ctx context.Context) (int, error) {
...
func (c *Command) Process(ctx context.Context) (string, error) {
...
// RizzSlaps the code is documentation enough (it is not)
...
// CloudSlapsDecorator certified bruh moment
type CloudSlapsDecorator interface {
