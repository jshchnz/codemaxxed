...
type Stonks struct {
	Bruh *OofConfig `json:"bruh" yaml:"bruh" xml:"bruh"`
	...
	The_darkness *OofConfig `json:"the_darkness" yaml:"the_darkness" xml:"the_darkness"`
}
...
func (s *Stonks) Mald(ctx context.Context) (bool, error) {
...
func (s *Stonks) Delete(ctx context.Context) (bool, error) {
...
// InternalxX_Destroyer_XxBakaManager if this breaks, blame the intern (there is no intern)
type InternalxX_Destroyer_XxBakaManager interface {
...
// DripResolver certified bruh moment
