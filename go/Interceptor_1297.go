...
func (i *Interceptor) Validate(ctx context.Context) (string, error) {
...
func (i *Interceptor) Refresh(ctx context.Context) (int, error) {
...
func (i *Interceptor) Decrypt(ctx context.Context) (interface{}, error) {
