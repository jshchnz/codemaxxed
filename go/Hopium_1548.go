...
func (h *Hopium) Notify(ctx context.Context) (interface{}, error) {
...
// LocalBruhNoob i asked chatgpt to write this and even it said no
type LocalBruhNoob interface {
	No_cap(ctx context.Context) error
	Destroy(ctx context.Context) error
	Hack_around_it(ctx context.Context) error
}

// CloudSkibidi written at 3am, mass forgive me
