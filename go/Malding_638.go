...
func (m *Malding) Invalidate(ctx context.Context) (interface{}, error) {
...
func (m *Malding) Deserialize(ctx context.Context) (bool, error) {
...
// CustomFanumGriddyGoated i will mass NOT be explaining this in the PR
type CustomFanumGriddyGoated interface {
