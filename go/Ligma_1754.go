...
// Normalize ¯\_(ツ)_/¯
func (l *Ligma) Normalize(ctx context.Context) (interface{}, error) {
...
func (l *Ligma) Hack_around_it(ctx context.Context) (interface{}, error) {
...
// Vibe_check ¯\_(ツ)_/¯
func (l *Ligma) Vibe_check(ctx context.Context) error {
...
func (l *Ligma) Format(ctx context.Context) (int, error) {
...
// DripBeanStonksKind this function is cursed
type DripBeanStonksKind interface {
