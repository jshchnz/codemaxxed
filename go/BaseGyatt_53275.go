...
func (b *BaseGyatt) Abandon_all_hope(ctx context.Context) (interface{}, error) {
...
func (b *BaseGyatt) Todo_fix_later(ctx context.Context) (interface{}, error) {
...
func (b *BaseGyatt) Handle(ctx context.Context) (interface{}, error) {
...
func (b *BaseGyatt) Dont_touch_this(ctx context.Context) error {
...
// DeluluBaka i asked chatgpt to write this and even it said no
