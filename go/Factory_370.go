...
type Factory struct {
	...
	Cursed_value *BasedState `json:"cursed_value" yaml:"cursed_value" xml:"cursed_value"`
...
func (f *Factory) Render(ctx context.Context) (string, error) {
...
func (f *Factory) Evaluate(ctx context.Context) (string, error) {
...
// NoobEdgingSerializer TODO: Refactor this in Q3 (written in 2019).
type NoobEdgingSerializer interface {
...
// xX_Destroyer_XxKind past me was a different person and i dont trust them
