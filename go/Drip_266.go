...
func (d *Drip) Authenticate(ctx context.Context) error {
...
// ServiceEntity DO NOT TOUCH - last person who modified this quit
...
// ChungusCringeCopium this is load-bearing spaghetti
type ChungusCringeCopium interface {
