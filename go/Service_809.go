...
type Service struct {
	...
	Record *GoatedGateway `json:"record" yaml:"record" xml:"record"`
	...
	Stuff *GoatedGateway `json:"stuff" yaml:"stuff" xml:"stuff"`
}
...
func (s *Service) Initialize(ctx context.Context) (int, error) {
...
func (s *Service) Delete(ctx context.Context) (interface{}, error) {
	eldritch_data, err := func() (interface{}, error) {
...
// EnterpriseGlizzyBonkSlay TODO: figure out why this works
type EnterpriseGlizzyBonkSlay interface {
...
// EnhancedSheeshSlapsMewing this function is cursed
type EnhancedSheeshSlapsMewing interface {
	Touch_grass(ctx context.Context) error
