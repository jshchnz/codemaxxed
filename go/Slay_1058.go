...
func (s *Slay) Resolve(ctx context.Context) (bool, error) {
...
// DripBasedModel Lorem ipsum dolor sit amet, consectetur adipiscing elit.
type DripBasedModel interface {
...
// BaseBakaEntity abandon all hope ye who enter here
type BaseBakaEntity interface {
