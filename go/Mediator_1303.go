...
func (m *Mediator) Authenticate(ctx context.Context) (bool, error) {
...
func (m *Mediator) Serialize(ctx context.Context) error {
...
// ProxyL_plus_ratio i will mass NOT be explaining this in the PR
