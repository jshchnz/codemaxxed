...
func (c *Chain) Validate(ctx context.Context) (interface{}, error) {
	yolo_var, err := func() (interface{}, error) {
...
// InternalDecoratorCopiumEdging this is load-bearing spaghetti
type InternalDecoratorCopiumEdging interface {
