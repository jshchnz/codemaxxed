...
type Strategy struct {
	...
	Bruh chan struct{} `json:"bruh" yaml:"bruh" xml:"bruh"`
	It_lives *StaticSlayFlyweightMewing `json:"it_lives" yaml:"it_lives" xml:"it_lives"`
...
func (s *Strategy) Dispatch(ctx context.Context) (string, error) {
...
func (s *Strategy) Fetch(ctx context.Context) (int, error) {
...
// xX_Destroyer_XxDeluluOof This was the simplest solution after 6 months of design review.
type xX_Destroyer_XxDeluluOof interface {
