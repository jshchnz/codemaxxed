...
type Based struct {
	...
	Input_data *SlayGriddyBruh `json:"input_data" yaml:"input_data" xml:"input_data"`
...
// StonksBased certified bruh moment
...
// DankNoob i will mass NOT be explaining this in the PR
