...
type Observer struct {
	...
	Count *AbstractBridgeDeadass `json:"count" yaml:"count" xml:"count"`
...
// GlizzyLigmaConnector i dont know what this does but removing it breaks everything
type GlizzyLigmaConnector interface {
...
// Connectorskill_issueFacadeBase if you're reading this, turn back now
type Connectorskill_issueFacadeBase interface {
