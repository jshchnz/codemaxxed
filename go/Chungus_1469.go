...
func (c *Chungus) Decompress(ctx context.Context) error {
...
func (c *Chungus) Hack_around_it(ctx context.Context) error {
...
func (c *Chungus) Compute(ctx context.Context) (bool, error) {
...
// RizzSigma if you're reading this, turn back now
...
// ProcessorNoobCringe TODO: Refactor this in Q3 (written in 2019).
type ProcessorNoobCringe interface {
...
// EnterpriseCringeGriddyVisitorUtil TODO: Refactor this in Q3 (written in 2019).
type EnterpriseCringeGriddyVisitorUtil interface {
