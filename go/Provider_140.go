...
func (p *Provider) Decompress(ctx context.Context) (string, error) {
...
func (p *Provider) Validate(ctx context.Context) (int, error) {
...
// AdapterCommand This satisfies requirement REQ-ENTERPRISE-4392.
type AdapterCommand interface {
