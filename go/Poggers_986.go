...
type Poggers struct {
	Yolo_var *SkibidiProviderTransformerValue `json:"yolo_var" yaml:"yolo_var" xml:"yolo_var"`
	...
	Xxx *SkibidiProviderTransformerValue `json:"xxx" yaml:"xxx" xml:"xxx"`
...
// LegacyHopiumEdgingInfo this function is cursed
type LegacyHopiumEdgingInfo interface {
