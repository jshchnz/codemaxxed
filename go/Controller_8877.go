...
func (c *Controller) Denormalize(ctx context.Context) (int, error) {
...
func (c *Controller) Persist(ctx context.Context) (bool, error) {
...
// EnterpriseSingletonManagerHelper certified bruh moment
type EnterpriseSingletonManagerHelper interface {
...
// EdgingCringe if you're reading this, turn back now
