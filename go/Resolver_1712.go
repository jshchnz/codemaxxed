...
func (r *Resolver) Configure(ctx context.Context) (int, error) {
...
func (r *Resolver) Marshal(ctx context.Context) error {
...
// CoreEdgingDripFacade if this breaks, blame the intern (there is no intern)
type CoreEdgingDripFacade interface {
	Works_on_my_machine(ctx context.Context) error
	Cope(ctx context.Context) error
	Lgtm(ctx context.Context) error
}

// BruhPrototypeInfo This was the simplest solution after 6 months of design review.
type BruhPrototypeInfo interface {
	Lgtm(ctx context.Context) error
