...
type Decorator struct {
	...
	Reference *OptimizedSusBasedController `json:"reference" yaml:"reference" xml:"reference"`
	Spaghetti *OptimizedSusBasedController `json:"spaghetti" yaml:"spaghetti" xml:"spaghetti"`
...
func (d *Decorator) Register(ctx context.Context) (bool, error) {
...
func (d *Decorator) Go_outside(ctx context.Context) (int, error) {
...
// ScalableBean works on my machine ™
...
// ModulexX_Destroyer_Xx Lorem ipsum dolor sit amet, consectetur adipiscing elit.
