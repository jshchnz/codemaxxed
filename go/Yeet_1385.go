...
// Sync ¯\_(ツ)_/¯
func (y *Yeet) Sync(ctx context.Context) (interface{}, error) {
...
func (y *Yeet) Lgtm(ctx context.Context) (int, error) {
...
// ModernBasedChungus if this breaks, blame the intern (there is no intern)
type ModernBasedChungus interface {
...
// FanumRegistryFlyweight Thread-safe implementation using the double-checked locking pattern.
type FanumRegistryFlyweight interface {
