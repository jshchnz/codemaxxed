...
func (v *Visitor) Ship_it(ctx context.Context) (interface{}, error) {
...
// Localno_bitchesInterface i dont know what this does but removing it breaks everything
type Localno_bitchesInterface interface {
...
// DeserializerImpl if you're reading this, turn back now
type DeserializerImpl interface {
