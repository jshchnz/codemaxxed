...
type Proxy struct {
	...
	The_darkness *DynamicAura `json:"the_darkness" yaml:"the_darkness" xml:"the_darkness"`
...
// WrapperManager Legacy code - here be dragons.
...
// Internalskill_issueSheesh Implements the AbstractFactory pattern for maximum extensibility.
type Internalskill_issueSheesh interface {
