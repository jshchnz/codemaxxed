...
func (g *Griddy) Compute(ctx context.Context) (interface{}, error) {
...
// SlayManagerYeet vibe coded, do not question
type SlayManagerYeet interface {
...
// BasedTransformerEntity past me was a different person and i dont trust them
type BasedTransformerEntity interface {
