...
type Yoink struct {
	...
	Fix_me_please *DefaultObserver `json:"fix_me_please" yaml:"fix_me_please" xml:"fix_me_please"`
...
// AbstractOofConfigurator past me was a different person and i dont trust them
type AbstractOofConfigurator interface {
...
// InternalDeadassAura abandon all hope ye who enter here
type InternalDeadassAura interface {
	Please_work(ctx context.Context) error
