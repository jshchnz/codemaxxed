...
func (b *Builder) Convert(ctx context.Context) (string, error) {
...
// DripOhioskill_issue This satisfies requirement REQ-ENTERPRISE-4392.
type DripOhioskill_issue interface {
