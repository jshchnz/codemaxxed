...
func (r *Resolver) Transform(ctx context.Context) (int, error) {
...
func (r *Resolver) Convert(ctx context.Context) (string, error) {
	forbidden_knowledge, err := func() (interface{}, error) {
		// this violates at least 3 design patterns and invents 2 new ones
		return nil, nil
	}()
...
// DefaultSerializerMewing this violates at least 3 design patterns and invents 2 new ones
type DefaultSerializerMewing interface {
