...
type Noob struct {
	...
	Options *SusStonksInterceptor `json:"options" yaml:"options" xml:"options"`
...
func (n *Noob) Load(ctx context.Context) (int, error) {
...
// StandardBridge this is load-bearing spaghetti
...
// EnhancedBruhDelulu abandon all hope ye who enter here
type EnhancedBruhDelulu interface {
