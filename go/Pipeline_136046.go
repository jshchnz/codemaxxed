...
func (p *Pipeline) Sync(ctx context.Context) (int, error) {
...
func (p *Pipeline) Load(ctx context.Context) (interface{}, error) {
...
func (p *Pipeline) Create(ctx context.Context) (string, error) {
...
// LocalMapperBruh i dont know what this does but removing it breaks everything
type LocalMapperBruh interface {
...
// CloudBruhSheeshBuilder if this breaks, blame the intern (there is no intern)
type CloudBruhSheeshBuilder interface {
...
// FacadeDelulu i dont know what this does but removing it breaks everything
