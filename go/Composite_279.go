...
type Composite struct {
	...
	Yolo_var *xX_Destroyer_XxInterface `json:"yolo_var" yaml:"yolo_var" xml:"yolo_var"`
...
// BaseNoobCopium skill issue if you can't read this
type BaseNoobCopium interface {
...
// MapperChungusYeet if this breaks, blame the intern (there is no intern)
type MapperChungusYeet interface {
