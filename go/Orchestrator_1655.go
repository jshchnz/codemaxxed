...
type Orchestrator struct {
	...
	Dont_ask *ComponentBakaTransformer `json:"dont_ask" yaml:"dont_ask" xml:"dont_ask"`
...
func (o *Orchestrator) Serialize(ctx context.Context) (interface{}, error) {
...
// GlobalConnectorLigma the code is documentation enough (it is not)
...
// ResolverPrototypeHopiumError ¯\_(ツ)_/¯
type ResolverPrototypeHopiumError interface {
