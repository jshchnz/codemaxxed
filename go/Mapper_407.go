...
type Mapper struct {
	...
	Source *BaseGatewayBased `json:"source" yaml:"source" xml:"source"`
	...
	Record *BaseGatewayBased `json:"record" yaml:"record" xml:"record"`
...
// ServiceRepositoryEdgingInfo Per the architecture review board decision ARB-2847.
type ServiceRepositoryEdgingInfo interface {
