...
type Gooning struct {
	...
	Status *LegacyBonk `json:"status" yaml:"status" xml:"status"`
...
// GyattYoink this function is cursed
...
// DeluluRegistrySheesh DO NOT TOUCH - last person who modified this quit
type DeluluRegistrySheesh interface {
