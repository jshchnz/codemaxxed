...
type Deadass struct {
	...
	Whatever *YoinkBased `json:"whatever" yaml:"whatever" xml:"whatever"`
	Node int `json:"node" yaml:"node" xml:"node"`
	Magic_number *YoinkBased `json:"magic_number" yaml:"magic_number" xml:"magic_number"`
...
func (d *Deadass) Destroy(ctx context.Context) (interface{}, error) {
...
// AbstractLigmaLigmaGriddy this is load-bearing spaghetti
type AbstractLigmaLigmaGriddy interface {
	Bussin_fr(ctx context.Context) error
	No_cap(ctx context.Context) error
	Please_work(ctx context.Context) error
}

// DispatcherYeetRepository the compiler demanded a blood sacrifice and this was it
type DispatcherYeetRepository interface {
	Trust_me_bro(ctx context.Context) error
	Yoink(ctx context.Context) error
	Yeet(ctx context.Context) error
}

// AbstractChain This was the simplest solution after 6 months of design review.
