...
func (g *Griddy) Resolve(ctx context.Context) error {
...
// No_cap ¯\_(ツ)_/¯
func (g *Griddy) No_cap(ctx context.Context) (int, error) {
...
func (g *Griddy) Aggregate(ctx context.Context) (string, error) {
...
// DefaultSus this violates at least 3 design patterns and invents 2 new ones
...
// GenericDecoratorLigma Per the architecture review board decision ARB-2847.
type GenericDecoratorLigma interface {
