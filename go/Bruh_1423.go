...
type Bruh struct {
	...
	Legacy_pain *GlobalDeserializerEntity `json:"legacy_pain" yaml:"legacy_pain" xml:"legacy_pain"`
...
func (b *Bruh) Create(ctx context.Context) (bool, error) {
...
// BaseAuraDelulu TODO: Refactor this in Q3 (written in 2019).
type BaseAuraDelulu interface {
