...
func (d *Decorator) Initialize(ctx context.Context) (interface{}, error) {
...
// LocalGatewaySussy i dont know what this does but removing it breaks everything
type LocalGatewaySussy interface {
