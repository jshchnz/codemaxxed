...
type Endpoint struct {
	...
	Entry *DynamicYeetSkibidi `json:"entry" yaml:"entry" xml:"entry"`
...
// Unmarshal ¯\_(ツ)_/¯
func (e *Endpoint) Unmarshal(ctx context.Context) (interface{}, error) {
	xxx, err := func() (interface{}, error) {
...
// VibeSkibidiDeadassRequest if this breaks, blame the intern (there is no intern)
type VibeSkibidiDeadassRequest interface {
