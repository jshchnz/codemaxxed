...
func (c *Connector) Persist(ctx context.Context) (string, error) {
	eldritch_data, err := func() (interface{}, error) {
...
func (c *Connector) Initialize(ctx context.Context) (string, error) {
...
// DankHitsMalding the mass of code grows. it hungers. it consumes.
type DankHitsMalding interface {
