...
// RatioGatewayDispatcher DO NOT MODIFY - This is load-bearing architecture.
type RatioGatewayDispatcher interface {
...
// DeadassHits i will mass NOT be explaining this in the PR
