...
type Manager struct {
	...
	It_lives *BakaPoggers `json:"it_lives" yaml:"it_lives" xml:"it_lives"`
	Item *BakaPoggers `json:"item" yaml:"item" xml:"item"`
...
// RatioNoobService this violates at least 3 design patterns and invents 2 new ones
type RatioNoobService interface {
...
// PipelineState this violates at least 3 design patterns and invents 2 new ones
