...
func (f *Fanum) Process(ctx context.Context) (int, error) {
...
// SlayDelulu written at 3am, mass forgive me
...
// DelegateCommand i dont know what this does but removing it breaks everything
