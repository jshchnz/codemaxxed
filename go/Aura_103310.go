...
type Aura struct {
	...
	Temp_but_permanent *DistributedSkibidiHitsDescriptor `json:"temp_but_permanent" yaml:"temp_but_permanent" xml:"temp_but_permanent"`
	God_object *DistributedSkibidiHitsDescriptor `json:"god_object" yaml:"god_object" xml:"god_object"`
