...
func (o *Oof) Marshal(ctx context.Context) (int, error) {
...
// ComponentEdgingType abandon all hope ye who enter here
type ComponentEdgingType interface {
...
// SheeshSkibidiPoggersException this function is cursed
type SheeshSkibidiPoggersException interface {
