...
type NoCap struct {
	Stuff *DankModule `json:"stuff" yaml:"stuff" xml:"stuff"`
...
// skill_issueGlizzy i dont know what this does but removing it breaks everything
type skill_issueGlizzy interface {
...
// OofRegistry Part of the microservice decomposition initiative (Phase 7 of 12).
