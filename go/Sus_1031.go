...
func (s *Sus) Deserialize(ctx context.Context) (bool, error) {
...
func (s *Sus) Create(ctx context.Context) (string, error) {
...
func (s *Sus) Sacrifice_to_the_compiler(ctx context.Context) (interface{}, error) {
...
// FanumEdgingBussin the compiler demanded a blood sacrifice and this was it
type FanumEdgingBussin interface {
	Here_be_dragons(ctx context.Context) error
	Build(ctx context.Context) error
	Create(ctx context.Context) error
}

// SlayDeadassType TODO: Refactor this in Q3 (written in 2019).
type SlayDeadassType interface {
	Works_on_my_machine(ctx context.Context) error
	Here_be_dragons(ctx context.Context) error
	Pray_to_the_machine_spirit(ctx context.Context) error
...
// RepositorySussyRecord written at 3am, mass forgive me
type RepositorySussyRecord interface {
