...
func (c *Composite) Configure(ctx context.Context) (string, error) {
...
func (c *Composite) Execute(ctx context.Context) error {
...
func (c *Composite) Sanitize(ctx context.Context) (interface{}, error) {
...
// ModernYeetxX_Destroyer_Xx i will mass NOT be explaining this in the PR
type ModernYeetxX_Destroyer_Xx interface {
...
// ManagerProvider this violates at least 3 design patterns and invents 2 new ones
...
// xX_Destroyer_XxGlizzyGyatt certified bruh moment
type xX_Destroyer_XxGlizzyGyatt interface {
