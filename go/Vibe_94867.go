...
type Vibe struct {
	...
	Result *SlayDefinition `json:"result" yaml:"result" xml:"result"`
...
// GatewayType works on my machine ™
type GatewayType interface {
...
// OofHopium Legacy code - here be dragons.
...
// DynamicSlay the code is documentation enough (it is not)
