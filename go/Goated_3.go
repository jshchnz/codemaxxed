...
func (g *Goated) Notify(ctx context.Context) (interface{}, error) {
...
// BakaValidator DO NOT MODIFY - This is load-bearing architecture.
...
// HitsSheeshRecord i dont know what this does but removing it breaks everything
type HitsSheeshRecord interface {
...
// CloudComponentStonksSigma skill issue if you can't read this
type CloudComponentStonksSigma interface {
