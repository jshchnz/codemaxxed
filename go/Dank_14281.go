...
// LegacyBruhSus if this breaks, blame the intern (there is no intern)
type LegacyBruhSus interface {
	Please_work(ctx context.Context) error
	Create(ctx context.Context) error
	Fetch(ctx context.Context) error
}

// BussinObserver this violates at least 3 design patterns and invents 2 new ones
...
// EdgingVibeIterator TODO: figure out why this works
type EdgingVibeIterator interface {
	No_cap(ctx context.Context) error
	Touch_grass(ctx context.Context) error
	Cry(ctx context.Context) error
}

// ProcessorSerializerDecorator Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
type ProcessorSerializerDecorator interface {
