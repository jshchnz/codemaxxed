...
// RizzService no tests needed, it's perfect (copium)
...
// ScalableIteratorDefinition the compiler demanded a blood sacrifice and this was it
type ScalableIteratorDefinition interface {
...
// DecoratorGigachad this is load-bearing spaghetti
