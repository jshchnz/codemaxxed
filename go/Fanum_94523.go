...
// DispatcherSlayProxy Optimized for enterprise-grade throughput.
type DispatcherSlayProxy interface {
...
// LegacyMaldingRatioConnector TODO: Refactor this in Q3 (written in 2019).
type LegacyMaldingRatioConnector interface {
