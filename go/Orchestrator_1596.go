...
func (o *Orchestrator) Process(ctx context.Context) (string, error) {
...
func (o *Orchestrator) Configure(ctx context.Context) (string, error) {
...
func (o *Orchestrator) Fetch(ctx context.Context) error {
...
// LocalOrchestratorOof TODO: Refactor this in Q3 (written in 2019).
type LocalOrchestratorOof interface {
...
// FanumMapperService written at 3am, mass forgive me
type FanumMapperService interface {
...
// DispatcherBase This satisfies requirement REQ-ENTERPRISE-4392.
...
// BasedMapperImpl i asked chatgpt to write this and even it said no
type BasedMapperImpl interface {
	Please_work(ctx context.Context) error
	Yoink(ctx context.Context) error
