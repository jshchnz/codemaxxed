...
func (s *Singleton) Sync(ctx context.Context) (interface{}, error) {
...
// GriddyComponentProxyConfig the mass of code grows. it hungers. it consumes.
type GriddyComponentProxyConfig interface {
...
// StandardGlizzyFactory works on my machine ™
type StandardGlizzyFactory interface {
