...
type Deadass struct {
	...
	Entity *Stonks `json:"entity" yaml:"entity" xml:"entity"`
	God_object *sync.Mutex `json:"god_object" yaml:"god_object" xml:"god_object"`
	Input_data *Stonks `json:"input_data" yaml:"input_data" xml:"input_data"`
...
func (d *Deadass) Load(ctx context.Context) (interface{}, error) {
...
// HitsHitsBase This class follows the Single Responsibility Principle (it has one responsibility: being enormous).
type HitsHitsBase interface {
