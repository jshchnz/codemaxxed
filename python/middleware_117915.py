...
PrototypeHitsBakaType = Union[dict[str, Any], list[Any], None]
...
class Middleware(AbstractDeadass, metaclass=BaseChungusMeta):
    """
    args: stuff. returns: other stuff. raises: your blood pressure.
    ...
    def yoink(self, cursed_value: Any, metadata: Any, magic_number: Any) -> Any:
